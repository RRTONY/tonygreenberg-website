...
const nextConfig: NextConfig = {
  ...
  async redirects() {
    return [
      ...
      {
        source: "/vendor-intake-long",
        destination: "https://ramprate.com/biochain/supplier-intake",
        permanent: true,
      },
      {
        source: "/vendor-intake-long/:token",
        destination: "https://ramprate.com/biochain/supplier-intake",
        permanent: true,
      },
      ...
      {
        source: "/attention-theft/economics",
        destination: "/attention-theft#heresy",
        permanent: true,
      },
      {
        source: "/blocker-finder",
        destination: "/attention-theft#blocker-finder",
        permanent: true,
      },
      {
        source: "/attention-theft/blocker-finder",
        destination: "/attention-theft#blocker-finder",
        permanent: true,
      },
      ...
      {
        source: "/attention-theft/weapons",
        destination: "/attention-theft#weapons",
        permanent: true,
      },
      { source: "/report", destination: "/attention-theft#report", permanent: true },
      {
        source: "/attention-theft/report",
        destination: "/attention-theft#report",
        permanent: true,
      },
      ...
      {
        source: "/find-my-attachment-style",
        destination: "/find-your-attachment-style",
        permanent: true,
      },
      ...
      {
        source: "/assessments/consciousness-scale",
        destination: "/consciousness-scale",
        permanent: true,
      },
  ...
  images: {
    remotePatterns: [
      { protocol: "https", hostname: "tonygreenberg.com", pathname: "/api/img/**" },
