...
## Safe Public Parity Closure Table

| Reference or live candidate                                                                   | Closure decision               | Active implementation or evidence                                                                                                        | Result                                           |
| --------------------------------------------------------------------------------------------- | ------------------------------ | ---------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------ |
| `/connect`, `/health`, `/library`, `/heroes`, `/impact`, `/projects`, `/quiz`, `/seven-doors` | Canonical alias                | Tested redirect configuration sends the verified live-homepage fallbacks to `/`.                                                         | Closed — no duplicate content page is warranted. |
| `/built-on-manus`                                                                             | Canonical alias                | Tested redirect configuration sends the observed live-homepage fallback to `/`.                                                          | Closed — no distinct approved content was found. |
| `/medicine-sequencing`                                                                        | Native public port             | Next.js route, PRI data adapter, focused tests, responsive screenshots.                                                                  | Closed.                                          |
| `/ecosystem-map`                                                                              | Native public port             | Next.js route, Journey Tracker integration, cookie-backed progress, focused tests, responsive screenshots.                               | Closed.                                          |
| `/skippy`                                                                                     | Native public port             | Next.js route, verified destination data, cookie-backed progress, focused tests, responsive screenshots.                                 | Closed.                                          |
| `/subscribe`                                                                                  | Native public port             | Managed newsletter endpoint, source tags, validation states, local responsive and public-route checks.                                   | Closed; paid offers remain deferred.             |
| Human OS reference home                                                                       | Active equivalent refined      | `/humanos` restores the verified hero and retains the active route architecture.                                                         | Closed.                                          |
| Facilitator Index diagrams                                                                    | Active equivalent refined      | `/facilitator-index` restores both verified diagrams, semantic Lucide controls, and focused media policy coverage.                       | Closed.                                          |
| Legacy Legal Database                                                                         | Active equivalent hardened     | Attention Theft’s Legal Arsenal supplies the safe public equivalent with official regulator links and no reporting/data-collection flow. | Closed.                                          |
| About, Letter, Body, Nightstand, Web, Walk Through media                                      | Active media repair            | Retired Sanity paths were replaced with true-WebP managed assets; public DOM evidence confirms Letter asset loading.                     | Closed.                                          |
| `/clock-keeper-part-2`                                                                        | Deferred                       | Consent-sensitive free-text/name/email collection needs retention, access-control, and managed-database design.                          | Deferred by design.                              |
| `/fauxtony`                                                                                   | Deferred                       | Requires server-side AI, source grounding, and misuse-safety review.                                                                     | Deferred by design.                              |
| `/shop` and paid legacy offers                                                                | Deferred                       | Requires Google authentication, approved checkout, product, and fulfillment design.                                                      | Deferred by design.                              |
| `/supplier-intake`, `/cheshire-grin`, legacy reporting workflows                              | Deferred or protected redirect | Existing external/protected routing is retained until secure managed replacements are approved.                                          | Deferred by design.                              |

> No safe, self-contained public candidate remains unclassified in the inventory. The reference-media source-group matrix in [`reference-media-manifest.md`](./reference-media-manifest.md) provides the image-level disposition underlying this table.

## Restored Route Validation Matrix

The following checks were completed on 11 September 2026. Desktop and mobile entries refer to full-page captures at 1280 × 720 and 375 × 812. “State coverage” identifies the relevant focused test or server-backed state boundary; the validation did not submit newsletter, report, or other personal data.

| Route or active equivalent | Desktop and mobile layout                                    | Media and navigation evidence                                                                                    | State coverage                                                                    | Result                                      |
| -------------------------- | ------------------------------------------------------------ | ---------------------------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------- | ------------------------------------------- |
| `/medicine-sequencing`     | Full-page captures completed                                 | Grouped cards and onward links remained readable.                                                                | Pure data adapter test; no durable state.                                         | Passed.                                     |
| `/ecosystem-map`           | Full-page captures completed                                 | Phase header, destination cards, and internal navigation remained readable.                                      | Journey visitor-state and route tests.                                            | Passed.                                     |
| `/skippy`                  | Full-page captures completed                                 | Map sections and verified destination cards remained readable.                                                   | Skippy data and visitor-state coverage.                                           | Passed.                                     |
| `/subscribe`               | Full-page captures completed; public desktop check completed | Labelled form, internal essay link, and deferred-payment notice verified.                                        | Newsletter endpoint and source-tag tests; no form submission during visual check. | Passed.                                     |
| `/humanos`                 | Desktop, tablet, and mobile checks completed                 | Verified hero, cards, and onward links remained readable.                                                        | Static public route.                                                              | Passed.                                     |
| `/facilitator-index`       | Full-page desktop and mobile checks completed                | Hero, restored diagrams, full-instrument affordance, and print control remained ordered.                         | Facilitator media and icon-policy tests.                                          | Passed.                                     |
| `/attention-theft`         | Full-page desktop and mobile checks completed                | Legal Arsenal filters, official-guidance links, and template layout remained responsive.                         | Legal Arsenal content-policy test; no personal-data flow.                         | Passed.                                     |
| `/about`                   | Full-page desktop and mobile checks completed                | Navigation and content layout passed; local managed-storage proxy shows a neutral media fallback.                | Public asset equivalence and managed-media tests.                                 | Passed with separate public asset evidence. |
| `/the-letter`              | Full-page desktop and mobile checks completed                | Four Doors layout and internal navigation passed; public DOM confirmed true-WebP hero dimensions and visibility. | Managed-media regression test.                                                    | Passed with public DOM asset evidence.      |
| `/the-body`                | Full-page desktop and mobile checks completed                | Editorial hierarchy and managed-image call site validated.                                                       | Managed-media regression test.                                                    | Passed.                                     |
| `/the-nightstand`          | Full-page desktop and mobile checks completed                | Editorial hierarchy and managed-image call site validated.                                                       | Managed-media regression test.                                                    | Passed.                                     |
| `/the-web`                 | Full-page desktop and mobile checks completed                | Editorial hierarchy and managed-image call site validated.                                                       | Managed-media regression test.                                                    | Passed.                                     |
| `/walk-through`            | Full-page desktop and mobile checks completed                | Door cards, forward icons, and managed-image call site validated.                                                | Walk Through icon and managed-media tests.                                        | Passed.                                     |
...
### Safe Public Parity Completion Boundary

The route, style, media, and interaction review now has a complete source-level decision trail. The reference-media manifest inventories 171 distinct legacy image declarations across 200 occurrences; its source-group disposition matrix assigns every declaration to an active equivalent, a constrained legacy workflow, or an obsolete/restricted surface. The remaining legacy candidates are not unimplemented public gaps: they are explicitly deferred because they require Google authentication, payment processing, AI safety controls, supplier or reporting workflows, sensitive-data consent, credential rotation, or current primary-source review. The implemented public equivalents—including the native sequencing, ecosystem, Skippy, newsletter, Human OS, Facilitator, legal framework, Letter, and recovered media experiences—have focused tests plus desktop and mobile validation evidence.
