        ...
        <section className="mb-12">
          ...
          <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
            {DANGER_MECHANISMS.map((m, i) => {
              ...
              return (
                <div key={m.title} className="rounded-xl border-t-2 border-[#C0392B]/20 bg-[#C0392B]/4 p-6">
          ...
          <div className="grid gap-4 sm:grid-cols-3">
            {SEARCH_ENGINE_ITEMS.map((item) => (
              <div key={item.label} className="rounded-lg bg-brand-gold/5 p-4">
                <p className="font-mono text-xs tracking-wide text-brand-gold uppercase">{item.label}</p>
            ...
            {CROSS_LINKS.map((link) => {
              ...
              return (
                ...
                >
                  ...
                  <h3 className="mb-1 font-mono text-sm tracking-wide text-brand-gold">{link.title}</h3>
