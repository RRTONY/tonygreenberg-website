...
const ESSAYS: Essay[] = [
  { num: "01", slug: "boiling-the-human-summit-harvard-kurzweil", title: '"Boiling the Human" — H+ Summit / Harvard-Kurzweil', why: "Because the line between human and machine was drawn on a stage at Harvard in 2010. This transcript captures the moment the question stopped being theoretical.", hook: "What happens when the people building the future forget to ask the people living in it?", tag: "THE RECKONING" },
  { num: "02", slug: "only-time-buys-trust", title: "Trust Us? Are You Really My Friend?", why: "Because trust is the only currency that compounds. This essay is the thesis statement for everything else on this site.", hook: "In a world optimized for speed, the most radical act is patience.", tag: "THE LESSON" },
  { num: "03", slug: "psychedelics-could-become-extractive-capitalism", title: "Psychedelics Could Become Extractive Capitalism", why: "Because consciousness expansion without accountability is just another gold rush. Six investments deep, this is what the view looks like from inside.", hook: "The medicine works. The question is whether the business model will poison it.", tag: "THE SYSTEMS MAP" },
  { num: "04", slug: "the-ball-and-blockchain-decentralization", title: "The Ball and Blockchain: Obstacles to a World-Changing Trajectory", why: "Because decentralization promised liberation and delivered speculation. This essay maps the gap between the vision and the reality.", hook: "Every revolution gets co-opted. The question is when you notice.", tag: "THE RECKONING" },
  { num: "05", slug: "return-on-investment-going-green-going-green-2", title: "Return on Investment — Are You Going Green?", why: "Because impact without returns is charity, and returns without impact is extraction. The math has to work for both.", hook: "Green isn't a color. It's a calculation.", tag: "THE SYSTEMS MAP" },
];
      ...
      <div className="bg-[#0A0A10] px-6 py-16 text-center sm:px-10">
        <div className="mx-auto max-w-2xl">
          ...
          <p className="mb-8 leading-relaxed text-white/60">
            Either response is useful. The essays that follow explore psychedelic medicine,
            payments infrastructure, enterprise technology, tokenized impact, and the personal
            cost of building systems that matter. Ninety dispatches from twenty-five years in the
            field. No algorithm. No sponsors. Just one person&apos;s attempt to make sense of the
