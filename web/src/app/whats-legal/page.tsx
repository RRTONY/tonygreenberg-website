      ...
      <section className="px-6 py-12">
        <div className="mx-auto max-w-3xl rounded-lg border border-amber-200 bg-amber-50 p-6">
          ...
          <p className="text-sm leading-relaxed text-amber-800">
            ...
            prosecuted for personal peptide possession in the US. The legal risk sits with
            suppliers making health claims, not researchers using compounds quietly and
            responsibly. That said: BPC-157 is scheduled in Australia. GLP-1 compounds are a
            litigation minefield. And Colorado is actively considering state-level peptide
            transparency legislation. The landscape is moving.
          </p>
        </div>
      </section>
        ...
        <div className="mx-auto max-w-3xl">
          ...
          <div className="space-y-6">
            <div className="border-l-4 border-emerald-500 pl-4">
              <h3 className="mb-1 font-bold text-foreground">&quot;Grey Market&quot; ≠ &quot;Illegal&quot;</h3>
              <p className="text-sm leading-relaxed text-muted-foreground">
                Grey market means not FDA-approved for human use but not explicitly banned for
                research purposes. The &quot;research only&quot; label is the legal distinction
                that has protected this market for a decade. It&apos;s thin. But it&apos;s real.
              </p>
            </div>
            <div className="border-l-4 border-amber-500 pl-4">
              <h3 className="mb-1 font-bold text-foreground">&quot;Approved (Rx)&quot; = Pharma Owns It</h3>
              <p className="text-sm leading-relaxed text-muted-foreground">
            ...
            <div className="border-l-4 border-red-500 pl-4">
              <h3 className="mb-1 font-bold text-foreground">&quot;Scheduled&quot; = Actually Controlled</h3>
              <p className="text-sm leading-relaxed text-muted-foreground">
