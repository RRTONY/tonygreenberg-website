      ...
      <section className="bg-[#0A0A10] px-6 py-20 text-white">
        <div className="mx-auto max-w-3xl">
          ...
          <p className="max-w-2xl leading-relaxed text-zinc-400">
            ...
            best options available right now, from cheapest to most rigorous.
          </p>
        </div>
      </section>
            ...
            <div key={opt.number} className="rounded-lg border border-border bg-card p-6 md:p-8">
              ...
              {opt.site && (
                <p className="mb-3 text-sm">
                  ...
                  <a href={opt.siteUrl} target="_blank" rel="noopener noreferrer" className="text-[#C84B2A] underline">
                    {opt.site}
                  </a>
                </p>
              )}
