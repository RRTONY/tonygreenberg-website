    ...
    <div>
      ...
      <div className="mx-auto max-w-3xl px-6 py-10">
        ...
        <p className="mb-10 text-foreground/80">
          Not biohacking vanity. Measurement-driven wellness with accountability built in. Years
          of testing every modality I can find — peptides, exosomes, regenerative medicine,
          breathwork, cold exposure, psychedelic-assisted therapy — each scored on a rigorous
        ...
        <div className="mb-10 rounded-r-md border-l-4 border-brand-gold bg-brand-gold/5 p-6">
          ...
          <p className="leading-relaxed text-foreground/80">
            ...
            is one that submits to measurement. If you can&apos;t track it, you can&apos;t trust
            it — and the gap between what feels good and what is good is where most people get
            lost.
          </p>
        </div>
