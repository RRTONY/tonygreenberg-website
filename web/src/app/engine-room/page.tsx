  ...
  return (
    <div className="mx-auto max-w-3xl px-6 py-10">
      ...
      <blockquote className="mb-10 border-l-2 border-brand-gold pl-5 text-foreground/80 italic">
        &ldquo;We never stop building. The work connects — enterprise technology informs the
        impact models, the consciousness research sharpens the ethics, and the consumer advocacy
        keeps everyone honest.&rdquo;
