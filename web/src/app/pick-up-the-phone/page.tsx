  ...
  return (
    <div className="mx-auto max-w-3xl px-6 py-10">
      ...
      <p className="mb-4 leading-relaxed text-foreground/80">
        If something on this site resonated — or if you think we should be working together — I
        want to hear from you. But I don&apos;t take cold calls, and I don&apos;t take meetings
        without preparation. The best partnerships start with clarity, not small talk.
      </p>
      <p className="mb-8 leading-relaxed text-muted-foreground">
        ...
        partnership. Pass it, and you&apos;ll get the booking link. Make it compelling enough, and
        I might reach out to you first.
      </p>
      ...
      <div className="rounded-r-md border-l-4 border-brand-gold bg-brand-gold/5 p-6">
        ...
        <p className="leading-relaxed text-foreground/80">
          ...
          start it with clarity — know what you want, know why it matters, and know what
