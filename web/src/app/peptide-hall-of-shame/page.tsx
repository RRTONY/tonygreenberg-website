...
const CLINICS: Clinic[] = [
  { name: "Admire Medical", url: "https://www.admiremedical.com/peptides", questions: 19, score: 40, type: "Intake form", contraindications: true, goals: true, personalized: false, evidence: false, medicalHistory: true, disclaimer: true, weaknesses: "No immediate personalized results — it's a lead-in to a paid consultation. No citation of evidence.", strengths: "Good safety screening. Asks about contraindications, medical history, and health goals. Comprehensive intake." },
  { name: "Vitality Centers NW", url: "https://vitalitycentersnw.com/peptide-assessment", questions: 10, score: 90, type: "Lead generation form", contraindications: false, goals: true, personalized: false, evidence: false, medicalHistory: false, disclaimer: true, weaknesses: "No contraindication screening, generic results, no evidence cited, no medical history questions.", strengths: "Asks about health goals. Has disclaimer." },
  { name: "Elite Living & Health", url: "https://www.elitelivingandhealth.com", questions: 9, score: 90, type: "Lead generation form", contraindications: false, goals: true, personalized: false, evidence: false, medicalHistory: true, disclaimer: false, weaknesses: "No contraindication screening, no personalized results, no evidence. Basic lead gen.", strengths: "Asks about medical history and goals." },
  { name: "Defy Medical", url: "https://www.defymedical.com/services/peptide-therapy/", questions: 8, score: 95, type: "Lead generation form", contraindications: false, goals: false, personalized: false, evidence: false, medicalHistory: false, disclaimer: true, weaknesses: "Basic lead generation form. No screening, no goals, no personalization, no evidence.", strengths: "Has disclaimer." },
  { name: "10X Health System", url: "https://10xhealthsystem.com", questions: 4, score: 95, type: "Lead generation form", contraindications: false, goals: false, personalized: false, evidence: false, medicalHistory: false, disclaimer: false, weaknesses: "Only 4 questions. Pure lead generation. No clinical value whatsoever.", strengths: "None." },
  { name: "Renew Youth", url: "https://www.renewyouth.com", questions: 8, score: 95, type: "Lead generation form", contraindications: false, goals: true, personalized: false, evidence: false, medicalHistory: false, disclaimer: false, weaknesses: "Lead generation disguised as assessment. No safety screening.", strengths: "Asks about goals." },
  ...
  { name: "Evolve", url: "https://www.evolvehrt.com", questions: 5, score: 100, type: "Lead generation form", contraindications: false, goals: false, personalized: false, evidence: false, medicalHistory: false, disclaimer: false, weaknesses: "Pure lead generation. No clinical criteria met.", strengths: "None." },
  { name: "Peptide Sciences", url: "https://www.peptidesciences.com", questions: 0, score: 100, type: "No assessment", contraindications: false, goals: false, personalized: false, evidence: false, medicalHistory: false, disclaimer: false, weaknesses: "No assessment exists. Research chemical vendor.", strengths: "None." },
  { name: "Lifeline Medical", url: "https://lifelinemed.com", questions: 0, score: 100, type: "No assessment", contraindications: false, goals: false, personalized: false, evidence: false, medicalHistory: false, disclaimer: false, weaknesses: "No assessment exists.", strengths: "None." },
  { name: "Bloom Health & Wellness", url: "https://bloomhealthwellness.com", questions: 0, score: 100, type: "No assessment", contraindications: false, goals: true, personalized: false, evidence: false, medicalHistory: false, disclaimer: false, weaknesses: "No assessment. Mentions goals on marketing page but no actual tool.", strengths: "None." },
  { name: "Fountain Life", url: "https://www.fountainlife.com", questions: 0, score: 100, type: "No assessment", contraindications: false, goals: false, personalized: false, evidence: false, medicalHistory: false, disclaimer: false, weaknesses: "No assessment. Premium pricing with no upfront screening.", strengths: "None." },
  { name: "Maximus", url: "https://www.maximustribe.com", questions: 0, score: 100, type: "No assessment", contraindications: false, goals: false, personalized: false, evidence: false, medicalHistory: false, disclaimer: false, weaknesses: "No assessment. DTC peptide sales with no screening.", strengths: "None." },
  { name: "Peter Attia MD", url: "https://peterattiamd.com", questions: 0, score: 100, type: "No assessment", contraindications: false, goals: false, personalized: false, evidence: true, medicalHistory: false, disclaimer: false, weaknesses: "No assessment tool. Educational content only.", strengths: "Cites peer-reviewed evidence in articles." },
  { name: "Biote Medical", url: "https://biote.com", questions: 0, score: 100, type: "No assessment", contraindications: false, goals: false, personalized: false, evidence: false, medicalHistory: false, disclaimer: false, weaknesses: "No assessment. Hormone pellet focus, peptides secondary.", strengths: "None." },
  { name: "SSRP Institute", url: "https://ssrpinstitute.com", questions: 0, score: 100, type: "No assessment", contraindications: false, goals: false, personalized: false, evidence: false, medicalHistory: false, disclaimer: false, weaknesses: "No assessment exists.", strengths: "None." },
  ...
  { name: "Core Med Science", url: "https://coremedscience.com", questions: 0, score: 100, type: "No assessment", contraindications: false, goals: false, personalized: false, evidence: false, medicalHistory: false, disclaimer: false, weaknesses: "No assessment. Supplement vendor.", strengths: "None." },
  { name: "Peptide Clinics (AU)", url: "https://www.peptideclinics.com.au", questions: 0, score: 100, type: "No assessment", contraindications: false, goals: false, personalized: false, evidence: false, medicalHistory: false, disclaimer: false, weaknesses: "No assessment. Australian telehealth provider.", strengths: "None." },
    ...
    <div>
      ...
      <div className="mx-auto max-w-4xl px-6 py-12 sm:px-10">
        ...
        <p className="mb-6 leading-relaxed text-foreground/80">
          Each provider was evaluated on 6 clinical criteria that any responsible peptide
          assessment should include. A score of 1 represents a perfect assessment; 100 represents
          the worst possible outcome — no assessment at all, or a lead generation form with zero
          clinical value. The criteria are weighted by clinical importance:
        </p>
        ...
        <div className="mb-12 rounded-xl border-2 border-emerald-700/20 bg-emerald-700/5 p-6">
          <div className="mb-4 flex flex-wrap items-center justify-between gap-4">
            <div>
              ...
              <p className="text-sm text-muted-foreground">
                Our assessment scores <strong className="text-foreground">5/100</strong> —
                meeting all 6 clinical criteria with 7 scoring axes and 16 personalized
                archetypes.
              </p>
            </div>
            <Link
          ...
          <div className="flex flex-wrap gap-2">
            {[
              ...
              <span key={f} className="rounded bg-emerald-700/10 px-2 py-1 font-mono text-xs text-emerald-700">
                ✓ {f}
              </span>
            ))}
          </div>
        ...
        <div className="mt-12 rounded-2xl bg-linear-to-br from-[#0A0A10] to-[#1a1a2e] px-6 py-16 text-center">
          ...
          <p className="mx-auto mb-8 max-w-md leading-relaxed text-[#E8E4DC]/60">
            10 questions. 7 clinical axes. 16 personalized archetypes. Contraindication
            screening. Evidence citations. No lead generation tricks.
          </p>
        ...
        <div className="mt-12 rounded-xl border border-brand-gold/25 bg-linear-to-br from-brand-gold/8 to-brand-gold/2 p-8 text-center">
          ...
          <p className="mx-auto mb-6 max-w-lg leading-relaxed text-muted-foreground">
            ...
            vendor base. If your manufacturing meets our transparency and quality standards, we
        ...
        <div className="mt-12 rounded-md bg-brand-gold/5 p-6">
          <p className="text-sm leading-relaxed text-muted-foreground">
            <strong className="text-foreground">Methodology Note:</strong> This audit was
            conducted in February 2026 by visiting each provider&apos;s website and evaluating
            their publicly available peptide assessment or questionnaire tools. Scores reflect
            the quality of the consumer-facing assessment tool only — not the quality of clinical
            care provided. Providers without a public assessment tool received the maximum
            weakness score (100). This page is for educational purposes only and does not
            constitute medical advice. Rankings may change as providers update their tools.
          </p>
        </div>
      </div>
    </div>
