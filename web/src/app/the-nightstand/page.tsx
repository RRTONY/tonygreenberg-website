    ...
    <div>
      ...
      <div className="mx-auto max-w-3xl px-6 py-10">
        ...
        <blockquote className="mb-10 text-center font-heading text-xl italic text-foreground">
          ...
          what&apos;s &apos;appropriate.&apos; The best ideas come from the strangest
          intersections. A mycology textbook next to a payments whitepaper next to a Sufi poem.
          That&apos;s my bookshelf.&rdquo;
        </blockquote>
