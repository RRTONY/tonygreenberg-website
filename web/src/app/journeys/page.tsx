...
const JOURNEYS: Journey[] = [
  {
    ...
    stops: [
      { page: "The Letter", href: "/the-letter", section: "Why Now?", teaser: "The collapse in Meaning — and why this document exists" },
  ...
  },
  {
    ...
    stops: [
      ...
      { page: "Blog", href: "/blog/trap-how-dmn8-gym-became-a-poster-child-for-fitness-fraud", section: "DMN8 Gym Exposé", teaser: "The most beautiful (crooked) gym in the world" },
      { page: "Blog", href: "/blog/luz-lounge-where-loyalty-goes-to-die-groupon", section: "Luz Lounge", teaser: "Where loyalty goes to die — and Groupon deals are lipstick on a pig" },
      { page: "Blog", href: "/blog/hiding-fees-tips-in-the-transparent-age", section: "Hiding Fees & Tips", teaser: "Bad business in the transparent age" },
    ],
  },
  {
  ...
  },
  {
    ...
    stops: [
      { page: "The Letter", href: "/the-letter", section: "Start Here", teaser: "I have something to show you." },
    ...
    <div className="px-6 py-10">
      <div className="mx-auto mb-10 max-w-3xl">
        ...
        <p className="mb-3 text-foreground/80">
          ...
          know what you&apos;re looking for, or if you want to be surprised in a specific
          direction, pick a path. Each journey threads sections from across the site into a
          coherent experience built for a particular kind of curiosity.
        </p>
        <p className="text-muted-foreground">
          Think of these as curated playlists for your attention. Some are short. One is
          everything.
        </p>
      </div>
