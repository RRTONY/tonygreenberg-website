  ...
  return (
    <footer className="border-t border-border bg-linear-to-b from-background to-secondary px-6 py-10 text-center">
      ...
      <p className="mt-6 text-sm text-muted-foreground">
        ...
        &bull; Founder,{" "}
        <a href="https://impactsoul.is" target="_blank" rel="noopener noreferrer" className="text-brand-gold">
          ImpactSoul
        </a>{" "}
        ...
        &bull;{" "}
        <a href="https://linkedin.com/company/ramprate" target="_blank" rel="noopener noreferrer" className="text-brand-gold">
          RampRate LinkedIn
        </a>{" "}
        &bull;{" "}
        <a href="https://linkedin.com/company/impactsoul" target="_blank" rel="noopener noreferrer" className="text-brand-gold">
          ImpactSoul LinkedIn
        </a>{" "}
      ...
      <div className="mx-auto mt-6 max-w-2xl border-t border-border pt-5 font-mono text-[0.68rem] leading-relaxed tracking-wide text-muted-foreground">
        ...
        <br />
        All content, essays, frameworks, assessments, and intellectual property on this site are
        the exclusive property of Tony Greenberg and/or RampRate, Inc.
        <br />
        Unauthorized reproduction, scraping, mirroring, or redistribution is strictly prohibited
        and subject to legal action under the DMCA and applicable law.
        <br />
