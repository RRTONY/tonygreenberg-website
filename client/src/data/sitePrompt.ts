/**
 * UNIFIED SITE PROMPT — Content DNA for tonygreenberg.com
 * 
 * Every piece of content on this site ultimately demonstrates one thesis:
 * extractive capitalism is economically inefficient and morally bankrupt;
 * regenerative models built on trust, transparency, and aligned incentives
 * produce superior returns for all stakeholders.
 * 
 * This file is the single source of truth for content voice, thesis mapping,
 * research citations, and LP comparables. The newsletter draws from this.
 */

// ─── CORE THESIS ───────────────────────────────────────────────────────────────

export const CORE_THESIS = {
  statement: "Extractive capitalism is economically inefficient and morally bankrupt. Regenerative models built on trust, transparency, and aligned incentives produce superior returns for all stakeholders.",
  shortForm: "Extraction wastes. Regeneration compounds.",
  authorVoice: "First person. Direct. Earned authority from 25 years of building and advising, not academic distance. Thinks in frameworks, writes in stories.",
  toneRule: 'Never preachy — always "here\'s what I saw, here\'s what the data says, here\'s what I built because of it."',
} as const;
...
export interface SectionThesis {
  ...
  dataPoints: string[];
  tone: string;
  categoryMatch: string[]; // maps to blogData.json categories
}
...
export const SECTION_THESIS_MAP: SectionThesis[] = [
  {
    ...
    anchorContent: [
      ...
      "CIO accountability",
      "Startup-killing by incumbents",
    ],
    impactSoulConnection: "RampRate's SPY Index proved that collapsing information asymmetry saves hundreds of millions. On-chain transparency does the same for capital markets. Same principle, bigger canvas.",
    dataPoints: [
      "1M+ SPY Index data points",
      "$10B+ transactions analyzed",
      "25% avg cost reduction",
      "99% reduction in early termination risk",
    ],
    tone: "Sharp, numbers-forward, slightly impatient with waste",
    categoryMatch: ["Systems & Innovation", "Business & Capital"],
  },
  {
    slug: "business",
    ...
    anchorContent: [
      "Ethical vs. economic decisions",
      "Fee transparency",
      "Loyalty decay",
      "Supply chain to blockchain",
      "Grameen Bank/Yunus influence",
      "Macrobiotic lifestyle as business metaphor",
    ],
    impactSoulConnection: "The ABIT model eliminates the ethical-economic tug of war by structurally aligning investor returns with community impact. Not charity. Not CSR. The engine.",
    dataPoints: [
      "Grameen Bank repayment rates vs. traditional banking",
      "B Corp certification 2022",
      "XPRIZE $3M+ grant facilitated",
    ],
    tone: "Philosophical but grounded. Personal stories that lead to structural insight.",
    categoryMatch: ["Business & Capital", "Impact & Purpose"],
  },
  {
    slug: "tony",
    title: "Tony Section",
    ...
    anchorContent: [
      "Elixir",
      "Arithmetic of Relationships",
      "Mastering BD",
      "Way of DAO",
      "Conscious satisficing",
      "Psychedelic medicine",
      "Biometric optimization",
    ],
    impactSoulConnection: "An LP investing in a regenerative thesis needs to know the founder lives it. This section is the behavioral track record — 90% philanthropic distribution, diet-as-discipline, relationship calculus, ceremony as practice.",
    dataPoints: [
      "90% philanthropic distribution",
      "25 years consistent behavior",
      "Diet-as-discipline track record",
    ],
    tone: "Warm, experiential, vulnerable where appropriate. The human behind the spreadsheet.",
    categoryMatch: ["Living Well", "Culture & Communication"],
  },
  {
    slug: "tonyg",
    title: "TonyG Page",
    ...
    impactSoulConnection: "This IS the investor-facing page. Every line should answer: why is this person credible to build the anti-extraction financial instrument?",
    dataPoints: [
      "Fortune 500 client list",
      "25 years advisory track record",
      "B Corp certified",
    ],
    tone: "Confident, credential-dense, no wasted words. Let the client list and track record speak.",
    categoryMatch: ["Business & Capital"],
  },
  {
    slug: "crusades",
    title: "The Crusades",
    ...
    anchorContent: [
      "AI ethics and hidden pricing",
      "Toll road scams",
      "Customer service decay",
      "Fitness fraud",
      "Restaurant deception",
    ],
    impactSoulConnection: "Every crusade article is a case study in extraction. The pattern is always the same: opacity enables exploitation. Transparency is the antidote.",
    dataPoints: [
      "Specific dollar amounts lost by consumers",
      "Complaint counts and resolution rates",
      "Industry-specific fraud statistics",
    ],
    tone: "Snarky, righteous, data-backed outrage. The consumer advocate who does the math.",
    categoryMatch: ["The Crusades"],
  },
];
...
export const RESEARCH_LIBRARY: ResearchCitation[] = [
  {
    author: "Khalili",
    year: 2025,
    title: "Extractive Capitalism",
    publisher: "Profile Books",
    relevance: "Core framework for the extraction thesis",
  },
  {
    author: "IISD",
    year: 2019,
    ...
    relevance: "200+ blockchain impact projects catalogued",
  },
  {
    author: "Lansley",
    year: 2021,
    ...
    relevance: "Wealth concentration and inequality dynamics",
  },
  {
    author: "World Inequality Lab",
    year: 2025,
    title: "Global Wealth 1800-2025",
    publisher: "World Inequality Lab",
    relevance: "Historical wealth distribution data",
  },
  {
    author: "Robeyns",
    year: 2025,
    title: "Inequality as Central Priority",
    publisher: "Utrecht University",
    relevance: "Academic framework for inequality analysis",
  },
  {
    author: "Byrnes & Collins",
    year: 2017,
    title: "Equity Crisis: True Costs of Extraction",
    publisher: "Academic Press",
    relevance: "Quantified costs of extractive economic models",
  },
];
...
export const LP_COMPARABLES: LPComparable[] = [
  {
    name: "Republic",
    model: "Mirror tokens for retail access",
    entryPoint: "~$65/share",
    limitation: "No asset backing or impact alignment",
  },
  {
    name: "Calvert Impact Capital",
    model: "Community investment notes",
    entryPoint: "$20 minimum",
    limitation: "No DAO governance or on-chain transparency",
  },
  {
    name: "Patagonia",
    model: '"Earth is only shareholder" structure',
    entryPoint: "Not investable by public",
    limitation: "Single-company, no portfolio diversification",
  },
  {
    name: "ABITs (ImpactSoul)",
    model: "Asset backing + impact alignment + DAO governance",
    entryPoint: "Tokenized access",
    limitation: "No single comparable offers all three",
  },
];
...
export const NEVER_USE = [
  ...
  "I AM" /* use legacy/vision language instead */,
] as const;

// ─── NEWSLETTER THESIS THREADS ─────────────────────────────────────────────────
...
export interface ThesisThread {
  ...
  tagline: string;
  description: string;
  articleSlugs: string[]; // slugs from blogData.json that belong to this thread
}
...
export const THESIS_THREADS: ThesisThread[] = [
  {
    ...
    description: "How hidden fees, buried terms, and information asymmetry extract wealth from consumers and businesses alike. From AI pricing to toll roads to gym contracts — the pattern is always the same.",
    articleSlugs: [
  ...
  },
  {
    ...
    description: "The measurable ROI of trust, transparency, and relationship capital. From the Grameen Bank to B Corp certification to 25 years of vendor negotiation — the data says the same thing.",
    articleSlugs: [
  ...
  },
  {
    ...
    description: "Evidence that regenerative models outperform extractive ones. From impact tokens to conscious capital to the triple bottom line — the returns are real and the data is in.",
    articleSlugs: [
  ...
  },
  {
    ...
    description: "The lived experience that backs the thesis. Psychedelic medicine, biometric optimization, relationship calculus, ceremony as practice. An LP needs to know the founder lives it.",
    articleSlugs: [
  ...
  },
  {
    ...
    description: "Enterprise technology, CIO accountability, vendor negotiation, and the $10B+ of transactions that proved information asymmetry is the most expensive line item in any budget.",
    articleSlugs: [
  ...
  },
  {
    ...
    description: "How professional communication, customer service, and cultural standards have eroded — and what it costs. From phone calls to apologies to the death of clear speech.",
    articleSlugs: [
...
// ─── ARTICLE → THESIS CONNECTOR ────────────────────────────────────────────────

/**
 * Maps article slugs to their thesis connection sentence.
 * These are the "at least one sentence" that connects each article
...
export const THESIS_CONNECTORS: Record<string, string> = {
  ...
  "from-supply-chain-to-the-blockchain-heal":
    "The supply chain is where extraction hides. The blockchain is where it gets caught.",
  "the-way-of-dao":
    "DAOs aren't just governance structures — they're the organizational immune system against extraction.",
  "the-arithmetic-of-relationships":
    "Relationships compound. Extraction depletes. The arithmetic is simple, but most people are solving the wrong equation.",
  "human-operating-system":
    "The human operating system runs on trust. Every extractive interaction is a bug, not a feature.",
};

// ─── NEWSLETTER HELPERS ────────────────────────────────────────────────────────

/**
 * Get the thesis thread for a given article slug
 */
export function getThreadForArticle(slug: string): ThesisThread | undefined {
  return THESIS_THREADS.find(t => t.articleSlugs.includes(slug));
}

/**
 * Get the thesis connector sentence for a given article slug
 */
export function getThesisConnector(slug: string): string | undefined {
  return THESIS_CONNECTORS[slug];
}

/**
 * Get the section thesis mapping for a given category
 */
export function getSectionForCategory(category: string): SectionThesis | undefined {
  return SECTION_THESIS_MAP.find(s => s.categoryMatch.includes(category));
}

/**
 * Get all articles in a thesis thread
 */
export function getArticlesInThread(threadId: string): string[] {
  const thread = THESIS_THREADS.find(t => t.id === threadId);
