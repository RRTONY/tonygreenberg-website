  ...
  return (
    ...
    >
      <div className="mx-auto flex h-14 max-w-7xl items-center justify-between px-5">
        <Link
          href="/"
          className="flex items-center gap-1.5 text-sm font-medium text-crusade-muted/70 hover:text-crusade-muted"
        >
          <ChevronLeft size={16} />
        ...
        <Link href="/attention-theft" className="group flex items-center gap-2">
          <Flame
            size={22}
            className="text-crusade-red transition-transform group-hover:scale-110"
          />
