    ...
    <section className="relative overflow-hidden border-y-2 border-crusade-red bg-linear-to-r from-crusade-red/6 via-background to-crusade-red/6 px-5 py-8">
      <div className="relative mx-auto max-w-4xl text-center">
        ...
        <p className="mb-4 text-base leading-relaxed text-crusade-ink md:text-lg">
          Someone sent you this link because{" "}
          <strong className="text-crusade-red">{offender}</strong> has been called out for attention
          theft. This page explains why unsolicited commercial email is destroying the most
        ...
        <div className="flex items-center justify-center gap-4">
          ...
          <button
            ...
            className="text-xs text-crusade-muted/60 underline"
          >
            Dismiss
          </button>
        </div>
