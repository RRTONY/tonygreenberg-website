  ...
  return (
    <header className="sticky top-0 z-50 border-b border-kava-sand-muted bg-kava-sand backdrop-blur-sm">
      <div className="mx-auto flex h-14 max-w-7xl items-center justify-between px-5">
        <Link
          href="/"
          className="flex items-center gap-1.5 text-sm font-medium text-kava-ink opacity-60 hover:opacity-100"
        >
          <ChevronLeft size={16} />
        ...
        <Link href="/kava" className="flex items-center gap-2">
          ...
          <span className="font-heading text-base font-bold tracking-wide text-kava-ink">
            PRI KAVA
          </span>
        </Link>
          ...
          <div className="flex flex-col gap-1 px-5 py-3">
            ...
            <div className="mt-2 border-t border-kava-sand-muted pt-2">
              <Link
                href="/"
                onClick={() => setMenuOpen(false)}
                className="block rounded-md px-3 py-2.5 text-sm font-medium text-kava-ink opacity-60"
              >
...
export function KavaFooter() {
  return (
    <footer className="border-t border-kava-sand-muted px-5 py-8 text-center">
      <p className="mb-1 font-heading text-sm font-medium text-kava-saffron">
      ...
      <p className="text-xs text-kava-ink opacity-50">
        ...
        <br />
        Consult a licensed medical professional before making any changes to medications or health
        protocols.
      </p>
      <div className="mt-4 flex items-center justify-center gap-4">
        <Link
          href="/kava"
          className="text-xs font-medium text-kava-ink opacity-50 underline hover:opacity-100"
        >
          Kava Home
        </Link>
        <Link
