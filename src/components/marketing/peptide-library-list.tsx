                ...
                >
                  <div className="min-w-50 flex-1">
                    ...
                    <p className="text-xs text-muted-foreground">
                      {peptide.mechanism.slice(0, 80)}...
                    </p>
                  </div>
                  <span
                    className={`rounded px-2 py-0.5 text-[10px] font-bold uppercase ${safety.bg} ${safety.text}`}
                  >
                    {peptide.safetyTier}
                  </span>
                      ...
                      <div className="space-y-4">
                        ...
                        <div>
                          ...
                          <Link href="/whats-legal" className="text-xs text-[#C84B2A] underline">
                            Full regulatory details <ForwardIcon aria-hidden="true" />
                          </Link>
                        </div>
                        <div>
                          <p className="mb-1 text-xs font-bold tracking-wide text-muted-foreground uppercase">
                          ...
                          <Link href="/price-tracker" className="text-xs text-[#C84B2A] underline">
                            Compare all prices <ForwardIcon aria-hidden="true" />
                          </Link>
                        </div>
                      </div>
                      <div className="space-y-4">
