...
function scoreAnswer(answer: string): number {
  ...
  const hasConcreteAction = /built|launched|tested|shipped|deployed|created|established|funded|raised|hired/i.test(
    trimmed,
  );
            ...
            <div className="mb-8 grid gap-4">
              <div className="flex gap-4">
                ...
                <div>
                  ...
                  <p className="mt-0.5 text-sm text-muted-foreground">
                    Strategy session. Engagement terms are bespoke — discussed directly, not
                    listed. Recorded via Fireflies.
                  </p>
                </div>
              </div>
              <div className="flex gap-4">
              ...
              <div className="flex gap-4">
                ...
                <div>
                  ...
                  <p className="mt-0.5 text-sm text-muted-foreground">
                    Demonstrate action. Show what you&apos;ve done. Stage 2 unlocks only after
                    proof of execution.
                  </p>
                </div>
              </div>
      ...
      {step === "result" && outcome === "wrong-fit" && (
        <div className="mx-auto max-w-2xl px-6 py-16 text-center sm:px-10">
          ...
          <p className="mb-8 text-sm text-muted-foreground">
            In the meantime, the essays are free. The assessments are free. The frameworks are
            free. Take what&apos;s useful.
          </p>
