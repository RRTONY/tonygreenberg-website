...
// into Sanity for /the-letter's hero (see scripts/rescue-homepage-images.ts
// and this route's own generateMetadata OG image) — legacy's Blog.tsx (this
// route) and Home.tsx (/the-letter) both used the identical source file,
