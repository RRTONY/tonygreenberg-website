...
const QUESTIONS: Question[] = [
  {
    ...
    choices: [
      {
        label: "Why the systems that run the world seem designed to break people",
        weights: { thinker: 3, operator: 1, impact: 2 },
      },
      {
        label: "How to build something that actually matters — and make it last",
        weights: { operator: 3, impact: 2, body: 1 },
      },
      {
        label: "Whether the person next to me really sees me — and whether I see them",
        weights: { relationship: 3, body: 1, thinker: 1 },
      },
      {
        label: "What's happening inside my own body and mind — and how to optimize it",
        weights: { body: 3, thinker: 1, relationship: 1 },
      },
      {
        label: "Why people with power keep getting away with things that offend my soul",
        weights: { crusade: 3, impact: 2, thinker: 1 },
      },
    ],
  },
  {
    ...
    choices: [
      {
        label: "Connecting ideas that nobody else sees are related — and changing the conversation",
        weights: { thinker: 3, operator: 1 },
      },
      {
        label: "Running an operation so clean it makes competitors nervous and partners loyal",
        weights: { operator: 3, crusade: 1 },
      },
      {
        label: "Loving fearlessly — building a partnership that's both sacred and scientific",
        weights: { relationship: 3, body: 1 },
      },
      {
        label: "Living in a body that's a temple — sharp mind, clean blood, radiant energy",
        weights: { body: 3, impact: 1 },
      },
      {
        label:
          "Holding the powerful accountable — being the person who says what everyone's thinking",
        weights: { crusade: 3, impact: 1 },
      },
    ],
  },
  {
    ...
    choices: [
      {
        label: "That consciousness isn't woo-woo — it's the operating system underneath everything",
        weights: { thinker: 3, body: 2 },
      },
      {
        label:
          "That most businesses fail not from bad ideas but from bad vendor relationships and hidden fees",
        weights: { operator: 3, crusade: 2 },
      },
      {
        label:
          "That love has a science — attachment styles, communication patterns, the whole architecture",
        weights: { relationship: 3, thinker: 1 },
      },
      {
        label: "That what you eat, breathe, and absorb is literally rewriting your DNA every day",
        weights: { body: 3, crusade: 1 },
      },
      {
        label: "That profit and purpose were never supposed to be different departments",
        weights: { impact: 3, operator: 2 },
      },
    ],
  },
  {
    ...
    choices: [
      {
        label:
          "The philosophers arguing about whether AI has a soul — and the neuroscientist who thinks they're both wrong",
        weights: { thinker: 3, body: 1 },
      },
      {
        label:
          "The founders swapping war stories about scaling, negotiating, and the deals that got away",
        weights: { operator: 3, impact: 1 },
      },
      {
        label:
          "The couple who've been together 30 years and still look at each other like it's the first date",
        weights: { relationship: 3, impact: 1 },
      },
      {
        label:
          "The biohacker, the breathwork coach, and the sommelier debating whether wine counts as medicine",
        weights: { body: 3, relationship: 1 },
      },
      {
        label:
          "The investigative journalist, the B Corp founder, and the person who just sued their gym",
        weights: { crusade: 3, operator: 1 },
      },
    ],
  },
  {
    ...
    choices: [
      {
        label: '"They saw the pattern before anyone else — and had the courage to name it."',
        weights: { thinker: 3, impact: 1 },
      },
      {
        label: '"They built something real — and everyone who worked with them was better for it."',
        weights: { operator: 3, relationship: 1 },
      },
      {
        label:
          '"They loved deeply, and the people around them became more themselves because of it."',
        weights: { relationship: 3, body: 1 },
      },
      {
        label: '"They treated their body like a sacred instrument — and the music showed."',
        weights: { body: 3, thinker: 1 },
      },
      {
        label: '"They never looked away from injustice — and they made the bastards pay."',
        weights: { crusade: 3, impact: 2 },
      },
    ],
  },
];
...
const JOURNEYS: Record<string, JourneyResult> = {
  thinker: {
    ...
    description:
      "You see patterns where others see noise. Your mind moves between consciousness research, decentralized governance, and the question of what it means to be human in a century that keeps redefining the term. Start here.",
    icon: Circle,
    accent: "#6B4C8A",
    articles: [
      {
        ...
        why: "The talk that started it all — consciousness, technology, and the question nobody wanted to ask",
      },
      {
        slug: "psychedelics-could-become-extractive-capitalism",
        title: "Psychedelics Could Become Extractive Capitalism",
        why: "What happens when Wall Street discovers consciousness expansion",
      },
      {
        slug: "the-way-of-dao",
        title: "The Way of DAO",
        why: "Decentralized governance as a mirror for decentralized selfhood",
      },
      {
        slug: "human-operating-system",
        title: "Human Operating System",
        why: "The firmware update you didn't know you needed",
      },
      {
        slug: "the-molecule-as-mirror-from-substance-to-service",
        title: "The Molecule as Mirror",
        why: "From substance to service — the psychedelic thesis",
      },
      {
        slug: "a-historical-perspective-on-blockchain",
        title: "A Historical Perspective on Blockchain",
        why: "The long arc of decentralization — and why it matters to thinkers",
      },
    ],
  },
  operator: {
    ...
    description:
      "You run things. You build things. You've been burned by bad vendors and worse advice. You need someone who's sat across from Microsoft, Disney, and Goldman Sachs for 25 years. This path is the business case.",
    icon: Hexagon,
    accent: "#8B6914",
    articles: [
      {
        ...
        why: "The most-read business piece on the site — because everyone's been on the wrong end of bad service",
      },
      {
        slug: "davos-2022-world-economic-forum-here-we-come",
        title: "Davos 2022 — World Economic Forum",
        why: "What actually happens when the world's operators gather in one room",
      },
      {
        slug: "why-good-service-is-all-about-trust",
        title: "Why Good Service Is All About Trust",
        why: "The trust equation that separates operators from pretenders",
      },
      {
        slug: "profiling-the-public-cloud-buyer",
        title: "Profiling the Public Cloud Buyer",
        why: "25 years of benchmarking distilled into one framework",
      },
      {
        slug: "mastering-human-and-business-development",
        title: "Mastering Human & Business Development",
        why: "The intersection of personal growth and organizational scaling",
      },
      {
        slug: "from-supply-chain-to-the-blockchain-heal",
        title: "From Supply Chain to the Blockchain",
        why: "How infrastructure thinking applies to everything — including healing",
      },
    ],
  },
  relationship: {
    ...
    description:
      "A friend texted from Jerusalem asking about matchmaking. That text lit years of research on fire. This path traces the neuroscience of magnetic partnership, the arithmetic of mutual value, and the ties that bind us in a century trying to untie everything.",
    icon: InfinityIcon,
    accent: "#C4536A",
    articles: [
      {
        slug: "love-as-dharma-a-science-based-playbook-for-magnetic-partnership",
        title: "Love as Dharma — A Science-Based Playbook",
        why: "The article that started with a text from Jerusalem and ended with a mirror",
      },
      {
        slug: "the-ties-that-bind-interpersonal-relationships",
        title: "The Ties That Bind",
        why: "Interpersonal relationships amended for a century that keeps trying to untie them",
      },
      {
        slug: "the-arithmetic-of-relationships",
        title: "The Arithmetic of Relationships",
        why: "The math of mutual value — because love deserves a spreadsheet too",
      },
      {
        slug: "the-decay-of-modern-day-communication",
        title: "The Decay of Modern Day Communication",
        why: "Why we stopped talking — and what it costs us",
      },
      {
        slug: "only-time-buys-trust",
        title: "Trust Us? Are You Really My Friend?",
        why: "The trust equation underneath every relationship that matters",
      },
      {
        slug: "apologize",
        title: "I Apologize. Nix 'I Am Sorry' From Our Lexicon",
        why: "The linguistics of repair — and why most apologies make things worse",
      },
    ],
  },
  body: {
    ...
    description:
      "You own an Oura Ring. You've Googled 'peptides' at 2am. You suspect your doctor knows less about your blood than you do. This path connects health investments, alt therapy scorecards, psychedelic medicine, and longevity protocols — with measurement that makes it science, not woo-woo.",
    icon: Gem,
    accent: "#2E8B57",
    articles: [
      {
        slug: "forever-chemicals-in-my-blood-pfas-and-microplastics",
        title: "Forever Chemicals in My Blood",
        why: "What happens when you actually test for what's inside you",
      },
      {
        slug: "elixir-of-life-device-and-journey",
        title: "Elixir of Life Device and Journey",
        why: "The longevity stack — devices, protocols, and the quest for more time",
      },
      {
        slug: "the-molecule-as-mirror-from-substance-to-service",
        title: "The Molecule as Mirror",
        why: "Psychedelic medicine as biochemistry optimization",
      },
      {
        slug: "india-my-virtual-soul-home",
        title: "India: My Virtual Soul & Home",
        why: "Where the body meets the spirit — and the food is medicine",
      },
      {
        slug: "an-ode-to-kusaki-where-plants-become-culinary-masterpieces",
        title: "An Ode to Kusaki",
        why: "When plants become culinary masterpieces — food as sacred practice",
      },
      {
        slug: "eco-vegan-realities-seriesethical-economic",
        title: "Eco Vegan Realities",
        why: "The ethical economics of what goes into your body",
      },
    ],
  },
  impact: {
    ...
    description:
      "You believe profit and purpose shouldn't be different departments. You've heard about tokenization but aren't sure if it's real. This path walks through ImpactSoul's ABIT model, live token ecosystems, and why a dinosaur skeleton might fund a school in rural India.",
    icon: Target,
    accent: "#D4B96A",
    articles: [
      {
        slug: "return-on-investment-going-green-going-green-2",
        title: "Return on Investment — Going Green",
        why: "The most-read impact piece — because ROI and regeneration aren't mutually exclusive",
      },
      {
        slug: "energy-as-impact",
        title: "Energy as Impact",
        why: "Reframing energy from consumption to contribution",
      },
      {
        slug: "would-you-hire-someone-who-led-a-rebellion",
        title: "Would You Hire Someone Who Led a Rebellion?",
        why: "The character test for impact-driven leadership",
      },
      {
        slug: "triple-bottom-line-of-soul-gregory-markel",
        title: "Triple Bottom Line of Soul",
        why: "Trust + Empathy = Business + Future",
      },
      {
        slug: "the-tug-of-war-ethical-vs-economic-decisions",
        title: "The Tug of War — Ethical vs. Economic",
        why: "The tension that defines every meaningful business decision",
      },
      {
        slug: "powering-purpose-driven-innovation",
        title: "Powering Purpose-Driven Innovation",
        why: "The engine room of impact at breakneck speed",
      },
    ],
  },
  crusade: {
    ...
    description:
      "You've been screwed by a company with dark patterns and fake reviews. You didn't write a Yelp review — you wanted to burn the building down (metaphorically). This path is for consumer advocates, whistleblowers, and anyone who believes the crusade IS the product.",
    icon: Swords,
    accent: "#B22222",
    articles: [
      {
        ...
        why: "The most-read crusade — because hidden fees are a moral failure",
      },
      {
        slug: "dmn8-the-most-beautiful-crooked-gym-in-the-world",
        title: "DMN8: The Most Beautiful Crooked Gym",
        why: "When aesthetics mask exploitation — the full investigation",
      },
      {
        slug: "how-to-alienate-a-loyal-vegan",
        title: "How to Alienate a Loyal Vegan",
        why: "Decades of loyalty destroyed by one act of corporate indifference",
      },
      {
        slug: "restaurants-beware-of-vegans-and-vegans-beware-of-lying-restaurants",
        title: "Restaurants Beware of Vegans",
        why: "The deception economy in food — and why it matters",
      },
      {
        ...
        why: "When your favorite restaurant is secretly destroying the planet",
      },
      {
        slug: "forward-health-is-a-sideway-step-at-best",
        title: "Forward Health Is a Sideways Step",
        why: "Healthcare disruption that disrupts nothing",
      },
    ],
  },
};
            ...
            {[
              {
                ...
                desc: "Not who you want to be. Who you are at 2 a.m.",
              },
              {
                num: "02",
                label: "Get your map",
                desc: "We score across six territories and find your primary path.",
              },
              {
                num: "03",
                label: "Start reading",
                desc: "Six curated articles — the ones that'll hit hardest for you.",
              },
            ].map((s) => (
              <div key={s.num}>
                <span className="font-mono text-xs tracking-[0.15em] text-brand-gold">{s.num}</span>
                <h3 className="mt-1.5 mb-1 font-heading text-lg font-normal text-[#FAFAF7]">
                  {s.label}
                </h3>
          ...
          <div className="mx-auto max-w-2xl">
              ...
              {q.choices.map((choice, i) => {
                ...
                return (
                  ...
                  >
                    ...
                    <span
                      className={`leading-relaxed ${isSelected ? "text-[#FAFAF7]" : "text-[#AAA]"}`}
                    >
                      {choice.label}
                    </span>
                  </button>
            ...
            <div className="flex justify-between">
              ...
              >
                {step === totalQuestions ? (
                  <>
                    See My Path <ForwardIcon aria-hidden="true" />
                  </>
                ) : (
                  <>
    ...
    <div className="bg-[#0A0A10]">
      <div className="px-6 py-24 sm:px-10">
        <div className="mx-auto max-w-2xl">
          ...
          <p
            className="mb-5 font-mono text-xs tracking-wide uppercase"
      ...
      <div className="border-t border-brand-gold/10 px-6 py-10 sm:px-10">
        <div className="mx-auto max-w-2xl">
          <h3 className="mb-6 font-mono text-xs tracking-wide text-brand-gold uppercase">
            Your Territory Map
          </h3>
          ...
          <div className="flex flex-col gap-5">
            {result.articles.map((article, i) => (
              ...
              >
                ...
                <div>
                  <h4 className="mb-1 font-heading text-base font-normal text-[#FAFAF7]">
                    {article.title}
                  </h4>
      ...
      <div className="border-t border-brand-gold/10 px-6 py-14 text-center sm:px-10">
        <div className="mx-auto max-w-xl">
          ...
          <p className="mb-8 text-[#777]">
            ...
            <strong style={{ color: allScores[1]?.journey.accent }}>
              {allScores[1]?.journey.title}
            </strong>
            {(allScores[2]?.score ?? 0) > 0 && (
              <>
                {" "}
                and{" "}
                <strong style={{ color: allScores[2]?.journey.accent }}>
                  {allScores[2]?.journey.title}
                </strong>
              </>
            )}
            .
