          ...
          {(["score", "questions", "name"] as const).map((s) => (
            <button
              ...
              className={`rounded border px-3 py-1.5 font-mono text-xs tracking-wide uppercase ${
                sortBy === s ? "border-brand-gold bg-brand-gold/10 text-brand-gold" : "border-border text-muted-foreground"
              }`}
            >
              ...
              {isExpanded && (
                <div className="border-t border-border p-5 pt-4">
                  <div className="grid gap-4 sm:grid-cols-2">
                    <div>
                      <h4 className="mb-2 font-mono text-xs tracking-wide text-[#B22222] uppercase">Weaknesses</h4>
                      <p className="text-sm leading-relaxed text-foreground/80">{clinic.weaknesses}</p>
                    </div>
                    <div>
                      <h4 className="mb-2 font-mono text-xs tracking-wide text-[#2E8B57] uppercase">Strengths</h4>
                        ...
                        return (
                          <span
                            ...
                            className={`rounded px-1.5 py-0.5 font-mono text-[0.6rem] ${
                              met ? "bg-[#2E8B57]/10 text-[#2E8B57]" : "bg-[#B22222]/10 text-[#B22222]"
                            }`}
                          >
                            {met ? "✓" : "✗"} {c.label}
                          </span>
