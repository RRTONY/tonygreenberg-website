...
const SHARE_TEXT =
  "The Psychedelic Readiness Index ... find your medicine match. 39 substances, 6 domains, hard-stop screening, medication interaction matrix.";
...
export function PriShareBar() {
  ...
  return (
    <div className="text-center">
      <div className="mb-3 text-xs font-bold tracking-[0.12em] text-pri-purple-light uppercase">
      ...
      <div className="flex flex-wrap justify-center gap-3">
        ...
        <a
          href={`mailto:?subject=${encodeURIComponent("The Psychedelic Readiness Index")}&body=${encodeURIComponent(SHARE_TEXT + "\n\n" + SHARE_URL)}`}
          className={BTN_CLASS}
        >
