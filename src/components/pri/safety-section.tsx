  ...
  return (
    <div>
      <div className="mb-4 border-l-4 border-pri-purple bg-pri-purple/8 p-5">
        <div className="mb-1 text-xs font-extrabold tracking-[0.08em] text-pri-purple uppercase">
          Safety Warning
        </div>
      ...
      <div className="mt-5 mb-1 text-[.7rem] font-extrabold tracking-[0.12em] text-[#E65100] uppercase">
        Drug Interactions
      </div>
      ...
      <div className="bg-pri-cream p-4 text-[.88rem] leading-[1.7] text-pri-brown">
