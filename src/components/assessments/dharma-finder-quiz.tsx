    ...
    return (
      <div className="relative z-1 flex min-h-screen flex-col font-sans text-[#2C1810]">
        ...
        <div className="relative z-1 mx-auto flex w-full max-w-2xl flex-1 flex-col justify-center px-6 pt-24 pb-12">
          {isFirstInSection && (
            <div className="mb-8">
              ...
              <h2 className="mb-2 font-heading text-[clamp(1.4rem,2.5vw,1.8rem)] font-normal">{section.subtitle}</h2>
              <blockquote className="mt-4 border-l-2 border-brand-gold-light pl-4 text-[0.95rem] text-[#5A4A3A] italic">
                &ldquo;{section.quote.text}&rdquo;
                <br />
                <span className="font-mono text-[0.75rem] text-brand-gold not-italic">— {section.quote.author}</span>
              </blockquote>
          ...
          <div className="mt-8 flex items-center justify-between">
            ...
            <button onClick={goNext} className="rounded-sm bg-brand-gold px-6 py-2.5 font-mono text-[0.75rem] tracking-[0.15em] text-[#F5F0E0] uppercase">
        ...
        <div className="border-t border-brand-gold/10 px-6 py-8 text-center">
          ...
          <p className="mt-2 font-mono text-[0.65rem] text-[#B8A898]">Full 3-hour version (200+ questions) available at civilizationemerging.com</p>
        </div>
      </div>
    );
  }
  ...
  return (
    <div className="relative z-1 min-h-screen font-sans text-[#2C1810]">
      ...
      <div className="border-b border-brand-gold/10 p-6 text-center">
        <Link href="/find-your-me" className="font-mono text-[0.65rem] tracking-[0.1em] text-[#4A3A2A]">
          ← Back to Find My
        </Link>
      </div>
