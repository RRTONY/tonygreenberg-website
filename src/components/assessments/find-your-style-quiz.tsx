...
const ARCHETYPES = {
  minimalist: {
    name: "The Minimalist",
    description:
      "Purity of form, clarity of purpose. You appreciate clean lines, muted palettes, and the power of reduction.",
  },
  maximalist: {
    name: "The Maximalist",
    description:
      "More is more. Life is a canvas, and you paint it with bold colors, vibrant patterns, and expressive layers.",
  },
  vintageCurator: {
    name: "The Vintage Curator",
    description:
      "Every piece tells a story. You are drawn to the history, craftsmanship, and soul of secondhand and heritage garments.",
  },
  streetwearArchitect: {
    name: "The Streetwear Architect",
    description:
      "The city is your runway. You build your identity from the ground up with iconic brands, cultural codes, and urban functionality.",
  },
  tailoredClassic: {
    name: "The Tailored Classic",
    description:
      "Enduring elegance, crafted to last. You invest in timeless silhouettes, impeccable tailoring, and the quiet confidence of quality.",
  },
  avantGarde: {
    name: "The Avant-Garde",
    description:
      "Dress to challenge, not to conform. You use clothing as a medium for artistic experimentation, pushing boundaries of form and function.",
  },
} as const;
...
const QUESTIONS: {
  ...
  },
  {
    ...
    options: [
      {
        text: "Perfectly tailored trousers and a crisp shirt.",
        scores: { silhouette: 1, sustainability: 1 },
      },
      {
        text: "A rare band t-shirt and worn-in jeans.",
        scores: { culturalReference: 2, sustainability: 1 },
      },
      {
        text: "A deconstructed jacket that plays with proportion.",
        scores: { selfExpression: 2, silhouette: 1 },
      },
      {
        text: "A monochrome sweatsuit in luxurious cotton.",
        scores: { textureSensitivity: 1, colorPhilosophy: -1 },
      },
    ],
  },
  {
    ...
    options: [
      {
        text: "A strict, curated palette of neutrals.",
        scores: { colorPhilosophy: -2, silhouette: 1 },
      },
      {
        text: "Bold, unexpected color combinations.",
        scores: { colorPhilosophy: 2, selfExpression: 1 },
      },
      {
        text: "Colors with a vintage or faded quality.",
        scores: { culturalReference: 1, sustainability: 1 },
      },
      {
        text: "Color is secondary to texture and material.",
        scores: { textureSensitivity: 2, colorPhilosophy: -1 },
      },
    ],
  },
  {
    ...
    options: [
      ...
      {
        text: "Is it made from a natural, interesting material?",
        scores: { textureSensitivity: 2 },
      },
  ...
  },
  {
    ...
    options: [
      {
        text: "'Invest in classics. Quality over quantity.'",
        scores: { sustainability: 2, silhouette: 1 },
      },
      {
        text: "'Don't be afraid to clash patterns and colors.'",
        scores: { selfExpression: 1, colorPhilosophy: 2 },
      },
  ...
  },
  {
    ...
    options: [
      {
        text: "A single, beautifully crafted leather belt.",
        scores: { silhouette: 1, sustainability: 1 },
      },
      {
        text: "A stack of mismatched, colorful bracelets.",
        scores: { colorPhilosophy: 1, selfExpression: 1 },
      },
      {
        text: "A vintage silk scarf with a story.",
        scores: { culturalReference: 2, sustainability: 1 },
      },
      {
        text: "An architecturally interesting piece of jewelry.",
        scores: { silhouette: 2, selfExpression: 1 },
      },
    ],
  },
  {
  ...
  },
  {
    ...
    options: [
      ...
      {
        text: "I appreciate them as part of a design's history.",
        scores: { culturalReference: 1, selfExpression: 1 },
      },
      {
        text: "I like them big and bold, as a graphic element.",
        scores: { colorPhilosophy: 1, selfExpression: 1 },
      },
      {
        text: "The only name that matters is the tailor's.",
        scores: { sustainability: 1, silhouette: 1 },
      },
    ],
  },
  {
    ...
    options: [
      {
        text: "Smooth, crisp, cool-to-the-touch cotton.",
        scores: { textureSensitivity: 2, silhouette: 1 },
      },
      {
        text: "Chunky, hand-knit wool or complex jacquard.",
        scores: { textureSensitivity: 2, colorPhilosophy: 1 },
      },
      {
        text: "Soft, worn-in denim or buttery, aged leather.",
        scores: { sustainability: 2, culturalReference: 1 },
      },
      {
        text: "Unconventional materials like neoprene or vinyl.",
        scores: { selfExpression: 2, silhouette: 1 },
      },
    ],
  },
  {
    ...
    options: [
      ...
      {
        text: "A rare, archival designer piece.",
        scores: { culturalReference: 2, sustainability: 1 },
      },
  ...
  },
  {
    ...
    options: [
      {
        text: "I follow them and enjoy interpreting them.",
        scores: { culturalReference: 1, selfExpression: 1 },
      },
      {
        text: "I'm more interested in timeless pieces.",
        scores: { sustainability: 2, silhouette: 1 },
      },
      { text: "I'm usually ahead of them or ignoring them.", scores: { selfExpression: 2 } },
      {
        text: "I prefer styles from the past over what's current.",
        scores: { culturalReference: 2, sustainability: 1 },
      },
    ],
  },
  {
    ...
    options: [
      ...
      {
        text: "Asymmetrical, deconstructed, and unexpected.",
        scores: { silhouette: 2, selfExpression: 2 },
      },
      {
        text: "A comfortable, functional, utilitarian shape.",
        scores: { silhouette: 1, sustainability: 1 },
      },
    ],
  },
  {
    ...
    options: [
      {
        text: "A stunning vintage gown no one else will have.",
        scores: { culturalReference: 2, sustainability: 2 },
      },
      {
        text: "A sleek, minimalist jumpsuit in a bold color.",
        scores: { silhouette: 2, colorPhilosophy: 1 },
      },
      {
        text: "A custom-tailored suit that fits like a glove.",
        scores: { silhouette: 2, sustainability: 1 },
      },
      {
        text: "A riot of color, pattern, and texture.",
        scores: { colorPhilosophy: 2, selfExpression: 2 },
      },
    ],
  },
  {
    ...
    options: [
      ...
      {
        text: "'Why blend in when you were born to stand out?'",
        scores: { selfExpression: 2, colorPhilosophy: 1 },
      },
      {
        text: "'My clothes are my armor and my biography.'",
        scores: { culturalReference: 2, selfExpression: 1 },
      },
    ],
  },
];
...
function pickArchetype(scores: Record<Dimension, number>) {
  ...
  if (scores.culturalReference > 4 && scores.selfExpression > 3)
    return ARCHETYPES.streetwearArchitect;
...
export function FindYourStyleQuiz() {
  ...
  const archetype = useMemo(
    () => (phase === "results" ? pickArchetype(scores) : null),
    [phase, scores],
  );
  ...
  return (
    <div className="relative z-1 min-h-screen font-sans text-[#2C1810]">
      ...
      {phase === "results" && !emailGated && (
        <EmailGate assessmentSlug="style" onUnlock={() => setEmailGated(true)} />
      )}
      ...
      {phase === "results" && emailGated && archetype && (
        <div className="relative z-1 mx-auto max-w-3xl px-6 py-16 text-center">
          ...
          <div className="flex flex-wrap items-center justify-center gap-16">
            ...
            <div>
              <h3 className="mb-4 text-left font-heading text-2xl text-brand-gold">
                Dimension Scores
              </h3>
