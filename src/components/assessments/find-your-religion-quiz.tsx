...
const QUESTIONS: Question[] = [
  {
    ...
    choices: [
      c("A personal presence — something that knows me and cares", {
        transcendence: 3,
        community: 1,
      }),
      c("An impersonal force — consciousness, energy, the ground of being", {
        transcendence: 2,
        mysticism: 2,
      }),
  ...
  },
  {
    ...
    choices: [
      c("In nature — mountains, oceans, forests, the night sky", {
        transcendence: 2,
        embodiment: 2,
      }),
  ...
  },
  {
    ...
    choices: [
      c("Something continues — a soul, a consciousness, a return", {
        transcendence: 3,
        mysticism: 1,
      }),
      c("We merge back into the whole — individual identity dissolves", {
        mysticism: 3,
        transcendence: 1,
      }),
  ...
  },
  {
    ...
    choices: [
      c("It's essential — tradition carries wisdom that individuals can't generate alone", {
        structure: 3,
        community: 1,
      }),
      c("It's useful but needs constant reform — the container matters, but so does updating it", {
        structure: 2,
        pluralism: 2,
      }),
      c("It's mostly harmful — power structures dressed up as spirituality", {
        ethics: 2,
        pluralism: 2,
      }),
      c("I take what works and leave the rest — I'm building my own practice", {
        pluralism: 2,
        mysticism: 2,
      }),
    ],
  },
  {
    ...
    choices: [
      c("Divinely inspired — they carry authority that human reason alone can't match", {
        structure: 3,
        transcendence: 1,
      }),
      c("Profound human wisdom — not literally divine, but deeply true", {
        structure: 1,
        pluralism: 2,
        ethics: 1,
      }),
      c("Cultural artifacts — interesting but not binding on my life", {
        pluralism: 2,
        embodiment: 2,
      }),
      c("I find more truth in poetry, philosophy, or direct experience", {
        mysticism: 2,
        embodiment: 2,
      }),
    ],
  },
  {
    ...
    choices: [
      c("Central — I need to practice with others, worship together, belong to something", {
        community: 3,
        structure: 1,
      }),
      c(
        "Important but not essential — I value spiritual friendship but don't need a congregation",
        { community: 2, pluralism: 2 },
      ),
      c("My spiritual life is mostly private — community is for other things", {
        mysticism: 2,
        embodiment: 2,
      }),
      c("I find community in shared action — building, serving, creating together", {
        community: 2,
        ethics: 2,
      }),
    ],
  ...
  },
  {
    ...
    choices: [
      c("I crave it — ritual grounds me and connects me to something ancient", {
        structure: 3,
        community: 1,
      }),
      c("I appreciate it when it's authentic, not performative", { practice: 2, community: 2 }),
      c("I create my own — personal rituals that mean something to me specifically", {
        mysticism: 2,
        embodiment: 2,
      }),
      c("I don't need it — I find meaning in more spontaneous ways", {
        pluralism: 2,
        embodiment: 2,
      }),
    ],
  },
  {
    ...
    choices: [
      c("Yes — and it changed everything. I've been trying to get back there ever since.", {
        mysticism: 3,
        transcendence: 1,
      }),
      c("Yes — but I interpret it through a specific tradition or framework", {
        mysticism: 2,
        structure: 2,
      }),
      c("Maybe — I've had moments of awe or connection but I wouldn't call them mystical", {
        embodiment: 2,
        pluralism: 2,
      }),
  ...
  },
  {
    ...
    choices: [
      c("It's where I meet God — or whatever I call the deepest thing", {
        mysticism: 3,
        transcendence: 1,
      }),
      c("It's uncomfortable but I know it's medicine — I'm learning to sit with it", {
        practice: 3,
        mysticism: 1,
      }),
  ...
  },
  {
    ...
    choices: [
      c("They're sacred technologies — some of the most important tools we have", {
        mysticism: 3,
        embodiment: 1,
      }),
      c("Interesting but not my path — I prefer practices that don't require substances", {
        practice: 2,
        structure: 2,
      }),
      c("Dangerous without proper context — set, setting, and tradition matter enormously", {
        structure: 2,
        community: 2,
      }),
      c("Not for me — I trust reason and grounded experience over altered states", {
        ethics: 2,
        embodiment: 2,
      }),
    ],
  },
  {
    ...
    choices: [
      c("From God or divine revelation — there are absolute moral truths", {
        transcendence: 2,
        structure: 2,
      }),
      c("From human reason and empathy — we figure it out together", { ethics: 3, pluralism: 1 }),
      c("From the consequences of our actions — what reduces suffering is good", {
        ethics: 2,
        embodiment: 2,
      }),
  ...
  },
  {
    ...
    choices: [
      c("Inseparable — if your spirituality doesn't make you fight for justice, it's escapism", {
        ethics: 3,
        community: 1,
      }),
      c("Connected but distinct — inner work and outer work feed each other", {
        ethics: 2,
        practice: 2,
      }),
      c("Spirituality is primarily about inner transformation — the world changes when we change", {
        mysticism: 2,
        practice: 2,
      }),
  ...
  },
  {
    ...
    choices: [
      c("It has meaning — suffering is a teacher, a crucible, part of a larger plan", {
        transcendence: 2,
        structure: 2,
      }),
      c(
        "It's the first noble truth — life includes suffering, and liberation comes from understanding it",
        { practice: 2, mysticism: 2 },
      ),
      c("It's mostly unnecessary — caused by systems we could change if we had the will", {
        ethics: 3,
        community: 1,
      }),
      c("It just is — not meaningful, not meaningless. The question is how we respond", {
        embodiment: 3,
        pluralism: 1,
      }),
    ],
  },
  {
    ...
    choices: [
      c("Yes — prayer, meditation, or devotional reading. It's the anchor of my day.", {
        practice: 3,
        structure: 1,
      }),
      c("I try — but consistency is hard. I practice in seasons.", { practice: 2, pluralism: 2 }),
      c("My practice is embodied — yoga, walking, cooking, being in nature", {
        embodiment: 3,
        practice: 1,
      }),
      c("Not really — I'm more spontaneous than disciplined about these things", {
        pluralism: 2,
        embodiment: 2,
      }),
    ],
  },
  {
    ...
    choices: [
      c("The body is sacred — incarnation is the point, not an obstacle", {
        embodiment: 3,
        mysticism: 1,
      }),
      c("The body is a vehicle — important but not the destination", {
        transcendence: 2,
        practice: 2,
      }),
      c("The body is where practice happens — posture, breath, sensation are the path", {
        practice: 3,
        embodiment: 1,
      }),
      c("I'm honestly disconnected from my body in spiritual contexts — it's mostly a head thing", {
        structure: 2,
        ethics: 2,
      }),
    ],
  },
  {
    ...
    choices: [
      c("Essential — I need someone further along the path to guide me", {
        structure: 3,
        practice: 1,
      }),
      ...
      c("The best teacher is direct experience — everything else is commentary", {
        mysticism: 3,
        embodiment: 1,
      }),
    ],
  ...
  },
  {
    ...
    choices: [
      c("Yes — love transcends tradition, and the differences would enrich us", {
        pluralism: 3,
        community: 1,
      }),
      c("Maybe — it would depend on how important their practice is to them", {
        pluralism: 2,
        community: 2,
      }),
      c("It would be hard — shared spiritual life is too important to me", {
        community: 2,
        structure: 2,
      }),
      c("No — I need someone who shares my path at the deepest level", {
        structure: 3,
        community: 1,
      }),
    ],
  },
  {
    ...
    choices: [
      c("The relationship — with God, with the divine, with whatever I call the deepest thing", {
        transcendence: 3,
        mysticism: 1,
      }),
      c("The community — the people who practice with me, who hold me accountable", {
        community: 3,
        structure: 1,
      }),
      c("The practice — meditation, prayer, the daily discipline that keeps me sane", {
        practice: 3,
        embodiment: 1,
      }),
      c("The ethics — the commitment to justice, compassion, and reducing suffering", {
        ethics: 3,
        pluralism: 1,
      }),
    ],
...
const TRADITIONS: Tradition[] = [
  {
    ...
    tension: [
      "May struggle with doubt as betrayal rather than growth",
      "Can become dependent on emotional experiences of God",
    ],
  },
  {
    ...
    tension: [
      "May confuse tradition with truth",
      "Can resist necessary evolution",
      "Risk of spiritual rigidity",
    ],
  },
  {
    ...
    practices: [
      "Communal worship and singing",
      "Small group fellowship",
      "Shared meals and celebrations",
      "Service projects and mutual aid",
    ],
    keyTexts: [
      "Acts 2 (early church community)",
    ...
    tension: [
      "May avoid solitary practice that's also necessary",
      "Can become codependent on community approval",
      "Risk of groupthink",
    ],
  },
  {
    ...
    practices: [
      ...
      "Ecstatic practices (breathwork, chanting, dance)",
    ],
    keyTexts: [
      "The Tao Te Ching",
      "The Upanishads",
    ...
    tension: [
      ...
      "Can become spiritually bypassing",
      "Risk of guru dependency",
    ],
  },
  {
    name: "The Prophet",
    ...
    practices: [
      ...
      "Ethical living and simplicity",
      "Prophetic witness",
      "Community organizing",
    ],
    keyTexts: [
      "The Hebrew Prophets (Amos, Isaiah, Micah)",
    ...
    tension: [
      "May burn out from constant moral urgency",
      "Can become self-righteous",
      "Risk of reducing spirituality to politics",
    ],
  },
  {
    ...
    description:
      "For you, spirituality is a discipline — not a feeling, not a belief, but a daily practice that shapes who you become. You meditate, you pray, you do yoga, you sit — not because it feels good (though sometimes it does) but because the practice itself is the transformation. You trust the process more than the peak experience. You know that showing up is 90% of enlightenment.",
    practices: [
  ...
  },
  {
    ...
    practices: [
      ...
      "Interfaith dialogue",
      "Personal synthesis and experimentation",
    ...
    tension: [
      "May lack depth from lack of commitment",
      "Can become a spiritual tourist",
      "Risk of appropriation without accountability",
    ],
  },
  {
    name: "The Grounded",
    ...
    description:
      "Your spirituality is rooted in this world, this body, this moment. You're skeptical of otherworldly promises and transcendent escapes. For you, the sacred is in the ordinary — in a good meal, in honest work, in the feel of soil under your fingernails. You might not call yourself spiritual at all, but you live with a presence and intentionality that many religious people envy. You've found that paying attention is the highest form of prayer.",
    practices: [
      "Mindful daily living",
      "Nature immersion",
      "Cooking, gardening, craft",
    ...
    tension: [
      "May dismiss genuine transcendent experiences",
      "Can become spiritually isolated",
      "Risk of reducing the sacred to the material",
    ],
  },
];
...
function computeResults(answers: Record<number, number>) {
  ...
  const sorted = [...TRADITIONS].sort(
    (a, b) => (normalized[b.primaryDimension] || 0) - (normalized[a.primaryDimension] || 0),
  );
      ...
      <section className="mx-auto max-w-3xl px-6 pb-12 text-center">
        ...
        <div className="mt-8 grid gap-3 [grid-template-columns:repeat(auto-fit,minmax(140px,1fr))]">
          {DIMENSIONS.map((dim) => (
            <div
              key={dim}
              className={`rounded-lg border p-3 ${dim === top.primaryDimension ? "border-brand-gold-light/30" : "border-black/5"}`}
            >
              <div className="mb-1 font-mono text-[0.6rem] tracking-[0.05em] text-[#888]">
                {DIMENSION_LABELS[dim]}
              </div>
              <div
                className={`font-heading text-xl ${dim === top.primaryDimension ? "text-brand-gold" : "text-[#5A4A3A]"}`}
              >
                {scores[dim] || 0}
              </div>
            </div>
          ...
          {[
            {
              ...
              desc: "35 questions mapping your spiritual landscape across 10 dimensions",
