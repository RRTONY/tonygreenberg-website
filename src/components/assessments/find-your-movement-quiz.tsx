...
const QUESTIONS: {
  ...
  },
  {
    ...
    options: [
      ...
      {
        text: "A competitive game of soccer or basketball",
        scores: { Community: 3, Endurance: 1 },
      },
      {
        text: "A silent retreat with meditation and yoga",
        scores: { Mindfulness: 3, Flexibility: 1 },
      },
  ...
  },
  {
    ...
    options: [
      ...
      {
        text: "Find a way to move around it gracefully",
        scores: { Flexibility: 2, Mindfulness: 1 },
      },
  ...
  },
  {
    ...
    options: [
      {
        text: "Seeing measurable gains in strength or speed",
        scores: { Strength: 2, Endurance: 1 },
      },
  ...
  },
  {
    ...
    options: [
      ...
      {
        text: "Minimal and functional (yoga mat, resistance bands)",
        scores: { Flexibility: 2, Strength: 1 },
      },
      {
        text: "Just my own body and the ground beneath me",
        scores: { Endurance: 2, Adventure: 1 },
      },
      {
        text: "Specialized gear for a specific sport or art",
        scores: { Mindfulness: 2, Community: 1 },
      },
    ],
  },
  {
  ...
  },
  {
    ...
    options: [
      {
        text: "By how much weight I can lift or how fast I can run",
        scores: { Strength: 2, Endurance: 1 },
      },
      {
        text: "By how connected I feel to my body and mind",
        scores: { Mindfulness: 3, Flexibility: 1 },
      },
...
type Dimension =
  "Strength" | "Flexibility" | "Endurance" | "Mindfulness" | "Community" | "Adventure";
    ...
    <div className="relative z-1 flex min-h-screen flex-col items-center justify-center font-sans text-[#2C1810]">
      ...
      {phase === "results" && emailGated && (
        <div className="relative z-1 max-w-150 px-6 text-center">
          ...
          <h2 className="mb-6 font-heading text-3xl text-brand-gold italic">
            The {topDimension?.[0] ?? "Explorer"} Path
          </h2>
          <p className="mb-8 text-[1.1rem] leading-loose text-[#2C1810]">
            Your body wants to move with purpose. Your highest dimension is {topDimension?.[0]},
            suggesting a movement practice that honors both physical capacity and inner alignment.
          </p>
          <div className="mb-8 flex flex-wrap justify-center gap-3">
            {Object.entries(scores).map(([dim, val]) => (
              <div
                key={dim}
                className="rounded-md border border-brand-gold/20 bg-brand-gold-light/10 px-4 py-2.5 font-mono text-[0.8rem]"
              >
                {dim}: {val}
              </div>
            ))}
