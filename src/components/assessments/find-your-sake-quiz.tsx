...
const QUESTIONS: { stem: string; subtext: string; choices: { text: string; dimensions: Partial<Record<Dimension, number>> }[] }[] = [
  { stem: "Close your eyes. What does comfort taste like?", subtext: "Not the food. The feeling in your mouth.", choices: [
    ...
    c("Dry and mineral — like licking a river stone in the best possible way", { palate: 3, philosophy: 1 }),
    c("Soft and round — like a whisper that fills the whole room", { palate: 2, ritual: 2 }),
  ] },
  { stem: "You're handed a glass of something you've never tried. What do you notice first?", subtext: "The first thing that registers before thinking kicks in.", choices: [
    c("The aroma — I'm already reading the story before it touches my lips", { palate: 3, philosophy: 1 }),
    c("The weight — how it sits in the glass, the viscosity, the promise of body", { palate: 3, terroir: 1 }),
    c("The temperature — cold, warm, room temp tells me everything about intention", { ritual: 3, palate: 1 }),
    c("The vessel — the cup or glass is the first chapter of the experience", { ritual: 3, season: 1 }),
  ] },
  { stem: "Which of these textures makes your nervous system exhale?", subtext: "Texture is the body's way of choosing before the mind catches up.", choices: [
    c("Silk — effortless, barely there, gone before you realize it arrived", { palate: 3, season: 1 }),
    c("Cream — full, coating, the kind of presence that lingers", { palate: 3, terroir: 1 }),
    c("Crisp — like biting into a cold apple at the exact right moment", { palate: 3, philosophy: 1 }),
    c("Velvet — weight without heaviness, warmth without heat", { palate: 2, ritual: 2 }),
  ] },
  { stem: "When a drink is perfect, what happens in your body?", subtext: "Not what you think. What you feel.", choices: [
    c("My shoulders drop — it's relief, like the first breath after holding one too long", { palate: 2, philosophy: 2 }),
    c("My eyes close — the taste demands my full attention, everything else disappears", { palate: 2, ritual: 2 }),
    c("I smile involuntarily — surprise and recognition at the same time", { palate: 2, season: 2 }),
    c("I go quiet — something sacred just happened and words would ruin it", { palate: 1, ritual: 2, terroir: 1 }),
  ] },
  { stem: "How do you prefer to drink?", subtext: "The context is the content.", choices: [
    c("Alone, slowly, as a form of meditation — the drink is the companion", { ritual: 3, philosophy: 1 }),
    c("With one other person, sharing the bottle like sharing a secret", { ritual: 3, season: 1 }),
    c("At a table full of people, where the drink is the thread connecting the conversation", { ritual: 3, terroir: 1 }),
    c("Standing at a counter, watching someone who loves their craft pour it for me", { ritual: 2, terroir: 2 }),
  ] },
  { stem: "What's the right amount of ceremony?", subtext: "Between carelessness and preciousness, where do you live?", choices: [
    c("Maximum — the ritual IS the experience. Every gesture matters.", { ritual: 3, philosophy: 1 }),
    ...
    c("Contextual — sometimes a paper cup at a festival, sometimes a ceramic ochoko at midnight", { ritual: 2, season: 2 }),
  ] },
  { stem: "You're hosting someone you deeply respect. What do you pour?", subtext: "The drink you choose for others reveals what you worship.", choices: [
    c("Something rare that they've never tried — I want to give them a new experience", { ritual: 3, terroir: 1 }),
    c("Something I love that I want to share — this is who I am in liquid form", { ritual: 2, philosophy: 2 }),
    c("Something from where they're from — honoring their story, not mine", { ritual: 2, terroir: 2 }),
    c("Whatever pairs best with the food — the meal is the main character tonight", { ritual: 2, palate: 2 }),
  ] },
  { stem: "The best drinking experiences you've had — what made them unforgettable?", subtext: "Not the drink. The everything else.", choices: [
    c("The setting — a specific place, a specific light, a specific temperature in the air", { season: 3, ritual: 1 }),
    c("The company — the people elevated the liquid into something transcendent", { ritual: 3, season: 1 }),
    c("The discovery — tasting something that rearranged my understanding of what was possible", { palate: 2, terroir: 2 }),
    c("The silence — a moment of perfect stillness where the drink was the only thing happening", { philosophy: 3, ritual: 1 }),
  ] },
  { stem: "Does it matter where something comes from?", subtext: "The question underneath every bottle.", choices: [
    c("Everything — place is flavor. Geography is biography. Terroir is truth.", { terroir: 3, philosophy: 1 }),
    c("Mostly — I want to know the story, but the liquid has to stand on its own", { terroir: 3, palate: 1 }),
    c("Somewhat — I appreciate provenance but I'm not a purist about it", { terroir: 2, ritual: 2 }),
    c("The maker matters more than the place — craft transcends geography", { philosophy: 3, terroir: 1 }),
  ] },
  { stem: "Which landscape calls to you?", subtext: "The land that makes the rice that makes the sake that makes the moment.", choices: [
    c("Mountain streams and snow — purity distilled through altitude and cold", { terroir: 3, palate: 1 }),
    c("Coastal plains — salt air, mineral soil, the ocean's invisible hand in every grain", { terroir: 3, season: 1 }),
    c("Ancient rice paddies — generations of hands in the same soil, time as ingredient", { terroir: 2, philosophy: 2 }),
    c("Urban craft breweries — tradition reimagined in concrete and steel", { terroir: 1, philosophy: 3 }),
  ] },
  { stem: "How important is the water?", subtext: "Sake is 80% water. This question is about more than sake.", choices: [
    c("It's everything — the water IS the sake. Everything else is just direction.", { terroir: 3, philosophy: 1 }),
    c("Hard water for bold sake, soft water for gentle sake — I want to taste the source", { terroir: 3, palate: 1 }),
    c("I trust the brewer to choose the right water — that's their art, not mine", { philosophy: 2, ritual: 2 }),
    c("Water is the invisible partner — I don't need to analyze it to feel it", { terroir: 2, season: 2 }),
  ] },
  { stem: "A brewer invites you to visit. What do you want to see first?", subtext: "Where your attention goes reveals what you value.", choices: [
    c("The water source — show me where it begins", { terroir: 3, philosophy: 1 }),
    c("The koji room — where the magic actually happens, where rice becomes something else", { terroir: 2, ritual: 2 }),
    c("The aging cellar — time is the final ingredient and I want to see where it lives", { philosophy: 3, terroir: 1 }),
    c("The tasting room — I came to drink, not to tour", { palate: 3, ritual: 1 }),
  ] },
  { stem: "Tradition or innovation?", subtext: "The oldest argument in every craft. Where do you stand?", choices: [
    c("Tradition — 1,000 years of refinement isn't an accident. Honor the lineage.", { philosophy: 3, terroir: 1 }),
    c("Innovation — the best way to honor tradition is to push it forward", { philosophy: 3, palate: 1 }),
    c("Both — the tension between them is where the best work lives", { philosophy: 2, ritual: 2 }),
    c("Neither — I just want what tastes good. Labels are for bottles, not for philosophy.", { palate: 3, season: 1 }),
  ] },
  { stem: "What's your relationship with simplicity?", subtext: "Four ingredients: rice, water, koji, yeast. That's it. That's everything.", choices: [
    c("Simplicity is the highest form of sophistication — constraint creates beauty", { philosophy: 3, palate: 1 }),
    c("Simplicity is a starting point — what you do within the constraints is what matters", { philosophy: 2, terroir: 2 }),
    c("I appreciate simplicity but I'm drawn to complexity — more layers, more to discover", { palate: 3, philosophy: 1 }),
    c("Simplicity in ingredients, complexity in experience — that's the paradox I love", { philosophy: 2, ritual: 2 }),
  ] },
  { stem: "How do you feel about polishing?", subtext: "In sake, the more you polish the rice, the more you remove. What remains is essence.", choices: [
    c("Polish it down to the soul — I want essence, not noise", { philosophy: 3, palate: 1 }),
    c("Leave some grain intact — character lives in the imperfections", { terroir: 3, philosophy: 1 }),
    c("It depends on what the brewer is trying to say — polishing is vocabulary, not virtue", { philosophy: 2, ritual: 2 }),
    c("I don't care about the number — I care about what's in the glass", { palate: 3, season: 1 }),
  ] },
  { stem: "What does 'craft' mean to you?", subtext: "The word everyone uses. The thing almost nobody means.", choices: [
    c("Obsession with process — doing the same thing 10,000 times until it's perfect", { philosophy: 3, ritual: 1 }),
    c("Connection to place — craft without terroir is just manufacturing with better marketing", { terroir: 3, philosophy: 1 }),
    c("Human scale — made by hands, not machines. Small enough to care.", { philosophy: 2, terroir: 2 }),
    c("Intention — it doesn't matter how it's made if the maker doesn't mean it", { philosophy: 2, ritual: 2 }),
  ] },
  { stem: "What time of year are you most yourself?", subtext: "Sake has seasons. So do you.", choices: [
    c("Spring — everything beginning, the air full of possibility and pollen", { season: 3, palate: 1 }),
    ...
    c("Winter — stillness, depth, the kind of cold that makes warmth sacred", { season: 3, philosophy: 1 }),
  ] },
  { stem: "It's 11pm. You've had a long day. What temperature is your drink?", subtext: "Temperature is mood made physical.", choices: [
    c("Ice cold — sharp, clarifying, a reset button for the nervous system", { season: 3, palate: 1 }),
    c("Slightly chilled — cool enough to refresh, warm enough to taste everything", { season: 2, palate: 2 }),
    c("Room temperature — no interference, just the liquid as it is", { season: 2, philosophy: 2 }),
    c("Warm — heated gently, like a blanket for the inside of your body", { season: 3, ritual: 1 }),
  ] },
  { stem: "What's the right occasion for the best bottle?", subtext: "When do you open the thing you've been saving?", choices: [
    c("A Tuesday night, alone, for no reason — the best moments aren't planned", { season: 2, philosophy: 2 }),
    c("A celebration — the milestone deserves the bottle and the bottle deserves the milestone", { season: 3, ritual: 1 }),
    c("When the right person shows up — some bottles are waiting for specific people", { ritual: 3, season: 1 }),
    c("When the season matches — first snow, cherry blossoms, the autumn equinox", { season: 3, terroir: 1 }),
  ] },
  { stem: "Last question. Why sake?", subtext: "Of all the things to drink. Why this one?", choices: [
    c("Honesty — four ingredients, no hiding. What you taste is what it is.", { philosophy: 3, palate: 1 }),
    c("Mystery — 1,000 years of craft and I still can't fully explain what koji does to rice", { terroir: 2, philosophy: 2 }),
    c("Connection — it's meant to be shared, poured for others, received with both hands", { ritual: 3, season: 1 }),
    c("Beauty — the intersection of nature and human attention, in a cup", { season: 2, terroir: 2 }),
  ] },
];
...
const SAKE_PROFILES: SakeProfile[] = [
  { id: "palate", name: "The Daiginjo Devotee", japaneseName: "大吟醸", tagline: "You drink with your whole body. The liquid is the teacher.",
    ...
    pairings: ["Sashimi — yellowtail, sea bream, or uni", "Steamed vegetables with a whisper of yuzu", "Fresh oysters with nothing on them", "Alone, chilled, in a thin-walled glass — sometimes the pairing is silence"],
  ...
  { id: "ritual", name: "The Ochoko Ceremonialist", japaneseName: "儀式", tagline: "The cup matters as much as what's in it. Context is content.",
    ...
    pairings: ["Yakitori — the charcoal and the rice find each other", "Hot pot (nabe) — communal food for a communal drink", "Grilled miso-glazed eggplant", "Anything cooked slowly, shared generously, eaten with your hands"],
  ...
  { id: "terroir", name: "The Terroir Pilgrim", japaneseName: "風土", tagline: "You taste the place before you taste the drink. Geography is biography.",
    ...
    pairings: ["Local cuisine from the same region as the sake — the ultimate pairing", "Seasonal vegetables — what grows together, drinks together", "River fish — ayu, iwana — grilled simply with salt", "Aged cheese — terroir recognizes terroir"],
  ...
  { id: "philosophy", name: "The Koji Contemplative", japaneseName: "哲学", tagline: "You don't just drink sake. You think about what sake means.",
    ...
    pairings: ["Rich, fatty dishes — braised pork belly, duck confit", "Aged or funky cheeses — blue cheese, washed rind", "Mushroom dishes — the earth meeting the earth", "Dark chocolate — bitterness recognizes bitterness"],
  ...
  { id: "season", name: "The Seasonal Drinker", japaneseName: "季節", tagline: "The right sake at the wrong time is the wrong sake.",
    ...
    pairings: ["Spring: cherry blossom viewing (hanami) with light appetizers", "Summer: chilled tofu, cucumber, and cold soba noodles", "Autumn: matsutake mushrooms, roasted sweet potato, grilled sanma", "Winter: hot pot, oden, anything that steams"],
...
const JOURNEY_CONTINUES = [
  { name: "Find Your Mezcal", url: "https://mezcalagave-ahru9fq8.manus.space", hook: "The agave that matches your soul." },
...
function GlassPanel({ children, className = "" }: { children: React.ReactNode; className?: string }) {
  return (
    <div className={`rounded-2xl border border-brand-gold-light/12 bg-[#0A0A10]/85 backdrop-blur-xl ${className}`}>{children}</div>
  );
}
      ...
      <div className="relative z-1 flex min-h-screen flex-col items-center justify-center px-6 font-sans text-[#2C1810]">
        ...
        <div className="w-full max-w-2xl">
          <GlassPanel className="p-8 md:p-12">
            <h2 className="mb-2 font-heading text-[clamp(1.4rem,3vw,2rem)] leading-[1.3] font-normal text-[#F5F0E0]">{q.stem}</h2>
            <p className="mb-8 font-mono text-[0.7rem] tracking-[0.05em] text-brand-gold-light/60">{q.subtext}</p>
    ...
    <div className="relative z-1 min-h-screen py-16 font-sans text-[#2C1810]">
      ...
      <div className="mx-auto max-w-4xl px-6">
        <div className="mb-12 text-center">
          <div className="mb-2 font-mono text-[0.65rem] tracking-[0.2em] text-brand-gold/60 uppercase">Your Sake Profile</div>
          <div className="-mb-2 font-serif text-5xl text-brand-gold-light/25">{topProfile.japaneseName}</div>
          <h1 className="mb-2 font-heading text-[clamp(2rem,5vw,3.5rem)] leading-[1.2] font-normal">{topProfile.name}</h1>
            ...
            <div className="mt-4 grid w-full grid-cols-5 gap-2">
              {DIMENSIONS.map((dim) => (
                <div key={dim} className="text-center">
                  <div className="font-mono text-[0.6rem] tracking-[0.05em] text-brand-gold-light/50 uppercase">{DIMENSION_LABELS[dim]}</div>
        ...
        <GlassPanel className="mb-8 p-8">
          ...
          <p className="text-base leading-[1.8] text-[#F5F0E0]/80 italic">{topProfile.tastingNotes}</p>
          <div className="mt-4 font-mono text-[0.7rem] text-brand-gold-light/60">Serving Temperature: {topProfile.servingTemp}</div>
        </GlassPanel>

        <div className="mb-8 grid gap-8 md:grid-cols-2">
          <GlassPanel className="p-8">
            <h3 className="mb-4 font-heading text-xl font-normal text-[#F5F0E0]">What to Eat With It</h3>
            <div className="flex flex-col gap-3">
              {topProfile.pairings.map((p) => (
                <div key={p} className="flex gap-3 text-[0.95rem] leading-relaxed text-[#F5F0E0]/80">
          ...
          <GlassPanel className="p-8">
            <h3 className="mb-4 font-heading text-xl font-normal text-[#F5F0E0]">Producers to Seek Out</h3>
            <div className="flex flex-col gap-4">
              {topProfile.producers.map((p) => (
                <div key={p.name}>
                  <div className="flex items-baseline gap-2">
                    <span className="font-heading text-base text-brand-gold">{p.name}</span>
                    <span className="font-mono text-[0.6rem] tracking-[0.05em] text-brand-gold-light/40">{p.region}</span>
                  </div>
                  <p className="mt-0.5 text-[0.85rem] leading-relaxed text-[#F5F0E0]/60">{p.note}</p>
                </div>
              ))}
            </div>
          </GlassPanel>
        ...
        <GlassPanel className="mb-8 p-8">
          ...
          <div className="grid gap-4 sm:grid-cols-3">
            {topProfile.resources.map((r) => (
              ...
              >
                <div className="mb-1 font-mono text-[0.55rem] tracking-[0.1em] text-brand-gold-light/40 uppercase">{r.type}</div>
        ...
        <GlassPanel className="mb-8 p-8">
          <div className="mb-2 font-mono text-[0.65rem] tracking-[0.15em] text-brand-gold-light/50 uppercase">The Journey Continues</div>
          <h3 className="mb-4 font-heading text-2xl font-normal text-[#F5F0E0]">Now that you&apos;ve found your sake...</h3>
          <div className="grid gap-4 sm:grid-cols-3">
