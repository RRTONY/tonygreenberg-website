...
const ARCHETYPES: Record<ArchetypeKey, { name: string; description: string }> = {
  Secure: {
    name: "The Anchor",
    description:
      "You are the bedrock of relationships—stable, trusting, and comfortable with intimacy. You navigate love with a steady hand, valuing both connection and autonomy. For you, love is a safe harbor, not a stormy sea.",
  },
  "Anxious-Preoccupied": {
    name: "The Seeker",
    description:
      "You crave deep connection and intimacy, but a fear of abandonment can create a current of anxiety in your relationships. Your heart is a passionate, hopeful vessel, always seeking reassurance that it has found a safe port.",
  },
  "Dismissive-Avoidant": {
    name: "The Fortress",
    description:
      "You are a self-sufficient island, valuing independence and autonomy above all. You protect your heart with high walls, finding it safer to rely on yourself than to let others in. Intimacy can feel like a threat to your cherished freedom.",
  },
  "Fearful-Avoidant": {
    name: "The Shapeshifter",
    description:
      "You are caught in a push-and-pull of wanting love and fearing it. You desire intimacy but are terrified of being hurt, leading to a confusing dance of approach and retreat. Your inner world is a complex landscape of conflicting desires.",
  },
};
...
const QUESTIONS: {
...
}[] = [
  {
    ...
    options: [
      ...
      opt("Feel a confusing mix of wanting them close and pushing them away.", {
        anxiety: 1,
        avoidance: 1,
        disorganization: 3,
      }),
  ...
  },
  {
    ...
    options: [
      ...
      opt("Alternate between angry outbursts and fearful withdrawal.", {
        anxiety: 1,
        avoidance: 1,
        disorganization: 3,
      }),
  ...
  },
  {
    ...
    options: [
      ...
      opt("Confused; I want affection but also feel uncomfortable with it.", {
        anxiety: 1,
        avoidance: 1,
        disorganization: 3,
      }),
  ...
  },
  {
    ...
    options: [
      ...
      opt("Suspicious and worried, but I might not show it.", {
        anxiety: 1,
        avoidance: 1,
        disorganization: 3,
      }),
  ...
  },
  {
    ...
    options: [
      ...
      opt("Something I want, but I find it hard to trust.", {
        anxiety: 1,
        avoidance: 1,
        disorganization: 3,
      }),
  ...
  },
  {
    ...
    options: [
      ...
      opt("Scared and may look for reasons to end it.", {
        anxiety: 1,
        avoidance: 1,
        disorganization: 3,
      }),
  ...
  },
  {
    ...
    options: [
      ...
      opt("Immediately feel guilty and try to fix things, even if it's not my fault.", {
        anxiety: 3,
      }),
      opt("Feel criticized and withdraw to protect myself.", { avoidance: 3 }),
      opt("Can become defensive or blame them back.", {
        anxiety: 1,
        avoidance: 1,
        disorganization: 3,
      }),
  ...
  },
  {
    ...
    options: [
      ...
      opt("Deeply conflicted; I want to but I can't seem to let my guard down.", {
        anxiety: 1,
        avoidance: 1,
        disorganization: 3,
      }),
  ...
  },
  {
    ...
    options: [
      ...
      opt("I'm not sure what to expect from a partner.", {
        anxiety: 1,
        avoidance: 1,
        disorganization: 3,
      }),
  ...
  },
  {
    ...
    options: [
      ...
      opt("Start a fight or act out to get a reaction.", {
        anxiety: 1,
        avoidance: 1,
        disorganization: 3,
      }),
  ...
  },
  {
    ...
    options: [
      ...
      opt("Passion and drama, even if it's unstable.", {
        anxiety: 1,
        avoidance: 1,
        disorganization: 3,
      }),
  ...
  },
  {
    ...
    options: [
      ...
      opt("Experiencing them in a chaotic and unpredictable way.", {
        anxiety: 1,
        avoidance: 1,
        disorganization: 3,
      }),
      ...
      {phase === "results" && emailGated && (
        <div className="relative z-1 max-w-150">
          ...
          <p className="mx-auto my-8 max-w-125 text-sm italic opacity-80">
            A note on attachment: Your attachment style is a map of your past, not a blueprint for
            your future. It reflects how you learned to connect, but it is not a fixed identity.
            With awareness and therapeutic work, a secure attachment style can be earned at any
            stage of life.
          </p>
