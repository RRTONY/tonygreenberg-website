...
type Dimension = "Roast Preference" | "Origin Curiosity" | "Brewing Ritual" | "Social Context" | "Caffeine Sensitivity" | "Flavor Complexity";
const DIMENSIONS: Dimension[] = ["Roast Preference", "Origin Curiosity", "Brewing Ritual", "Social Context", "Caffeine Sensitivity", "Flavor Complexity"];
...
const QUESTIONS: { text: string; options: { text: string; scores: Partial<Record<Dimension, number>> }[] }[] = [
  ...
  { text: "How do you typically enjoy your coffee?", options: [
  ...
  { text: "Which brewing method are you most drawn to?", options: [
  ...
  { text: "How much caffeine do you prefer in your coffee?", options: [
  ...
  { text: "What kind of flavors do you seek in a coffee?", options: [
  ...
  { text: "How important is the origin of your coffee beans to you?", options: [
  ...
  { text: "Describe your ideal coffee-making process.", options: [
  ...
  { text: "Where is your favorite place to drink coffee?", options: [
  ...
  { text: "How do you feel about adding milk or sugar to your coffee?", options: [
  ...
  { text: "What roast level do you gravitate towards?", options: [
  ...
  { text: "How willing are you to experiment with your coffee routine?", options: [
  ...
  { text: "What role does coffee play in your social life?", options: [
  ...
  { text: "How does coffee affect your energy levels?", options: [
  ...
  { text: "You're at a cafe with a huge menu. What do you order?", options: [
  ...
  { text: "The story behind the bean is...", options: [
...
export function FindYourCoffeeQuiz() {
  ...
  const chartScores = useMemo(() => {
    ...
    for (const dim of DIMENSIONS) normalized[dim] = Math.min(10, (Math.abs(scores[dim]) / maxPossible) * 10);
    return normalized;
  }, [scores]);
  ...
  return (
    <div className="relative z-1 min-h-screen py-16 font-sans text-[#2C1810]">
      ...
      <div className="mx-auto max-w-3xl px-6 text-center">
        <div className="mb-2 font-mono text-[0.65rem] tracking-[0.2em] text-brand-gold/60 uppercase">Your Coffee Archetype</div>
        <h1 className="mb-6 font-heading text-[clamp(2rem,5vw,3rem)] leading-[1.2] font-normal text-brand-gold">{archetype}</h1>
        <p className="mx-auto mb-10 max-w-160 text-base leading-[1.8] text-[#5C4A3A]">{archetypeInfo.description}</p>
        ...
        <div className="mb-12 flex flex-col items-center justify-center gap-8 sm:flex-row">
          ...
          <div className="w-full max-w-70 text-left">
            <h3 className="mb-3 font-mono text-[0.65rem] tracking-[0.2em] text-brand-gold/70 uppercase">Dimension Scores</h3>
        ...
        <div className="mb-12 text-left">
          <div className="mb-1 text-center font-mono text-[0.65rem] tracking-[0.2em] text-brand-gold/60 uppercase">Curated For You</div>
          <h2 className="mb-8 text-center font-heading text-2xl font-normal text-brand-gold italic">Your Coffees</h2>
          <div className="flex flex-col gap-5">
            {archetypeInfo.recommendations.map((rec) => (
              <div key={rec.name} className="rounded-xl border border-brand-gold/15 bg-white/40 p-6">
                ...
                <div className="mb-1.5 font-mono text-[0.7rem] tracking-[0.03em] text-brand-gold/70">{rec.origin}</div>
        ...
        <div className="mb-10">
          <h3 className="mb-4 font-heading text-xl font-normal text-brand-gold">The Journey Continues</h3>
