...
const QUESTIONS: {
...
}[] = [
  {
    ...
    choices: [
      ...
      c("In my body — tension, numbness, or restlessness I can't explain", {
        somatic: 3,
        integrative: 1,
      }),
  ...
  },
  {
    ...
    choices: [
      c("I replay the situation looking for what I missed — where the logic broke", {
        cognitive: 3,
        integrative: 1,
      }),
      c("I feel it in my chest or stomach before I can name what happened", {
        somatic: 3,
        depth: 1,
      }),
      c("I reach for someone — I need to process it out loud with a person I trust", {
        relational: 3,
        integrative: 1,
      }),
      c("I go quiet and inward — something deeper than thinking takes over", {
        depth: 2,
        altered: 2,
      }),
    ],
  },
  {
    ...
    choices: [
      c("I devour them — frameworks and models are how I make sense of myself", {
        cognitive: 3,
        integrative: 1,
      }),
      c("They make sense in my head but nothing changes in my life", {
        cognitive: 1,
        somatic: 2,
        integrative: 1,
      }),
      c("I prefer conversations to books — I learn through people, not pages", {
        relational: 3,
        cognitive: 1,
      }),
      c(
        "The ones that changed me weren't self-help — they were poetry, myth, or something I can't categorize",
        { depth: 2, altered: 2 },
      ),
    ],
  },
  {
    ...
    choices: [
      ...
      c("My thinking disconnects me from what I actually feel", {
        cognitive: 1,
        somatic: 2,
        depth: 1,
      }),
      c("I think clearly about other people's problems but go blank on my own", {
        relational: 2,
        cognitive: 1,
        depth: 1,
      }),
  ...
  },
  {
    ...
    choices: [
      c("I live from the neck up — my body is transportation for my brain", {
        cognitive: 2,
        somatic: 1,
        integrative: 1,
      }),
  ...
  },
  {
    ...
    choices: [
      ...
      c("Recently, and it came from my body — shaking, heaving, not just tears", {
        somatic: 3,
        depth: 1,
      }),
      c("When someone really saw me — the tears were about being witnessed", {
        relational: 3,
        somatic: 1,
      }),
      c("During a meditation, ceremony, or experience that cracked something open", {
        altered: 3,
        somatic: 1,
      }),
    ],
  },
  {
    ...
    choices: [
      ...
      c("Jaw clenching, shoulder tension, stomach knots — my body is a stress barometer", {
        somatic: 3,
        integrative: 1,
      }),
      c("I get irritable with people close to me before I realize I'm stressed", {
        relational: 2,
        somatic: 1,
        depth: 1,
      }),
      c("I dissociate — I leave my body and watch from somewhere else", {
        somatic: 2,
        depth: 1,
        altered: 1,
      }),
  ...
  },
  {
    ...
    choices: [
      ...
      c("I call someone I trust and talk until I can breathe again", {
        relational: 3,
        integrative: 1,
      }),
      c("I go inward — meditation, silence, or something that takes me out of ordinary mind", {
        altered: 2,
        depth: 2,
      }),
    ],
  ...
  },
  {
    ...
    choices: [
      c("I intellectualize — I explain the relationship instead of being in it", {
        cognitive: 2,
        relational: 1,
        depth: 1,
      }),
      c("My body tenses — I feel physically unsafe even when I'm logically fine", {
        somatic: 3,
        relational: 1,
      }),
      c("I merge — I lose myself in the other person and forget what I need", {
        relational: 3,
        depth: 1,
      }),
      c("I disappear — not physically, but something inside me goes offline", {
        depth: 2,
        somatic: 1,
        altered: 1,
      }),
  ...
  },
  {
    ...
    choices: [
      c("The lawyer — I build my case, present evidence, argue my position", {
        cognitive: 3,
        relational: 1,
      }),
      c("The ghost — I freeze, shut down, or leave my body", { somatic: 2, depth: 2 }),
      c("The caretaker — I abandon my position to preserve the relationship", {
        relational: 3,
        integrative: 1,
      }),
      c("The mirror — I reflect back what the other person can't see about themselves", {
        depth: 2,
        relational: 1,
        integrative: 1,
      }),
  ...
  },
  {
    ...
    choices: [
      c("I'm not sure I've felt it — I trust data and track records, not feelings", {
        cognitive: 3,
        relational: 1,
      }),
      c("A softening — my shoulders drop, my breath deepens, my guard comes down", {
        somatic: 3,
        relational: 1,
      }),
      c("It feels like home — being with someone where I don't have to perform", {
        relational: 3,
        depth: 1,
      }),
      c("I've felt it most in non-ordinary states — ceremony, deep meditation, peak experiences", {
        altered: 3,
        depth: 1,
      }),
    ],
  ...
  },
  {
    ...
    choices: [
      c("I rarely remember dreams — my waking mind is busy enough", {
        cognitive: 2,
        integrative: 1,
        depth: 1,
      }),
      c("I have vivid body-based dreams — falling, running, being chased", {
        somatic: 2,
        depth: 2,
      }),
      c("My dreams are full of people — conversations, reunions, betrayals", {
        relational: 2,
        depth: 2,
      }),
      c("My dreams feel like messages from somewhere deeper than my biography", {
        depth: 3,
        altered: 1,
      }),
    ],
  },
  {
    ...
    choices: [
      c("I know what to do but can't make myself do it — the gap between insight and action", {
        cognitive: 1,
        integrative: 2,
        somatic: 1,
      }),
      c("I attract the same relationship dynamics no matter who I'm with", {
        relational: 2,
        depth: 2,
      }),
      c("My body breaks down when my life gets too intense", { somatic: 3, depth: 1 }),
      c("I glimpse something profound and then can't hold onto it in daily life", {
        altered: 2,
        integrative: 2,
      }),
    ],
  },
  {
    ...
    choices: [
      c("I've analyzed it thoroughly — I understand the dynamics intellectually", {
        cognitive: 3,
        depth: 1,
      }),
      c("Being around them activates something in my nervous system I can't control", {
        somatic: 2,
        depth: 2,
      }),
      c("I'm still playing a role I outgrew decades ago", { relational: 2, depth: 2 }),
      c(
        "There are things that happened that I've never fully processed — they live in the basement",
        { depth: 3, somatic: 1 },
      ),
    ],
  },
  {
    ...
    choices: [
      c("A conversation where someone reflected back what I couldn't see", {
        relational: 3,
        cognitive: 1,
      }),
      ...
      c("An altered state — meditation, ceremony, or spontaneous mystical experience", {
        altered: 3,
        integrative: 1,
      }),
    ],
  },
  {
    ...
    choices: [
      ...
      c("Yes — through my body. A physical experience that transcended explanation", {
        somatic: 2,
        altered: 2,
      }),
      c("Yes — through deep connection with another person. Love as a portal", {
        relational: 2,
        altered: 2,
      }),
  ...
  },
  {
    ...
    choices: [
      c("I've tried it but my mind won't stop — I need something more structured", {
        cognitive: 2,
        integrative: 2,
      }),
      c("Body-based practices work better for me — yoga, tai chi, walking meditation", {
        somatic: 3,
        altered: 1,
      }),
      c("Group practice or guided meditation with a teacher — I need the relational container", {
        relational: 2,
        altered: 1,
        integrative: 1,
      }),
      c("I've gone deep — and what I found there changed my understanding of reality", {
        altered: 3,
        depth: 1,
      }),
    ],
  },
  {
    ...
    choices: [
      c("Curious but cautious — I want the evidence before I trust the experience", {
        cognitive: 2,
        altered: 1,
        integrative: 1,
      }),
      c("Interested in the body-based aspects — the somatic release, the nervous system reset", {
        somatic: 2,
        altered: 2,
      }),
      c(
        "I'd only do it with someone I deeply trust — the relational container matters more than the molecule",
        { relational: 2, altered: 2 },
      ),
      c("I've experienced it — or I'm drawn to it — as the most direct path to what's underneath", {
        altered: 3,
        depth: 1,
      }),
    ],
  },
  {
    ...
    choices: [
      ...
      c("A body worker — someone who speaks the language of sensation", {
        somatic: 3,
        integrative: 1,
      }),
      c("A sherpa — someone who's been to the edge and can take me there safely", {
        altered: 2,
        depth: 2,
      }),
    ],
  },
  {
    ...
    choices: [
      ...
      c("Several — talk therapy, maybe some body work, maybe medication", {
        integrative: 3,
        cognitive: 1,
      }),
      c("A lot — and I found truth in each of them but none was complete", {
        integrative: 3,
        depth: 1,
      }),
      c(
        "I've been on a long journey across modalities and I'm ready for something that holds all of it",
        { integrative: 3, altered: 1 },
      ),
    ],
  },
  {
    ...
    choices: [
      c("It was too slow — I need practical tools and measurable progress", {
        cognitive: 3,
        integrative: 1,
      }),
      c("It stayed in my head — nothing changed in my body or my daily life", {
        somatic: 2,
        integrative: 2,
      }),
      c("The therapist was competent but the relationship didn't feel safe enough to go deep", {
        relational: 3,
        depth: 1,
      }),
      c("It couldn't hold the spiritual or transpersonal dimensions of my experience", {
        altered: 2,
        depth: 1,
        integrative: 1,
      }),
  ...
  },
  {
    ...
    choices: [
      ...
      c("They overwhelm me — too much, too fast, too often", {
        somatic: 2,
        relational: 1,
        integrative: 1,
      }),
  ...
  },
  {
    ...
    choices: [
      c("A new operating system — different patterns, different outcomes", {
        cognitive: 2,
        integrative: 2,
      }),
      c("To feel at home in my body for the first time", { somatic: 3, depth: 1 }),
      c("To stop being afraid of intimacy — to let someone all the way in", {
        relational: 3,
        depth: 1,
      }),
...
const MODALITIES: Modality[] = [
  {
    ...
    resources: [
      ...
      {
        title: "Psychology Today — Find a CBT Therapist",
        url: "https://www.psychologytoday.com/us/therapists/cognitive-behavioral-cbt",
        type: "directory",
      },
    ],
    relatedModalities: ["integrative", "depth"],
    shareText:
      "I'm The Architect — I heal by understanding. CBT and structured approaches match my wiring. Find your therapy style →",
  },
  {
    id: "somatic",
    name: "The Embodied",
    ...
    resources: [
      ...
      {
        title: "Waking the Tiger by Peter Levine",
        url: "https://www.amazon.com/Waking-Tiger-Healing-Trauma-Innate/dp/155643233X",
        type: "book",
      },
      {
        title: "EMDRIA — Find an EMDR Therapist",
        url: "https://www.emdria.org/find-an-emdr-therapist/",
        type: "directory",
      },
    ],
    relatedModalities: ["depth", "altered"],
    shareText:
      "I'm The Embodied — my body remembers what my mind forgot. Somatic therapy speaks my language. Find your therapy style →",
  },
  {
    id: "relational",
    ...
    resources: [
      {
        title: "No Bad Parts by Richard Schwartz",
        url: "https://www.amazon.com/No-Bad-Parts-Restoring-Wholeness/dp/1683646681",
        type: "book",
      },
      {
        title: "Attached by Amir Levine",
        url: "https://www.amazon.com/Attached-Science-Adult-Attachment-YouFind/dp/1585429139",
        type: "book",
      },
      {
        title: "IFS Institute — Find a Therapist",
    ...
    shareText:
      "I'm The Mirror Seeker — I heal in relationship. IFS and attachment therapy match my wiring. Find your therapy style →",
  },
  {
    id: "depth",
    ...
    description:
      "Surface-level fixes insult your intelligence. You sense that your patterns have roots that go deeper than this lifetime's biography — into family systems, collective unconscious, and the archetypal layers of psyche. Psychodynamic therapy, Jungian analysis, and depth psychology honor the complexity you feel.",
    howItWorks:
      "Depth psychology works with dreams, symbols, transference, and the unconscious material that drives behavior from below awareness. Jungian analysis explores archetypes, shadow work, and individuation — the process of becoming who you actually are beneath the adaptations. Psychodynamic therapy traces current patterns to their developmental origins.",
    bestFor: [
    ...
    resources: [
      {
        title: "Man and His Symbols by Carl Jung",
        url: "https://www.amazon.com/Man-His-Symbols-Carl-Jung/dp/0440351839",
        type: "book",
      },
      {
        title: "The Soul's Code by James Hillman",
        url: "https://www.amazon.com/Souls-Code-Character-Calling/dp/0446673714",
        type: "book",
      },
      {
        title: "IAAP — Find a Jungian Analyst",
        url: "https://iaap.org/analysts/",
        type: "directory",
      },
    ],
    relatedModalities: ["altered", "relational"],
    shareText:
      "I'm The Archaeologist — I need to go down before I can go forward. Depth psychology matches my wiring. Find your therapy style →",
  },
  {
    id: "altered",
    ...
    resources: [
      {
        ...
        url: "https://www.amazon.com/Change-Your-Mind-Consciousness-Transcendence/dp/0735224153",
        type: "book",
      },
      {
        title: "The Way of the Psychonaut by Stanislav Grof",
        url: "https://www.amazon.com/Way-Psychonaut-Encyclopedia-Inner-Journeys/dp/0998276596",
        type: "book",
      },
      { title: "MAPS — Psychedelic Therapy Research", url: "https://maps.org", type: "research" },
      {
        title: "Ketamine Research Foundation",
        url: "https://www.ketamineresearchfoundation.org",
        type: "research",
      },
    ],
    relatedModalities: ["depth", "somatic"],
    shareText:
      "I'm The Boundary Crosser — ordinary consciousness can't solve what it created. Psychedelic-assisted therapy matches my wiring. Find your therapy style →",
  },
  {
    id: "integrative",
    ...
    howItWorks:
      "Integrative therapy draws from multiple evidence-based approaches — combining talk therapy with body work, mindfulness with behavioral strategies, depth exploration with practical tools. The therapist reads what's needed in each session and adapts accordingly. Approaches like Hakomi, Sensorimotor Psychotherapy, and eclectic practitioners work this way.",
    bestFor: [
    ...
    resources: [
      {
        title: "The Myth of Normal by Gabor Maté",
        url: "https://www.amazon.com/Myth-Normal-Illness-Healing-Culture/dp/0593083881",
        type: "book",
      },
      {
        title: "Mindsight by Daniel Siegel",
        url: "https://www.amazon.com/Mindsight-New-Science-Personal-Transformation/dp/0553386395",
        type: "book",
      },
      {
        title: "Open Path Collective — Affordable Therapy",
    ...
    shareText:
      "I'm The Synthesizer — I don't fit in one box, and neither should my healing. Integrative therapy matches my wiring. Find your therapy style →",
  },
];
...
const JOURNEY_CONTINUES = [
  {
    ...
    hook: "Map your beliefs across 10 dimensions and 6 traditions.",
    url: "/find-your-spirit",
    badge: "35 Questions",
  },
  {
    name: "Find Your Religion",
    hook: "8 real spiritual/philosophical archetypes, mapped.",
    url: "/find-your-religion",
    badge: "20 Questions",
  },
  {
    name: "Find My",
    hook: "5 questions that reveal which dimension of life is pulling you hardest.",
    url: "/find-my",
    badge: "5 Questions",
  },
  {
    name: "Find Your Purpose",
    hook: "The Dharma Finder — what you can't stop doing, even when nobody's paying.",
  ...
  },
  {
    ...
    hook: "A radar chart that doesn't care about your feelings.",
    url: "/the-mirror",
    badge: "18 Questions",
  },
];
...
function GlassPanel({
  ...
  return (
    <div
      className={`rounded-2xl border border-brand-gold-light/12 bg-[#0A0A10]/60 backdrop-blur-xl ${className}`}
      style={style}
    >
      {children}
    </div>
  ...
  const handleShare = useCallback(
    (platform: string) => {
      ...
      if (platform === "twitter")
        ...
        window.open(
          `mailto:?subject=${encodeURIComponent("Find Your Therapy")}&body=${encodeURIComponent(`${text}\n\n${url}`)}`,
          "_blank",
        );
    ...
    return (
      <div className="relative z-1 flex min-h-screen flex-col items-center justify-center px-6 font-sans text-[#2C1810]">
        ...
        <div className="w-full max-w-2xl py-16">
          <h2 className="mb-2 text-center font-heading text-[clamp(1.6rem,4vw,2.2rem)] leading-[1.4] font-normal text-[#2C1810]">
            {q.stem}
          </h2>
  ...
  return (
    <div className="relative z-1 min-h-screen py-16 font-sans text-[#2C1810]">
      ...
      <div className="mx-auto max-w-4xl px-6">
        <div className="mb-2 text-center font-mono text-[0.7rem] tracking-[0.3em] text-brand-gold/50 uppercase">
          Your Therapeutic Archetype
        </div>
        <h1
          className="mb-2 text-center font-heading text-[clamp(2rem,5vw,3.5rem)] leading-[1.2] font-normal"
          style={{ color: ACCENT }}
        >
          {modality.name}
        </h1>
        <p className="mx-auto mb-12 max-w-125 text-center font-heading text-[1.15rem] text-[#5C4A3A] italic">
          {modality.tagline}
        </p>
              ...
              {DIMENSIONS.slice()
                ...
                .map((dim) => (
                  <div key={dim} className="flex items-center gap-3">
                    <span className="w-24 shrink-0 text-right font-mono text-[0.65rem] text-brand-gold-light/50">
                      {DIMENSION_LABELS[dim]}
                    </span>
                    <div className="h-1 flex-1 rounded-full bg-brand-gold-light/10">
                      <div
                        className="h-full rounded-full bg-linear-to-r from-brand-gold to-brand-gold-light transition-[width] duration-700"
                        style={{ width: `${dimensionScores[dim] * 10}%` }}
                      />
                    </div>
                    <span className="w-8 shrink-0 font-mono text-[0.65rem] text-brand-gold-light">
                      {dimensionScores[dim].toFixed(1)}
                    </span>
                  </div>
                ))}
            </div>
        ...
        <GlassPanel className="mb-8 border-l-2 p-10" style={{ borderLeftColor: ACCENT }}>
          <h3 className="mb-4 font-mono text-[0.7rem] tracking-[0.25em] text-brand-gold-light/60 uppercase">
            How It Works
          </h3>
        ...
        <div className="mb-8 grid gap-6 md:grid-cols-2">
          <GlassPanel className="p-8">
            <h3 className="mb-4 font-mono text-[0.65rem] tracking-[0.2em] text-[#7BC9A4]/80 uppercase">
              Best For
            </h3>
            <ul className="flex list-none flex-col gap-2 p-0">
              {modality.bestFor.map((item) => (
                <li
                  key={item}
                  className="relative pl-4 text-[0.95rem] leading-relaxed text-[#F5F0E0]/70"
                >
          ...
          <GlassPanel className="p-8">
            <h3 className="mb-4 font-mono text-[0.65rem] tracking-[0.2em] text-[#C97B7B]/80 uppercase">
        ...
        <GlassPanel className="mb-8 p-8 text-center">
          <h3 className="mb-4 font-mono text-[0.65rem] tracking-[0.2em] text-brand-gold-light/50 uppercase">
        ...
        <div className="mb-8">
          <h3 className="mb-5 font-mono text-[0.75rem] tracking-[0.25em] text-brand-gold-light/50 uppercase">
            Go Deeper
          </h3>
          <div className="grid gap-3">
            {modality.resources.map((resource) => (
              <a key={resource.title} href={resource.url} target="_blank" rel="noopener noreferrer">
                <GlassPanel className="flex items-center justify-between px-6 py-5 transition-colors hover:border-brand-gold-light/30">
                  ...
                  <span className="rounded-sm border border-brand-gold/15 px-2 py-0.5 font-mono text-[0.6rem] tracking-[0.1em] text-brand-gold-light/40 uppercase">
                    {resource.type}
                  </span>
                </GlassPanel>
              </a>
        ...
        <GlassPanel className="mb-8 p-8 text-center">
          <p className="mb-2 font-heading text-[1.3rem] text-brand-gold-light">
            Share your archetype. Start a conversation.
          </p>
          <p className="mb-6 text-[0.95rem] text-[#F5F0E0]/50">
          ...
          {shareCount > 0 && (
            <p className="mt-4 font-mono text-[0.7rem] text-brand-gold-light/40">
        ...
        <div className="mb-8">
          <h3 className="mb-1 text-center font-mono text-[0.65rem] tracking-[0.25em] text-brand-gold-light/50 uppercase">
            The Journey Continues
          </h3>
          <p className="mb-6 text-center text-[0.95rem] leading-relaxed text-[#2C1810]/50">
            You&apos;ve mapped your therapeutic wiring. Now go deeper into the dimensions that shape
            it.
          </p>
              ...
              <a key={item.name} href={item.url}>
                <GlassPanel className="h-full p-5 transition-colors hover:border-brand-gold-light/30">
                  <div className="mb-1.5 flex items-start justify-between gap-2">
                    <span className="font-heading text-[0.95rem] text-brand-gold-light">
                      {item.name}
                    </span>
                    <span className="shrink-0 rounded-sm border border-brand-gold/15 px-1.5 py-0.5 font-mono text-[0.5rem] tracking-[0.08em] text-brand-gold-light/50 uppercase">
                      {item.badge}
                    </span>
                  </div>
                  <p className="m-0 text-[0.82rem] leading-relaxed text-[#F5F0E0]/40">
                    {item.hook}
                  </p>
                </GlassPanel>
              </a>
        ...
        <div className="text-center">
          ...
          <div className="mt-4">
            <Link
              href="/find-my"
              className="font-mono text-[0.7rem] tracking-[0.1em] text-brand-gold-light/40 hover:text-brand-gold-light"
            >
              Explore the full Find Your ___ ecosystem <ForwardIcon aria-hidden="true" />
            </Link>
          </div>
