...
type Dimension = "Technique Mastery" | "Ingredient Sourcing" | "Cultural Curiosity" | "Presentation" | "Improvisation" | "Hospitality";
...
const DIMENSIONS: Dimension[] = ["Technique Mastery", "Ingredient Sourcing", "Cultural Curiosity", "Presentation", "Improvisation", "Hospitality"];
...
const QUESTIONS: { id: number; text: string; options: { text: string; score: ScoreMap }[] }[] = [
  { id: 1, text: "When sourcing ingredients, you prioritize:", options: [
    { text: "Local, seasonal produce from the farmer's market.", score: { "The Farm-to-Table Purist": 3, "Ingredient Sourcing": 3 } },
    { text: "Perfecting a single, complex technique.", score: { "Technique Mastery": 3 } },
    { text: "Exploring international grocery stores for rare finds.", score: { "The Fusion Explorer": 3, "Cultural Curiosity": 2 } },
  ...
  { id: 2, text: "A perfect meal for you is:", options: [
    { text: "A beautifully plated dish that looks like a work of art.", score: { "The Pastry Architect": 2, Presentation: 3 } },
    { text: "A communal feast where everyone shares and connects.", score: { "The Communal Cook": 3, Hospitality: 3 } },
    { text: "A dish that surprises with unexpected flavor combinations.", score: { "The Fusion Explorer": 3, Improvisation: 2 } },
  ...
  { id: 3, text: "Your kitchen's most essential tool is:", options: [
    ...
    { text: "A collection of spices from around the world.", score: { "The Fusion Explorer": 3, "Cultural Curiosity": 2 } },
  ...
  { id: 4, text: "When you cook for others, your main goal is:", options: [
    ...
    { text: "To introduce them to new flavors and cultures.", score: { "The Fusion Explorer": 3, "Cultural Curiosity": 2 } },
    { text: "To serve something deeply satisfying and soulful.", score: { "The Fire Master": 2, "The Farm-to-Table Purist": 1 } },
  ] },
  { id: 5, text: "You find joy in:", options: [
    { text: "The slow process of fermentation.", score: { "The Fermentation Alchemist": 3 } },
    { text: "The precision of pastry and baking.", score: { "The Pastry Architect": 3, "Technique Mastery": 1 } },
    { text: "The spontaneity of improvising a meal.", score: { Improvisation: 3, "The Fusion Explorer": 1 } },
    { text: "The connection to nature through ingredients.", score: { "The Farm-to-Table Purist": 3, "Ingredient Sourcing": 2 } },
  ] },
  ...
  { id: 7, text: "The best part of a meal is:", options: [
    ...
    { text: "The story behind the ingredients.", score: { "The Farm-to-Table Purist": 2, "Ingredient Sourcing": 2 } },
    { text: "The visual appeal of the plated food.", score: { Presentation: 3, "The Pastry Architect": 1 } },
  ] },
  ...
  { id: 9, text: "Your cookbook collection is full of:", options: [
    ...
    { text: "Travelogues with recipes from far-off lands.", score: { "The Fusion Explorer": 3, "Cultural Curiosity": 3 } },
    { text: "Books focused on a single ingredient or region.", score: { "The Farm-to-Table Purist": 3, "Ingredient Sourcing": 2 } },
  ...
  { id: 10, text: "You feel most connected to your food when:", options: [
    { text: "You know the farmer who grew it.", score: { "The Farm-to-Table Purist": 3, "Ingredient Sourcing": 3 } },
    { text: "You are using a traditional cooking method.", score: { "The Fire Master": 2, "Cultural Curiosity": 1 } },
    { text: "You are creating a dish that is uniquely your own.", score: { Improvisation: 3, "The Fusion Explorer": 1 } },
  ...
  { id: 12, text: "A kitchen should be:", options: [
    { text: "A laboratory for experimentation.", score: { "The Fermentation Alchemist": 2, "The Fusion Explorer": 2 } },
    { text: "A studio for creative expression.", score: { "The Pastry Architect": 2, Presentation: 2 } },
    { text: "A sanctuary for mindfulness and connection.", score: { "The Farm-to-Table Purist": 2 } },
  ...
  { id: 13, text: "When you travel, you are most excited about:", options: [
    { text: "Trying street food and local delicacies.", score: { "Cultural Curiosity": 3, "The Fusion Explorer": 2 } },
    { text: "Visiting local markets and farms.", score: { "Ingredient Sourcing": 3, "The Farm-to-Table Purist": 2 } },
  ...
  { id: 14, text: "The ideal kitchen gadget is one that:", options: [
    ...
    { text: "Allows for precise and consistent results.", score: { "Technique Mastery": 2, "The Pastry Architect": 2 } },
    { text: "Opens up new possibilities for flavor combinations.", score: { "The Fusion Explorer": 2, Improvisation: 1 } },
...
export function FindYourKitchenQuiz() {
  ...
  return (
    <div className="relative z-1 min-h-screen font-sans text-[#2C1810]">
      ...
      {phase === "results" && !emailGated && <EmailGate assessmentSlug="kitchen" onUnlock={() => setEmailGated(true)} />}

      {phase === "results" && emailGated && results && (
        <div className="max-w-3xl text-center">
          <h1 className="mb-4 font-heading text-5xl text-brand-gold">Your Archetype: {results.archetype}</h1>
          <p className="mx-auto mb-8 max-w-150 text-lg leading-relaxed">{ARCHETYPE_DESCRIPTIONS[results.archetype]}</p>
