...
const QUESTIONS: {
  ...
  },
  {
    ...
    options: [
      ...
      {
        text: "It's a regular part of my diet",
        scores: { "Nutrient Density": 1, Inflammation: 1 },
      },
  ...
  },
  {
    ...
    options: [
      ...
      {
        text: "A bit stiff, but it passes quickly",
        scores: { Inflammation: 3, "Energy Patterns": 3 },
      },
  ...
  },
  {
    ...
    options: [
      {
        text: "I eat when I feel gentle hunger and stop when satisfied",
        scores: { "Mindful Eating": 4, "Metabolic Type": 4 },
      },
      {
        text: "I often ignore hunger until I'm ravenous",
        scores: { "Mindful Eating": 1, "Metabolic Type": 1 },
      },
      {
        text: "I eat on a strict schedule, regardless of hunger",
        scores: { "Mindful Eating": 2, "Metabolic Type": 2 },
      },
      {
        text: "I tend to snack or graze throughout the day",
        scores: { "Mindful Eating": 3, "Metabolic Type": 3 },
      },
    ],
  },
  {
  ...
  },
  {
    ...
    options: [
      ...
      {
        text: "Consistently irritated, red, or broken out",
        scores: { Inflammation: 1, "Gut Health": 1 },
      },
    ],
  },
  {
    ...
    options: [
      {
        text: "Full, focused, and satiated for hours",
        scores: { "Metabolic Type": 4, "Energy Patterns": 4 },
      },
      {
        text: "Satisfied, but hungry again in a few hours",
        scores: { "Metabolic Type": 3, "Energy Patterns": 3 },
      },
      { text: "A bit heavy or sluggish", scores: { "Metabolic Type": 2, "Energy Patterns": 2 } },
      {
        text: "I don't typically eat high-fat meals",
        scores: { "Metabolic Type": 1, "Energy Patterns": 1 },
      },
    ],
  },
  {
  ...
  },
  {
    ...
    options: [
      {
        text: "Very sensitive, a little goes a long way",
        scores: { "Metabolic Type": 2, "Energy Patterns": 2 },
      },
      {
        text: "I can have it in the morning but not afternoon",
        scores: { "Metabolic Type": 3, "Energy Patterns": 3 },
      },
      {
        text: "Not very sensitive, I can drink it any time",
        scores: { "Metabolic Type": 4, "Energy Patterns": 4 },
      },
...
const ARCHETYPE_DESCRIPTIONS: Record<string, string> = {
  "The Ancestral Eater":
    "You thrive on a diet rich in whole, unprocessed foods, similar to what our ancestors ate. Think high-quality meats, fish, vegetables, fruits, and healthy fats. Grains, legumes, and dairy may not be your best friends.",
  "The Plant Alchemist":
    "Your body flourishes on a vibrant, plant-based diet. You have a knack for turning vegetables, fruits, legumes, and whole grains into delicious and nourishing meals. You may be more sensitive to animal products.",
  "The Intuitive Grazer":
    "You're in tune with your body's subtle cues, preferring to eat smaller, more frequent meals throughout the day. You do best when you listen to your hunger and fullness signals rather than sticking to a rigid schedule.",
  "The Performance Fueler":
    "You see food as fuel for your active lifestyle. You likely need a steady supply of complex carbohydrates and lean proteins to maintain your energy levels and support muscle recovery.",
  "The Mediterranean Soul":
    "Your body responds well to a diet inspired by the Mediterranean coast—rich in olive oil, fish, fresh vegetables, and whole grains. This anti-inflammatory way of eating supports your overall well-being.",
  "The Fasting Philosopher":
    "Your digestive system benefits from periods of rest. Intermittent fasting or time-restricted eating can help improve your energy, mental clarity, and metabolic health. You're not one for constant snacking.",
};
  ...
  return (
    <div className="relative z-1 min-h-screen font-sans text-[#2C1810]">
      ...
      {phase === "results" && !emailGated && (
        <EmailGate assessmentSlug="diet" onUnlock={() => setEmailGated(true)} />
      )}
