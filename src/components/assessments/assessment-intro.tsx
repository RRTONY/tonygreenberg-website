  ...
  return (
    <div className="relative z-1 flex min-h-screen items-center justify-center px-6 pt-[clamp(5rem,8vw,8rem)] pb-16">
      <div className="max-w-160 text-center">
        ...
        <div className="mb-4 font-mono text-[11px] tracking-[0.3em] uppercase opacity-85" style={{ color: accentColor }}>
        ...
        <p className="mb-8 text-[clamp(1.05rem,2.5vw,1.25rem)] leading-relaxed text-[#5C4A3A] italic">{subtitle}</p>

        <p className="mx-auto mb-10 max-w-130 text-base leading-relaxed text-[#6B5B4F]">{description}</p>
        ...
        >
          <div className="mb-3 font-mono text-[11px] tracking-[0.2em] uppercase" style={{ color: accentColor }}>
