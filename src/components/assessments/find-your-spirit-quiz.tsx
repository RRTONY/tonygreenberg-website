...
const QUESTIONS: Question[] = [
  {
    ...
    choices: [
      ...
      c("Secular, atheist, agnostic — or spiritual but not religious", {
        heritage: 1,
        pluralism: 2,
        trajectory: 1,
      }),
  ...
  },
  {
    ...
    choices: [
      c("I still practice it — it's deepened, not diminished, with age", {
        heritage: 3,
        scripture: 1,
      }),
      c("I've left it but it left fingerprints on everything I believe", {
        heritage: 2,
        trajectory: 2,
      }),
      c("I've actively rejected it — and I'm building something different", {
        pluralism: 2,
        trajectory: 2,
      }),
      c("I was never really given one — I'm starting from scratch", {
        trajectory: 3,
        pluralism: 1,
      }),
    ],
  },
  {
    ...
    choices: [
      c("Jesus, Muhammad, or Moses — a prophet who changed civilization", {
        heritage: 2,
        scripture: 2,
      }),
      c("The Buddha, Lao Tzu, or Krishna — a sage who transcended the world", {
        mysticism: 2,
        practice: 2,
      }),
      c("Rumi, Hafiz, or Hildegard — a mystic who dissolved into the divine", {
        mysticism: 3,
        heritage: 1,
      }),
      c("Carl Jung, Alan Watts, or Ram Dass — a modern bridge-builder", {
        pluralism: 2,
        trajectory: 2,
      }),
    ],
  ...
  {
    category: "CONCEPT OF THE DIVINE",
    stem: "Is there a God?",
    subtext: "The question behind every other question.",
    choices: [
      c("Yes — a personal God who knows me, hears me, and acts in the world", {
        theism: 3,
        heritage: 1,
      }),
      c("Yes — but not a person. A force, a consciousness, the ground of being", {
        theism: 2,
        mysticism: 2,
      }),
      c("Maybe — I'm genuinely uncertain, and I've stopped pretending otherwise", {
        pluralism: 2,
        trajectory: 2,
      }),
  ...
  },
  {
    ...
    choices: [
      c("A father, a mother, a beloved — someone who loves me specifically", {
        theism: 3,
        heritage: 1,
      }),
      c("Light, energy, vibration — something impersonal but alive", { theism: 1, mysticism: 3 }),
      c("The universe itself — everything is sacred, nothing is separate", {
        mysticism: 2,
        pluralism: 2,
      }),
  ...
  },
  {
    ...
    choices: [
      ...
      c("Not directly — but there's a pattern, a flow, a synchronicity that guides", {
        theism: 1,
        mysticism: 2,
        practice: 1,
      }),
      c("No — but the belief itself can be transformative, and that matters", {
        pluralism: 2,
        ethics: 2,
      }),
  ...
  },
  {
    ...
    choices: [
      c("God transcends gender — but the masculine metaphors carry real meaning", {
        theism: 2,
        heritage: 2,
      }),
      c("The divine feminine has been suppressed — and reclaiming it is essential", {
        mysticism: 2,
        society: 2,
      }),
      c("Both and neither — the divine contains all polarities", { mysticism: 2, pluralism: 2 }),
      c("The question is anthropomorphic — consciousness doesn't have a gender", {
        trajectory: 2,
        pluralism: 2,
      }),
    ],
  },
  {
    ...
    choices: [
      ...
      c("You can approach but never arrive — the mystery is the point", {
        pluralism: 2,
        trajectory: 2,
      }),
  ...
  {
    category: "AFTERLIFE & SALVATION",
    stem: "What happens when we die?",
    subtext: "Your honest answer. Not the comforting one.",
    choices: [
      c("Heaven, hell, or judgment — there's a reckoning, and it matters how we live", {
        afterlife: 3,
        ethics: 1,
      }),
      c("Reincarnation — consciousness continues in new forms based on karma", {
        afterlife: 2,
        mysticism: 2,
      }),
      c("We return to the source — individual identity dissolves into the whole", {
        afterlife: 1,
        mysticism: 3,
      }),
      c("Nothing — and accepting that is the beginning of real freedom", {
        ethics: 2,
        trajectory: 2,
      }),
    ],
  },
  {
    ...
    choices: [
      c("Being saved by grace — forgiven, redeemed, made whole by something beyond myself", {
        afterlife: 2,
        theism: 2,
      }),
      c("Enlightenment — waking up from the dream of separation", { mysticism: 3, practice: 1 }),
      c("Freedom from suffering — through wisdom, compassion, and right action", {
        ethics: 2,
        practice: 2,
      }),
      c("There's nothing to be saved from — just a life to be lived fully", {
        trajectory: 2,
        society: 2,
      }),
    ],
  },
  {
    ...
    choices: [
      c("Yes — there are forces of darkness, and spiritual warfare is real", {
        afterlife: 2,
        theism: 2,
      }),
      c("Evil is the absence of consciousness — ignorance, not malice", {
        mysticism: 2,
        ethics: 2,
      }),
      c("Evil is a human construct — but the suffering it names is real", {
        ethics: 2,
        society: 2,
      }),
      c("There's no evil — only unconsciousness, trauma, and systems that perpetuate harm", {
        society: 2,
        trajectory: 2,
      }),
    ],
  },
  {
    ...
    choices: [
      ...
      c("Somewhat — I trust the process even if I don't know the details", {
        mysticism: 2,
        practice: 2,
      }),
      c("Not really — but it helps me live more fully right now", { trajectory: 2, ethics: 2 }),
      c("No — and I don't think it should. Death is the great unknown.", {
        pluralism: 2,
        trajectory: 2,
      }),
    ],
  ...
  {
    category: "SACRED TEXTS & AUTHORITY",
    stem: "Is there a book that's more than a book to you?",
    subtext: "Scripture, revelation, or just really good writing?",
    choices: [
      c("Yes — the Bible, Quran, Torah, or Gita carries divine authority", {
        scripture: 3,
        heritage: 1,
      }),
      c("Several — I find revelation scattered across many traditions and texts", {
        scripture: 1,
        pluralism: 3,
      }),
  ...
  },
  {
    ...
    choices: [
      ...
      c("Both — they're answering different questions and both are valid", {
        scripture: 1,
        pluralism: 2,
        heritage: 1,
      }),
      c("Science — but I respect the metaphorical wisdom in sacred texts", {
        pluralism: 2,
        trajectory: 2,
      }),
  ...
  },
  {
    ...
    choices: [
      c("A priest, pastor, imam, or rabbi — ordained authority matters", {
        scripture: 2,
        heritage: 2,
      }),
  ...
  },
  {
    ...
    choices: [
      ...
      c("The core is eternal, but our understanding of it evolves", {
        scripture: 1,
        pluralism: 2,
        heritage: 1,
      }),
  ...
  },
  {
    ...
    choices: [
      c("Prayer — talking to God, listening for God, surrendering to God", {
        practice: 3,
        theism: 1,
      }),
      ...
      c("I don't have one — and I'm either at peace with that or looking for one", {
        trajectory: 2,
        pluralism: 2,
      }),
    ],
  },
  {
    ...
    choices: [
      ...
      c("Nice but not necessary — I go when it feeds me", {
        practice: 1,
        pluralism: 2,
        trajectory: 1,
      }),
      c("I've replaced it with my own practice — solo or with a small group", {
        mysticism: 2,
        practice: 2,
      }),
      c("I don't gather for spiritual purposes — and I don't miss it", {
        trajectory: 2,
        society: 2,
      }),
    ],
  },
  {
    ...
    choices: [
      ...
      c("I'm curious — I haven't tried but I'm drawn to the intensity", {
        practice: 2,
        trajectory: 2,
      }),
      c("I prefer gentler practices — yoga, walking meditation, nature immersion", {
        practice: 1,
        mysticism: 2,
        pluralism: 1,
      }),
      c("Not really — I find spiritual meaning in everyday life, not special experiences", {
        ethics: 2,
        society: 2,
      }),
    ],
  },
  {
    ...
    choices: [
      ...
      c("Yes — but it's more like meditation or intention-setting than petition", {
        practice: 2,
        mysticism: 2,
      }),
  ...
  },
  {
    ...
    choices: [
      c("They're among the most powerful spiritual technologies available to us", {
        mysticism: 3,
        trajectory: 1,
      }),
      c("Interesting but I prefer practices that don't require substances", {
        practice: 2,
        heritage: 2,
      }),
      c("They need proper ceremonial context — set, setting, and lineage matter", {
        heritage: 2,
        mysticism: 2,
      }),
      c("I'm skeptical — altered states aren't the same as spiritual growth", {
        ethics: 2,
        scripture: 2,
      }),
    ],
  },
  {
    ...
    choices: [
      ...
      c("From the interconnection of all things — harm to one is harm to all", {
        ethics: 2,
        mysticism: 2,
      }),
  ...
  },
  {
    ...
    choices: [
      ...
      c("There are principles, but application requires wisdom and context", {
        ethics: 2,
        pluralism: 2,
      }),
      c("Morality is culturally constructed — but suffering is universal", {
        society: 2,
        pluralism: 2,
      }),
      c("Everything is context — and anyone who says otherwise is selling something", {
        trajectory: 2,
        society: 2,
      }),
    ],
  },
  {
    ...
    choices: [
      c("Change yourself first — the world changes when individuals change", {
        practice: 2,
        mysticism: 2,
      }),
      ...
      c("Neither — I'm skeptical of both spiritual bypassing and activist burnout", {
        trajectory: 2,
        pluralism: 2,
      }),
    ],
  },
  {
    ...
    choices: [
      ...
      c("It's important but it can't be forced — some things take time", {
        ethics: 2,
        practice: 2,
      }),
      c("I prefer 'release' to 'forgiveness' — letting go without condoning", {
        mysticism: 2,
        trajectory: 2,
      }),
      c("Some things shouldn't be forgiven — accountability matters more", {
        society: 2,
        ethics: 2,
      }),
    ],
  },
  {
    ...
    choices: [
      c("Yes — and it's the most real thing that's ever happened to me", {
        mysticism: 3,
        theism: 1,
      }),
      c("Yes — but I interpret it through a specific tradition", { mysticism: 2, heritage: 2 }),
      c("Maybe — I've had moments of deep awe or connection", {
        mysticism: 1,
        pluralism: 2,
        trajectory: 1,
      }),
  ...
  },
  {
    ...
    choices: [
      ...
      c("Yes — but it's not what most people think. It's ordinary, not extraordinary.", {
        mysticism: 2,
        trajectory: 2,
      }),
      c("It's a useful concept but probably not a permanent state", { pluralism: 2, practice: 2 }),
      c("No — it's a spiritual fantasy that keeps people from engaging with reality", {
        society: 2,
        ethics: 2,
      }),
    ],
  },
  {
    ...
    choices: [
      c("It's where I meet the divine — silence is the language of God", {
        mysticism: 3,
        theism: 1,
      }),
      ...
      c("I'd rather be in dialogue — with people, with texts, with ideas", {
        society: 2,
        heritage: 2,
      }),
    ],
  },
  {
    ...
    choices: [
      c("Consciousness is God — or at least the closest thing we have to God", {
        mysticism: 3,
        theism: 1,
      }),
      c("Consciousness is fundamental — the universe is aware, not just alive", {
        mysticism: 2,
        trajectory: 2,
      }),
      c("We don't know yet — and I'm comfortable with the mystery", {
        pluralism: 3,
        trajectory: 1,
      }),
      c("It's an emergent property of complex systems — beautiful but not magical", {
        society: 2,
        ethics: 2,
      }),
    ],
  },
  {
    ...
    choices: [
      c("One — my tradition has it right, and the differences matter", {
        heritage: 3,
        scripture: 1,
      }),
      c("Many — different traditions are different faces of the same mountain", {
        pluralism: 3,
        mysticism: 1,
      }),
      c("Some — not all paths are equal, but several are legitimate", {
        pluralism: 2,
        heritage: 2,
      }),
      c("None — or all. Truth isn't a destination, it's a way of being.", {
        trajectory: 2,
        pluralism: 2,
      }),
    ],
  },
  {
    ...
    choices: [
      c("Raised in one — roots matter, and you can always branch out later", {
        heritage: 3,
        scripture: 1,
      }),
      c("Exposed to many — let them find their own way with a broad foundation", {
        pluralism: 3,
        trajectory: 1,
      }),
      c("Raised with values and ethics, not specific religious content", { ethics: 2, society: 2 }),
      c("Left alone — religion is a personal choice, not a parental one", {
        trajectory: 2,
        pluralism: 2,
      }),
    ],
  },
  {
    ...
    choices: [
      c("Yes — that's exactly my aspiration. Deep roots, open branches.", {
        heritage: 2,
        pluralism: 2,
      }),
      c("I've tried — but commitment to one tradition means believing it's truest", {
        heritage: 2,
        scripture: 2,
      }),
      c("I can't commit to just one — I need the freedom to draw from many", {
        pluralism: 3,
        trajectory: 1,
      }),
      c("I'm committed to none — and that's its own kind of freedom", {
        trajectory: 3,
        society: 1,
      }),
    ],
  },
  {
    ...
    choices: [
      ...
      c("The question is backwards — politics has corrupted religion, not the other way around", {
        ethics: 2,
        mysticism: 2,
      }),
    ],
  },
  {
    ...
    choices: [
      c("Less — secularism is winning, and something precious is being lost", {
        heritage: 2,
        scripture: 2,
      }),
      c("More — but differently. Spirituality is evolving beyond traditional religion.", {
        trajectory: 3,
        pluralism: 1,
      }),
      c("Neither — the hunger for meaning is constant, only the forms change", {
        mysticism: 2,
        pluralism: 2,
      }),
  ...
  },
  {
    ...
    choices: [
      c("Deeper into my tradition — I'm going further in, not further out", {
        heritage: 3,
        scripture: 1,
      }),
      c("Toward synthesis — integrating the best of multiple traditions into something new", {
        pluralism: 2,
        trajectory: 2,
      }),
      c("Toward direct experience — less belief, more practice, more presence", {
        mysticism: 2,
        practice: 2,
      }),
      c("Away from religion entirely — toward philosophy, ethics, and human connection", {
        society: 2,
        ethics: 2,
      }),
    ],
...
const TRADITIONS: SpiritualTradition[] = [
  {
    ...
    growthEdge: [
      "May struggle with doubt — experiencing it as betrayal rather than deepening",
      "Can become attached to spiritual experiences rather than the Source behind them",
    ],
  },
  {
    id: "mystic-seeker",
    ...
    modernExpressions: [
      ...
      "Psychedelic-assisted awakening",
    ],
    growthEdge: [
      "May devalue the ordinary in pursuit of peak experiences",
      "Can become a spiritual tourist — breadth without depth",
      "Risk of bypassing emotional work for transcendent states",
    ],
  },
  {
    id: "ethical-humanist",
    ...
    growthEdge: [
      "May dismiss genuine transcendent experiences too quickly",
      "Can become morally rigid without the softening of mystery",
      "Risk of intellectual arrogance about 'outgrowing' religion",
    ],
  },
  {
    id: "rooted-reformer",
    ...
    growthEdge: [
      "May exhaust yourself fighting battles the institution won't change",
      "Can become defined by what you're against rather than what you're for",
    ],
  },
  {
    ...
    description:
      "Your spirituality is rooted in this world, this body, this moment. You find the sacred in a good meal, in honest work, in the feel of soil under your fingernails, in the night sky. You might not call yourself spiritual at all — but you live with a presence and intentionality that many religious people envy. Nature is your cathedral. Attention is your prayer. Being fully alive is your salvation.",
    ...
    growthEdge: [
      "May dismiss transcendent experiences that don't fit the naturalist frame",
      "Can become spiritually isolated without community",
      "Risk of reducing the sacred to the aesthetic",
    ],
  },
  {
    ...
    description:
      "For you, spirituality is a discipline — not a feeling, not a belief, but a daily practice that shapes who you become. You sit, you pray, you practice — not because it feels good (though sometimes it does) but because the practice itself is the transformation. You trust the process more than the peak experience. You know that showing up is 90% of awakening.",
    ...
    growthEdge: [
      "May become rigid or legalistic about practice",
      "Can mistake discipline for transformation",
      "Risk of spiritual pride in consistency",
    ],
  },
];
  ...
  const computeResults = useCallback(
    (finalAnswers: Record<number, number>) => {
      ...
      const traditionScores = TRADITIONS.map((t) => {
        const score = t.topDimensions.reduce(
          (sum, dim, idx) => sum + (normalized[dim] || 0) * (3 - idx),
          0,
        );
    ...
    return (
      <div className="relative z-1 flex min-h-screen flex-col font-sans text-[#2C1810]">
        ...
        <div className="relative z-1 mx-auto flex w-full max-w-2xl flex-1 flex-col items-center justify-center px-6 pt-20 pb-8">
          <div className="mb-6 font-mono text-[0.6rem] tracking-[0.15em] text-brand-gold uppercase">
            {q.category}
          </div>
          <h2 className="mb-3 text-center font-heading text-[clamp(1.3rem,3.5vw,1.8rem)] leading-[1.3] font-normal">
            {q.stem}
          </h2>
  ...
  return (
    <div className="relative z-1 min-h-screen font-sans text-[#2C1810]">
      ...
      <section className="mx-auto max-w-3xl px-6 py-12 text-center">
        ...
        <h1 className="mb-4 font-heading text-[clamp(2rem,5vw,3rem)] font-normal">
          {topResult.name}
        </h1>
        <p className="mb-8 font-heading text-lg text-brand-gold italic">{topResult.tagline}</p>
        <p className="mx-auto max-w-150 text-[1.05rem] leading-[1.8] text-[#5A4A3A]">
          {topResult.description}
        </p>
      </section>

      <section className="mx-auto max-w-3xl px-6 pb-12 text-center">
        <h3 className="mb-6 font-mono text-[0.65rem] tracking-[0.15em] text-[#888] uppercase">
        ...
        <div className="mt-8 grid gap-3 [grid-template-columns:repeat(auto-fit,minmax(120px,1fr))]">
          {DIMENSIONS.map((dim) => (
            ...
            >
              <div className="mb-1 font-mono text-[0.55rem] tracking-[0.05em] text-[#888]">
                {DIMENSION_LABELS[dim]}
              </div>
              <div
                className={`font-heading text-xl ${topResult.topDimensions.includes(dim) ? "text-brand-gold" : "text-[#5A4A3A]"}`}
              >
                {scores[dim] || 0}
              </div>
            </div>
      ...
      <section className="mx-auto max-w-3xl px-6 pb-12">
        <div className="grid grid-cols-1 gap-8 sm:grid-cols-2">
          <div>
            <h3 className="mb-4 font-mono text-[0.65rem] tracking-[0.1em] text-brand-gold uppercase">
              Practices
            </h3>
            {topResult.practices.map((p) => (
              <div
                key={p}
                className="mb-2 border-l-2 border-brand-gold-light/20 pl-4 text-sm text-[#5A4A3A]"
              >
                {p}
              </div>
            ))}
      ...
      <section className="mx-auto max-w-3xl px-6 pb-12">
        ...
        {topResult.growthEdge.map((g) => (
          <div
            key={g}
            className="mb-3 border-l-2 border-[#C97B7B]/30 pl-4 text-[0.95rem] text-[#5A4A3A]"
          >
            {g}
          </div>
        ))}
      ...
      {secondResult && (
        <section className="mx-auto max-w-3xl border-t border-brand-gold/10 px-6 py-8">
          <div className="mb-3 font-mono text-[0.6rem] tracking-[0.15em] text-[#888] uppercase">
            Your Secondary Tradition
          </div>
          <h3 className="mb-2 font-heading text-2xl font-normal">{secondResult.name}</h3>
          <p className="mb-4 font-heading text-base text-brand-gold italic">
            {secondResult.tagline}
          </p>
      ...
      <section className="mx-auto max-w-3xl border-t border-brand-gold/10 px-6 py-8">
        <div className="mb-6 text-center font-mono text-[0.6rem] tracking-[0.15em] text-[#888] uppercase">
          ...
          {[
            {
              ...
              desc: "20 questions mapping your spiritual archetype across 8 dimensions",
              href: "/find-your-religion",
            },
            {
              name: "Find Your Therapy",
              desc: "25 questions matching you to your ideal therapeutic modality",
              href: "/find-your-therapy",
            },
            {
              name: "Find Your Purpose",
              desc: "The Dharma Finder — 25 questions revealing the work you were built for",
              href: "/assessments/dharma-finder",
            },
            {
              name: "Ecosystem Map",
              desc: "See all experiences and track your journey progress",
              href: "/ecosystem-map",
            },
          ].map((next) => (
            <Link
              key={next.name}
              href={next.href}
              className="block rounded-lg border border-black/6 bg-white/40 p-5"
            >
      ...
      <footer className="border-t border-brand-gold/8 px-6 py-8 text-center">
        <div className="mb-2 font-heading text-sm text-[#555] italic">
          &quot;The wound is the place where the Light enters you.&quot;
        </div>
        <div className="font-mono text-[0.6rem] tracking-[0.1em] text-[#444]">
