...
const INITIAL_SCORES: Record<Dimension, number> = {
  "Circadian Alignment": 0,
  "Sleep Architecture": 0,
  "Dream Quality": 0,
  "Recovery Depth": 0,
  "Environment Sensitivity": 0,
  "Wind-Down Ritual": 0,
};
const ACCENT = "#7E57C2";
...
const ARCHETYPE_DESCRIPTIONS: Record<string, string> = {
  "The Dawn Walker":
    "You are an early chronotype, naturally rising with the sun and finding your peak energy in the morning. Your internal clock is well-aligned with the natural light-dark cycle.",
  "The Night Architect":
    'You are a late chronotype, a classic "night owl" who finds their peak creativity and energy in the evening hours. Your internal clock is shifted later in the day.',
  "The Power Napper":
    "You thrive on polyphasic sleep, leveraging short, strategic bursts of rest to maintain high performance throughout the day. Your sleep is flexible and efficient.",
  "The Deep Diver":
    "Your sleep is dominated by deep, restorative slow-wave stages. You wake up feeling profoundly refreshed, having given your body the ultimate recovery time.",
  "The Dream Weaver":
    "You experience a rich and vivid dream life, indicating a dominance of REM sleep. Your mind is a canvas for creative, emotional, and memory-processing work during the night.",
  "The Zen Sleeper":
    "Your sleep quality is deeply connected to your state of mind. You have mastered the art of the wind-down, using mindfulness and relaxation to pave the way for peaceful rest.",
};
...
const QUESTIONS: {
...
}[] = [
  {
    ...
    options: [
      ...
      {
        text: "Mid-day, after I've had some time to wake up.",
        scores: { "Circadian Alignment": 1 },
      },
  ...
  },
  {
    ...
    options: [
      ...
      {
        text: "I wake up a few times, but fall back asleep easily.",
        scores: { "Sleep Architecture": -1 },
      },
      {
        text: "Restless and light; I toss and turn a lot.",
        scores: { "Sleep Architecture": -2, "Recovery Depth": -1 },
      },
  ...
  },
  {
    ...
    options: [
      ...
      {
        text: "Generally okay, but I need coffee to get started.",
        scores: { "Recovery Depth": 1 },
      },
  ...
  },
  {
    ...
    options: [
      {
        text: "Extremely sensitive. Everything needs to be perfect.",
        scores: { "Environment Sensitivity": 2 },
      },
      {
        text: "Moderately sensitive. Minor disturbances can wake me.",
        scores: { "Environment Sensitivity": 1 },
      },
      {
        text: "Not very sensitive. I can sleep through most things.",
        scores: { "Environment Sensitivity": -1 },
      },
  ...
  },
  {
    ...
    options: [
      {
        text: "A consistent, relaxing routine: reading, stretching, etc.",
        scores: { "Wind-Down Ritual": 2 },
      },
      {
        text: "I try to wind down, but often get distracted by screens.",
        scores: { "Wind-Down Ritual": -1 },
      },
      { text: "It varies wildly depending on the day.", scores: { "Wind-Down Ritual": -1 } },
      {
        text: "Working or watching stimulating TV until the last minute.",
        scores: { "Wind-Down Ritual": -2 },
      },
    ],
  },
  {
    ...
    options: [
      {
        text: "Yes, I have a well-established meditation or mindfulness practice.",
        scores: { "Wind-Down Ritual": 2 },
      },
      { text: "I use a white noise machine or app.", scores: { "Environment Sensitivity": 1 } },
      {
        text: "Occasionally, I'll take something like melatonin.",
        scores: { "Sleep Architecture": 1 },
      },
  ...
  },
  {
    ...
    options: [
      {
        text: "I love a good power nap; it's a key part of my routine.",
        scores: { "Circadian Alignment": 1, "Sleep Architecture": 1 },
      },
  ...
  },
  {
    ...
    options: [
      ...
      {
        text: "Related to my daily life and anxieties.",
        scores: { "Dream Quality": -1, "Recovery Depth": -1 },
      },
  ...
  },
  {
    ...
    options: [
      {
        text: "Very consistent. I go to bed and wake up at the same time every day.",
        scores: { "Circadian Alignment": 2 },
      },
      {
        text: "Fairly consistent, but I allow for some flexibility on weekends.",
        scores: { "Circadian Alignment": 1 },
      },
      {
        text: "It's a bit chaotic; my schedule is all over the place.",
        scores: { "Circadian Alignment": -2 },
      },
      {
        text: "I have a different schedule for weekdays and weekends.",
        scores: { "Circadian Alignment": -1 },
      },
    ],
  },
  {
    ...
    options: [
      {
        text: "Absolutely essential. I've optimized my bedroom for it.",
        scores: { "Environment Sensitivity": 2 },
      },
      {
        text: "Very important, but I can manage without it for a night or two.",
        scores: { "Environment Sensitivity": 1 },
      },
  ...
  {
    question:
      "Do you feel your sleep quality has a significant impact on your mood and productivity?",
    options: [
      {
        text: "Absolutely, it's the foundation of my well-being.",
        scores: { "Recovery Depth": 2 },
      },
      ...
      {
        text: "Not really, I seem to function the same regardless.",
        scores: { "Recovery Depth": -2 },
      },
    ],
  },
  {
    ...
    options: [
      {
        text: "I have a strict 'no screens' rule for at least an hour before sleep.",
        scores: { "Wind-Down Ritual": 2 },
      },
      {
        text: "I use blue-light filters and try to limit my usage.",
        scores: { "Wind-Down Ritual": 1 },
      },
      {
        text: "I often fall asleep while scrolling on my phone or watching something.",
        scores: { "Wind-Down Ritual": -2 },
      },
      {
        text: "I need it to help me fall asleep, like listening to a podcast.",
        scores: { "Wind-Down Ritual": -1, "Environment Sensitivity": 1 },
      },
    ],
  },
  {
    ...
    options: [
      {
        text: "I practice a breathing exercise or meditation to fall back asleep.",
        scores: { "Wind-Down Ritual": 2, "Sleep Architecture": 1 },
      },
      {
        text: "I lie in bed and try to force myself back to sleep, often getting frustrated.",
        scores: { "Sleep Architecture": -2 },
      },
      {
        text: "I get up for a little while and do something relaxing until I feel sleepy again.",
        scores: { "Sleep Architecture": 1 },
      },
...
function calculateArchetype(scores: Record<Dimension, number>): string {
  ...
  if (scores["Sleep Architecture"] >= 3 && scores["Circadian Alignment"] >= 1)
  ...
  return (
    <div className="relative z-1 min-h-screen font-sans text-[#2C1810]">
        ...
        <div className="mx-auto max-w-3xl px-6 py-[clamp(3rem,5vw,4rem)]">
          <div className="mb-8">
            ...
            <div className="h-1 w-full bg-brand-gold/15">
              <div
                className="h-1 bg-brand-gold-light transition-[width] duration-500"
      ...
      {phase === "results" && !emailGated && (
        <EmailGate assessmentSlug="sleep" onUnlock={() => setEmailGated(true)} />
      )}
        ...
        <div className="mx-auto max-w-4xl px-6 py-[clamp(4rem,6vw,6rem)] text-center">
          ...
          <div className="mt-16 border-t border-brand-gold-light/25 pt-8">
            ...
            <div className="flex justify-center gap-4">
              <Link
                href="/find-your-diet"
                className="border border-brand-gold/30 px-6 py-3 font-mono"
              >
                Find Your Diet
              </Link>
            </div>
