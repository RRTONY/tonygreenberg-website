...
const ARCHETYPES: Record<Dimension, { name: string; description: string; tips: string }> = {
  "Words of Affirmation": {
    name: "The Encourager",
    description:
      "You feel love most deeply through spoken or written words. Compliments, encouragement, and heartfelt expressions of affection are your emotional currency. You value hearing 'I love you' and the reasons behind it.",
  ...
  "Acts of Service": {
    name: "The Helper",
    description:
      "For you, actions speak louder than words. You feel loved when your partner does things for you, like taking care of chores, running errands, or helping you with a project. These gestures show you that they are on your team.",
  ...
  "Receiving Gifts": {
    name: "The Giver",
    description:
      "You see gifts as tangible, visual symbols of love. It's not about materialism, but the thought and effort behind the gift. A meaningful present shows you that you are known, cared for, and prized.",
  ...
  "Quality Time": {
    name: "The Companion",
    description:
      "You feel most loved when you have your partner's undivided attention. This means no phones, no TV, just focused, quality conversation and shared activities. It's about being present and connected.",
  ...
  "Physical Touch": {
    name: "The Cuddler",
    description:
      "You feel love through physical affection. Hugs, holding hands, a touch on the arm—these are your primary emotional connectors. Physical presence and accessibility are crucial for you to feel secure and loved.",
...
const QUESTIONS: {
...
}[] = [
  {
    ...
    options: [
      {
        text: "Someone telling you how much they appreciate you.",
        scores: { "Words of Affirmation": 3 },
      },
  ...
  },
  {
    ...
    options: [
      ...
      {
        text: "Helps you with a difficult project.",
        scores: { "Acts of Service": 2, "Quality Time": 1 },
      },
  ...
  },
  {
    ...
    options: [
      {
        text: "A heartfelt card with a personal message.",
        scores: { "Words of Affirmation": 3, "Receiving Gifts": 1 },
      },
      {
        text: "Your partner taking care of all the planning for a celebration.",
        scores: { "Acts of Service": 3 },
      },
      { text: "A carefully chosen gift you mentioned wanting.", scores: { "Receiving Gifts": 3 } },
      {
        text: "A weekend getaway for just the two of you.",
        scores: { "Quality Time": 3, "Physical Touch": 1 },
      },
    ],
  },
  {
    ...
    options: [
      ...
      {
        text: 'Hearing your partner say, "You handled that so well."',
        scores: { "Words of Affirmation": 3 },
      },
      {
        text: "Coming home to a clean house and a prepared meal.",
        scores: { "Acts of Service": 3 },
      },
      {
        text: "Your partner listening intently as you talk about your day.",
        scores: { "Quality Time": 3 },
      },
    ],
  },
  {
    ...
    options: [
      {
        text: "Feeling understood and listened to.",
        scores: { "Quality Time": 2, "Words of Affirmation": 1 },
      },
  ...
  },
  {
    ...
    options: [
      {
        text: "They send you a text just to say they miss you.",
        scores: { "Words of Affirmation": 3 },
      },
      {
        text: "They pick up your favorite snack on their way home.",
        scores: { "Acts of Service": 1, "Receiving Gifts": 2 },
      },
      { text: "They bring you a souvenir from a trip.", scores: { "Receiving Gifts": 3 } },
      {
        text: "They make time for a video call when you are apart.",
        scores: { "Quality Time": 3 },
      },
    ],
  },
  {
    ...
    options: [
      ...
      {
        text: '"I am your rock, you can lean on me."',
        scores: { "Physical Touch": 2, "Words of Affirmation": 1 },
      },
    ],
  },
  {
  ...
  },
  {
    ...
    options: [
      {
        text: "Is distracted by their phone when you are together.",
        scores: { "Quality Time": -3 },
      },
      {
        text: "Forgets an important anniversary or event.",
        scores: { "Receiving Gifts": -2, "Acts of Service": -1 },
      },
  ...
  },
  {
    ...
    options: [
      ...
      {
        text: '"You have the best taste." (in reference to a gift)',
        scores: { "Receiving Gifts": 3 },
      },
  ...
  },
  {
    ...
    options: [
      ...
      {
        text: "A sincere expression of regret and empathy.",
        scores: { "Words of Affirmation": 3 },
      },
      {
        text: "Making up for it with a special gesture.",
        scores: { "Receiving Gifts": 2, "Quality Time": 1 },
      },
  ...
  },
  {
    ...
    options: [
      ...
      {
        text: "You hear words of love and affirmation regularly.",
        scores: { "Words of Affirmation": 3 },
      },
      {
        text: "You know you can count on your partner for practical help.",
        scores: { "Acts of Service": 3 },
      },
    ],
  },
  {
    ...
    options: [
      ...
      {
        text: "Your partner putting their phone away to talk to you.",
        scores: { "Quality Time": 3 },
      },
    ],
  },
  {
    ...
    options: [
      ...
      {
        text: "Have long phone calls to catch up.",
        scores: { "Quality Time": 2, "Words of Affirmation": 1 },
      },
      {
        text: "Know they are handling things at home so you don't have to worry.",
        scores: { "Acts of Service": 3 },
      },
  ...
  },
  {
    ...
    options: [
      {
        text: "A surprise party planned with all your favorite people.",
        scores: { "Acts of Service": 2, "Quality Time": 1 },
      },
      {
        text: "A public declaration of love and admiration.",
        scores: { "Words of Affirmation": 3 },
      },
      { text: "An incredibly thoughtful and personal gift.", scores: { "Receiving Gifts": 3 } },
      {
        text: "A quiet, intimate moment of connection.",
        scores: { "Physical Touch": 2, "Quality Time": 1 },
      },
    ],
  },
];
  ...
  return (
    <div className="relative z-1 min-h-screen font-sans text-[#2C1810]">
      ...
      {phase === "results" && !emailGated && (
        <EmailGate assessmentSlug="love-language" onUnlock={() => setEmailGated(true)} />
      )}
        ...
        <div className="relative z-1 px-6 py-[clamp(6rem,10vw,8rem)] text-center">
          ...
          <div className="mx-auto mt-12 max-w-3xl border-t border-brand-gold-light pt-8">
            <p className="mt-8 text-sm text-[#aaa]">
              This assessment is based on Dr. Gary Chapman&apos;s &quot;The 5 Love Languages®&quot;
              framework. It is intended for personal insight and is not a substitute for
              professional advice.
            </p>
          </div>
          <WhatsNext />
