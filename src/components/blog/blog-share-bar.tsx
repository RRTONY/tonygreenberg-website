...
const AI_TOOLS = [
  {
    label: "ChatGPT",
    buildHref: (prompt: string) => `https://chatgpt.com/?q=${encodeURIComponent(prompt)}`,
  },
  {
    label: "Claude",
    buildHref: (prompt: string) => `https://claude.ai/new?q=${encodeURIComponent(prompt)}`,
  },
  {
    label: "Gemini",
    buildHref: (prompt: string) => `https://gemini.google.com/app?q=${encodeURIComponent(prompt)}`,
  },
  {
    label: "Perplexity",
    buildHref: (prompt: string) =>
