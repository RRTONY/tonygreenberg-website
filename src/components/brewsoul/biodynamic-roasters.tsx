...
const ROASTERS: Roaster[] = [
  {
    name: "Holistic Roasters (Biodynamic Coffee)",
    loc: "Montreal, Canada",
    ...
    products: [
      {
        roast: "Light (Rubicon)",
        origin: "Brazil (Camocim)",
        oz: "10.6oz",
        price: "$19.95",
        perOz: "$1.88",
      },
      {
        roast: "Medium (Rise & Shine)",
        origin: "Peru (La Chacra D'Dago)",
        oz: "10.6oz",
        price: "$19.95",
        perOz: "$1.88",
      },
      {
        roast: "French Roast",
        origin: "Peru/Honduras blend",
        oz: "10.6oz",
        price: "$19.95",
        perOz: "$1.88",
      },
      {
        roast: "Biodynamic Decaf (SWP)",
  ...
  },
  {
    ...
    products: [
      ...
      {
        roast: "Medium (Rise & Shine / Camocim)",
        origin: "Brazil",
        oz: "12oz",
        price: "~$22.00",
        perOz: "~$1.83",
  ...
  },
  {
    ...
    cert: [
      ...
      "Demeter Biodynamic (select lines)",
    ],
    products: [
      {
        roast: "Protect (Light-Medium)",
        origin: "Multi-origin",
        oz: "12oz",
        price: "$29.00",
        perOz: "$2.42",
      ...
      {
        roast: "Calm Decaf (SWP, 1/3 caf option)",
        origin: "Multi-origin",
        oz: "12oz",
        price: "$29.00",
        perOz: "$2.42",
        ...
        >
              ...
              <thead>
                <tr>
                  {["Product", "Origin", "Size", "Price", "$/oz"].map((h) => (
                    <th
                      key={h}
                      className="border-b border-[#5d3a28]/10 px-2.5 py-2 text-left font-mono text-[9px] tracking-wide text-[#6b5a4e] uppercase"
                    >
                      {h}
                    </th>
                  ))}
              ...
              <tbody>
                {r.products.map((p, pi) => (
                  <tr key={p.roast} className={pi % 2 === 1 ? "bg-[#f5efe0]/30" : ""}>
                    ...
                    <td className="p-2.5 font-mono text-xs font-semibold text-[#c4873b]">
                      {p.perOz}
                    </td>
                  </tr>
                ))}
          ...
          {expanded === i && (
            <div className="border-t border-[#5d3a28]/6 pt-3">
              ...
              >
                Buy Direct <ForwardIcon aria-hidden="true" />
              </a>
            </div>
          )}
