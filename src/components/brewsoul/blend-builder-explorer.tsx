      ...
      {parts.length > 0 && (
        <div className="mb-6 flex flex-col gap-3">
          {parts.map((p) => {
            ...
            return (
              <div key={p.coffeeId} className="flex items-center gap-4 rounded-xl border border-[#6F4E37]/8 bg-white p-6">
                <div className="flex-1">
                  <div className="font-heading text-[0.95rem] font-bold text-[#2C1810]">{coffee.name}</div>
