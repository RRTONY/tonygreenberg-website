      ...
      {FARMS.map((farm, i) => (
        ...
        >
          <div className="flex flex-wrap items-start justify-between gap-3">
            <div>
              <div className="font-heading text-2xl font-bold text-[#f5efe0] italic">{farm.name}</div>
          ...
          <div className="my-4 grid gap-3 [grid-template-columns:repeat(auto-fit,minmax(120px,1fr))]">
            <div>
              <div className="font-mono text-[9px] tracking-wide text-[#6b5a4e]">CO₂ Sequestered</div>
            ...
            <div>
              <div className="font-mono text-[9px] tracking-wide text-[#6b5a4e]">Organic Matter</div>
          ...
          <div className="mt-2 text-sm leading-relaxed text-[#f5efe0]/65">
            <strong className="text-[#e8dcc8]">Tasting:</strong> {farm.notes} · <strong className="text-[#e8dcc8]">Process:</strong> {farm.process}
          </div>
