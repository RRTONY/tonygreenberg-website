...
export const WATCHDOG_PILLARS: WatchdogPillar[] = [
  { iconKey: "flask", title: "Independent Testing Lab Network", body: "Partner with ISO 17025-accredited labs to systematically test products from the market. Publish results publicly. Expand Finnrick-model coverage to include sterility, endotoxin, heavy metals, and residual solvents — not just purity and quantity." },
  { iconKey: "chart", title: "Public Vendor Registry", body: "Maintain a public, searchable database of vendor scores using the 10-category scorecard. Red/yellow/green status updated quarterly. Any vendor receiving a criminal referral or warning letter is immediately flagged." },
  { iconKey: "scale", title: "Regulatory Liaison Office", body: "Dedicated staff for FDA MedWatch reporting, DOJ/HHS-OIG referrals, and coordination with state boards of pharmacy and medical boards. Make whistleblower intake frictionless. Provide consumers with structured reporting support." },
  { iconKey: "link", title: "Supply Chain Audit Program", body: "Offer paid audit certification to vendors willing to open their supply chains to independent review. Certified vendors earn a PeptideWatch seal. Any vendor refusing audit is rated accordingly." },
  { iconKey: "phone", title: "Consumer Alert System", body: "Real-time alerts when new FDA warning letters, DOJ indictments, ITC orders, or state AG actions drop. SMS and email opt-in. Free to consumers. Partners with LegitScript, Finnrick, and PeptideExaminer for data sharing." },
  { iconKey: "graduation", title: "Clinician Education Program", body: "Train prescribing physicians, telehealth providers, and med-spa clinicians on supply-chain due diligence. Offer CME credits. Publish procurement SOPs. The goal: make responsible sourcing the default, not the exception." },
];
