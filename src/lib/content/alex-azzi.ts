...
export const SUBJECT = {
  ...
  totalPaid: "$15,000",
  paidNote:
    "One partial payment on Invoice #1 (kickoff). The only money RampRate ever received.",
...
export const RED_FLAGS = [
  ...
  },
  {
    ...
    lesson:
      "Social proof is not solvency. Ask for bank references, not LinkedIn connections.",
  },
  {
...
export const EVIDENCE_ROWS = [
  { claim: "Binding contract signed by Azzi", source: "SOW executed Jan 21, 2022", strength: "IRONCLAD" as const },
  { claim: "$25K kickoff invoice — only $15K paid (once, ever)", source: "Change Order 1 — Azzi's own admission of $10K shortfall", strength: "IRONCLAD" as const },
  { claim: "$50K deferred balance unpaid", source: "SOW Section 2.2 + Dec 2023 collections letter", strength: "IRONCLAD" as const },
  { claim: "3%+2% equity never transferred", source: "Dec 2023 formal request — no response", strength: "STRONG" as const },
  { claim: "Services delivered in full", source: "4+ meeting docs, grant app, BD intros", strength: "STRONG" as const },
  { claim: "$200K in bank — active refusal", source: "July 2023 internal CSO update after Azzi call", strength: "DOCUMENTED" as const },
  { claim: "Collections ignored 3+ years", source: "Email record, formal letters, direct confrontations", strength: "STRONG" as const },
  { claim: "Interest at 1.5%/month per contract", source: "SOW Section 2.5 — contractual term", strength: "IRONCLAD" as const },
  { claim: "$50K Dec 2024 invoice unpaid", source: "Collections notice + editorial record", strength: "DOCUMENTED" as const },
];
...
export const PLAYBOOK_STEPS = [
  { num: 1, title: "Beg for help.", text: "Present yourself as visionary, underdog, deserving. Use warm intros to bypass due diligence." },
  { num: 2, title: "Receive the services.", text: "Use the work product. Show the investor decks. Name-drop the advisor. Extract maximum value." },
  { num: 3, title: "Deflect.", text: "Redirect to someone else. Blame timing. Blame fundraising. Blame the market. Never blame yourself." },
  { num: 4, title: "Go silent.", text: "Make the creditor feel like they are the problem for asking. Silence is the weapon." },
  { num: 5, title: "Offer a re-engagement.", text: "Float new work to sidestep the original debt. Create a new future to erase the past." },
  { num: 6, title: "Repeat.", text: "Find the next warm intro. The next kind person. The next believer. The grin never leaves." },
];
...
export const MAP_PINS = [
  { city: "Las Vegas, NV", event: "CES Speaker", detail: "Consumer Electronics Show — VR fitness pitch to investor audiences." },
  { city: "Santa Clara, CA", event: "AWE USA 2023", detail: "Startup Pitch Finalist at Augmented World Expo." },
  { city: "San Francisco, CA", event: "GDC 2024", detail: "Game Developers Conference 2024." },
  { city: "Miami, FL", event: "Goldman Sachs Demo + Former Base", detail: "Private demo to ~20 attendees. Former residential base." },
  { city: "New York, NY", event: "Current Base", detail: "Current primary base. Active in AI and longevity networking." },
  { city: "Davos, Switzerland", event: "WEF Fringe Panels", detail: "3 panels on psychedelics at WEF fringe events (2024 + 2026)." },
  { city: "Dubai, UAE", event: "6-Year Residence", detail: "Founded Biohackers UAE and Biohack.ae." },
  { city: "Beirut, Lebanon", event: "Birthplace", detail: "Hosted Beirut XR Mastermind Jan 9, 2024." },
  { city: "London, UK", event: "Former Residence", detail: "Active in AI & Longevity Mastermind circles." },
  { city: "Helsinki, Finland", event: "Biohacker Summit", detail: "Recurring presence." },
];

export const ESCALATION_SPECTRUM = [
  { level: "Gossip", description: "Unverified whispers. Damages reputations. Solves nothing. The most dangerous thing on earth.", risk: "Destroys trust" },
  { level: "Rumor", description: "Repeated gossip with embellishment. Now it's 'common knowledge' that was never verified.", risk: "Creates false consensus" },
  { level: "Unchecked Pattern", description: "Multiple people have been affected but nobody talks. The bad actor refines their technique.", risk: "Enables escalation" },
  { level: "Serial Fraud", description: "Romance scams ($1.16B in 9 months, 2025). Investment fraud. Vendor theft. Now it's a business model.", risk: "Systematic harm" },
  { level: "Institutional Scale", description: "Bernie Madoff. $65 billion. Decades of silence. Everyone suspected. Nobody verified. Nobody spoke.", risk: "Civilizational failure" },
];

export const VERIFICATION_STEPS = [
  { num: 1, title: "Stop. Breathe. Question your motive.", text: "Before you say a single word to anyone, ask yourself: Is this about protecting others, or about revenge? If there's even 5% revenge in it, you're not ready. Go heal first. Come back when your motive is clean.", gate: "Motive check" },
  { num: 2, title: "Apply Byron Katie's Four Questions.", text: "Take the thought that's driving you — 'This person scammed me' — and run it through The Work. Is it true? Can you absolutely know it's true? How do you react when you believe that thought? Who would you be without it? If it survives all four, proceed.", gate: "Byron Katie gate" },
  { num: 3, title: "Gather documentation. Not feelings. Documents.", text: "Contracts. Invoices. Emails. Text messages. Bank records. Timestamps. If you can't point to a document, you don't have a case — you have a grievance. Grievances are valid. But they're not evidence.", gate: "Evidence threshold" },
  { num: 4, title: "Find one corroborating witness. Quietly.", text: "Not on Reddit. Not on a Facebook group. Reach out privately to ONE person you believe may have had a similar experience. Ask open-ended questions. Don't lead. Don't gossip. Listen. If their story independently matches yours, you have corroboration.", gate: "Corroboration" },
  { num: 5, title: "Consult a professional before going public.", text: "A lawyer. A mediator. A restorative justice practitioner. Someone who understands defamation law, fair comment doctrine, and the difference between opinion and actionable claims. This costs money. It's worth it. Your credibility depends on it.", gate: "Legal review" },
  { num: 6, title: "Give the subject a chance to respond. In writing.", text: "Send a formal letter. State the facts. State what you believe happened. Give them 30 days to respond. Document that you gave them the opportunity. This is not optional — it's the ethical floor.", gate: "Right of reply" },
  { num: 7, title: "Calculate the cost of being wrong.", text: "If you publish and you're wrong, you will be sued. You will lose money. You will lose reputation. You will hurt an innocent person. Are you willing to bet your house on this? If not, go back to Step 3.", gate: "Consequences acceptance" },
  { num: 8, title: "Publish with conviction, not anger.", text: "If you've passed every gate above, you've earned the right to speak. Do it with facts. Do it with documentation. Do it with a path to redemption for the subject. And do it knowing that words have consequences — for them and for you.", gate: "Publication" },
];
...
export const HEALING_FRAMEWORK = [
  { title: "Protect", text: "Judiciously, slowly, legally. Not with gossip — with verified, documented truth. The ethical way to ensure the next person doesn't learn the hard way." },
  { title: "Heal", text: "Healing ourselves. Healing those who were wronged. And offering a path to healing for those who caused the harm — because reparation is not just punishment, it's transformation." },
  { title: "Become", text: "In this massive transformational time, the communities that survive are the ones that hold each other accountable with love, not rage. With facts, not feelings. With conviction, not cruelty." },
];
...
export const FAQ = [
  ...
  { q: "Why is there a community protection report on Alex Azzi?", a: "A VerifiedTribe report documents $137,000+ in unpaid invoices and unfulfilled equity agreements across 6 years. The report includes signed contracts, invoices, and correspondence as evidence. A path to resolution is provided." },
];
...
export const LEGAL_NOTICES = [
  ...
  { title: "Right of Reply", text: "Alex Azzi has been given the opportunity to respond to these claims through multiple channels over a period of 6 years. This page will be updated to include any substantive response received." },
  ...
  { title: "Path to Removal", text: "This report includes a publicly documented path to removal (see the General Ledger of Retribution above). Completion of all conditions, verified by an independent third party, results in removal of this report." },
  { title: "Anti-Gossip Commitment", text: "This platform exists to eliminate gossip, not perpetuate it. Every claim passes through a verification standard before publication. Anonymous, unsubstantiated claims are rejected. We are accountable for what we publish." },
