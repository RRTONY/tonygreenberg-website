...
export const ASSESSMENT_QUESTIONS: AssessmentQuestion[] = [
  ...
  },
  {
    ...
    options: [
      ...
      { text: "Evaluating an impact investment that could change an industry", archetype: "investor" },
    ],
  },
  {
    id: 3,
  ...
  },
  {
    ...
    options: [
      { text: "Systems that outlast me — infrastructure for the next generation", archetype: "builder" },
      { text: "A record of truth that made powerful people uncomfortable", archetype: "crusader" },
      { text: "A portfolio of impact that proved profit and purpose aren't enemies", archetype: "investor" },
    ],
  },
];
