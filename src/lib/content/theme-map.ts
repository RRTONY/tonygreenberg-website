...
// Ported verbatim from legacy client/src/data/themeMap.json + the `themes`
// array in client/src/pages/Blog.tsx. Only 4 of the 6 mapped categories are
// surfaced as clickable theme cards on the homepage (legacy comment: "Living
// Well & Impact & Purpose content still accessible via category filters —
// just not featured as theme cards") — kept that way here too, but the full
// map is ported since it's real curated data, not just the 4 in use.
