...
export const DIMENSIONS: Dimension[] = [
  {
    ...
    max: 1000,
    unit: "Hawkins Scale",
    description: "20=Shame → 1000=Enlightenment. 200=critical threshold: below=force, above=power",
  },
  {
    id: 2,
    ...
    max: 100,
    unit: "tCO₂e",
    description: "Scope 1-3 + sequestration + trajectory to net-positive",
  },
  {
    id: 3,
    label: "Labor Justice",
    ...
    max: 100,
    unit: "LJI",
    description: "Wage equity, benefits, safety, dignity, CEO-to-median ratio",
  },
  {
    id: 4,
    label: "Supply Chain",
    ...
    max: 100,
    unit: "SCI",
    description: "6-tier depth: Tier1 → Tier4 origin ecosystems → logistics → end-of-life",
  },
  {
    id: 5,
    ...
    max: 100,
    unit: "CPI",
    description: "Indigenous rights, sacred sites, traditional knowledge sovereignty",
  },
  {
    id: 6,
    ...
    max: 100,
    unit: "CMX",
    description: "Dollar recirculation, local hiring, community ownership %, power-sharing",
  },
  {
    id: 7,
    ...
    max: 100,
    unit: "FJI",
    description: "Stakeholder vs shareholder return distribution",
  },
  {
    id: 8,
    ...
    max: 100,
    unit: "GTI",
    description: "Board diversity, stakeholder representation, transparency",
  },
  {
    id: 9,
    ...
    max: 100,
    unit: "RCI",
    description: "Circular material use, waste-to-value, water stewardship",
  },
  {
    id: 10,
    label: "Human Dignity",
    ...
    max: 100,
    unit: "HDI",
    description: "Worker autonomy, portable credentials, mental health",
  },
  {
    id: 11,
    ...
    max: 100,
    unit: "RII",
    description: "Net-positive R&D, open-source, biomimicry",
  },
  {
    id: 12,
    ...
    max: 100,
    unit: "RTI",
    description: "Real-time reporting, blockchain verification, independent audits",
  },
];
...
export const BENCHMARKS: BenchmarkEntity[] = [
  {
    name: "Fortune 500 Avg",
    tag: "F500",
    scores: [110, 35, 40, 30, 15, 20, 25, 45, 30, 35, 40, 30],
  },
  ...
  {
    name: "BP (ESG 'AA' rated)",
    tag: "BP",
    scores: [75, 18, 45, 25, 10, 15, 20, 55, 15, 40, 30, 35],
  },
  {
    name: "Extractive Gig Platform",
    tag: "UBER",
    scores: [95, 25, 22, 20, 5, 10, 12, 30, 20, 15, 45, 20],
  },
  { name: "Avg US Worker", tag: "USWK", scores: [175, 30, 0, 0, 20, 35, 25, 0, 30, 0, 20, 25] },
  {
    name: "ImpactSoul Impact Worker",
    tag: "ISOL",
    scores: [280, 65, 80, 60, 55, 70, 65, 55, 60, 85, 50, 75],
  },
];
...
export const SUPPLY_TIERS: SupplyTier[] = [
  ...
  },
  {
    ...
    factors: [
      "Extraction violence",
      "Deforestation",
      "Cobalt/lithium ethics",
      "Artisanal mining conditions",
      "Biodiversity",
    ],
  },
  {
    name: "Tier 4: Origin Ecosystems",
    colorKey: "teal",
    factors: [
      "Soil health",
      "Watershed integrity",
      "Cultural site proximity",
      "Sacred land",
...
export const FAILURES: FailurePattern[] = [
  {
    title: "No baseline ever set",
    severity: 10,
    fix: "SoulScore auto-generates baseline on first measurement",
  },
  {
    title: "ESG correlates with greenwashing",
    severity: 10,
    fix: "12-axis eliminates single-dimension gaming",
  },
  { title: "Supply chain = carbon only", severity: 10, fix: "6-tier, 30-factor analysis" },
  {
    title: "$41T ESG funds zero standards",
    severity: 10,
    fix: "Open-source scoring, on-chain verification",
  },
  {
    title: "No individual impact identity",
    severity: 10,
    fix: "Personal SoulScore: portable, sovereign, cumulative",
  },
  { title: "76.4M gig workers unmeasured", severity: 10, fix: "Impact Worker credential + tokens" },
  {
    title: "CEO consciousness unmeasured",
    severity: 9,
    fix: "Leadership calibration correlated to C-NPV",
  },
  {
    title: "Dashboards before data architecture",
    severity: 9,
    fix: "Data collection first, measurement auto-generates",
  },
  {
    title: "Self-reported data = truth",
    severity: 9,
    fix: "On-chain verification + third-party consciousness audit",
  },
  {
    title: "Every impact platform died",
    severity: 10,
    fix: "AI-native architecture, not dashboards on broken data",
  },
  ...
  {
    title: "Labor justice weakest ESG pillar",
    severity: 9,
    fix: "Independent Labor Justice Index",
  },
  {
    title: "No consciousness layer anywhere",
    severity: 9,
    fix: "Hawkins-calibrated Corporate Consciousness Scale",
  },
  {
    title: "Impact tokens don't exist",
    severity: 10,
    fix: "ABIT: verified outcomes minted as tradeable tokens",
  },
...
export function getConsciousnessZone(hawkins: number): {
  zone: string;
  colorKey: ColorKey;
  bg: string;
} {
...
export function calcCNPV(
  fcf: number,
  consciousness: number,
  years: number,
  discount: number,
): { standard: number; adjusted: number; premium: number } {
  ...
  return {
    standard,
    adjusted,
    premium: standard > 0 ? ((adjusted - standard) / standard) * 100 : 0,
  };
}
