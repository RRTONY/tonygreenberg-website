// Ported from legacy client/src/data/brewsoul-esoteric.ts — the real
// "Esoteric Coffee Index" dataset (9 real coffees across 2 tiers, each
// with real tasting notes, rarity score, typical cost, and real named
// buy sources), unchanged. **Real content gap found, not fixed**: both
// `ACQUISITION_PRIORITY` and `EXPLORER_SCORES` reference "Laurina" as a
// real 10th entry, but no `EsotericCoffee` card for it exists anywhere in
// `ESOTERIC_COFFEES` — legacy's own "Top 10" list and scorecard table
// promise a coffee the page never actually documents. Ported verbatim
// rather than inventing card content that doesn't exist in the source.
...
export const ESOTERIC_COFFEES: EsotericCoffee[] = [
  ...
  {
    id: "sidra", name: "Sidra", tier: 2, tierLabel: "Competition Monsters",
    whyItMatters: "A rising star in competition circuits, prized for its delicate complexity.",
    origin: "Ecuador", tastingNotes: ["Rose", "Berry", "Citrus"], rarity: 9, typicalCost: "$30–$80",
    buySources: [
      { name: "Passenger Coffee", url: "https://passengercoffee.com" },
      { name: "Onyx Coffee Lab", url: "https://onyxcoffeelab.com" },
    ],
  ...
  {
    id: "pink-bourbon", name: "Pink Bourbon", tier: 2, tierLabel: "Competition Monsters",
    whyItMatters: "A genetic mystery that produces some of the most floral cups in specialty coffee.",
    origin: "Colombia", tastingNotes: ["Rosewater", "Strawberry", "Citrus"], rarity: 8, typicalCost: "$25–$60",
    buySources: [
      { name: "Black & White Coffee", url: "https://www.blackwhiteroasters.com" },
      { name: "Passenger Coffee", url: "https://passengercoffee.com" },
    ],
  ...
  {
    id: "bourbon-aji", name: "Bourbon Aji", tier: 2, tierLabel: "Competition Monsters",
    whyItMatters: "An ultra-rare Colombian variety with candy-like sweetness.",
    origin: "Colombia", tastingNotes: ["Peach Candy", "Tropical Fruit"], rarity: 10, typicalCost: "$40–$120",
    buySources: [
  ...
  {
    id: "sudan-rume", name: "Sudan Rume", tier: 2, tierLabel: "Competition Monsters",
    whyItMatters: "A wild lineage coffee with extraordinary genetic diversity.",
    origin: "Sudan Lineage", tastingNotes: ["Wild Berry", "Floral", "Tropical Fruit"], rarity: 10, typicalCost: "$40–$100",
    buySources: [
...
export const ACQUISITION_PRIORITY: string[] = ["Panama Geisha", "Yemen Mokha", "Liberica", "Wush Wush", "Eugenioides", "Sudan Rume", "Bourbon Aji", "Sidra", "Pink Bourbon", "Laurina"];
