...
export const ESOTERIC_COFFEES: EsotericCoffee[] = [
  {
    ...
    buySources: [
      {
        name: "Panama Coffee Gold Reserve",
        url: "https://www.panamacoffeegoldreserve.com/collections/geisha-coffee",
      },
      {
        name: "Hacienda La Esmeralda (original legendary farm)",
        url: "https://blessedbeancoffee.com/products/panama-hacienda-la-esmeralda-geisha-1500",
      },
      {
        name: "9th Street Coffee",
        url: "https://9thstreetcoffee.com/products/organic-panama-geisha-coffee",
      },
    ],
    additionalSources: [
    ...
    references:
      "Panama Geisha routinely commands some of the highest prices in coffee and remains one of the world's most sought-after varieties.",
  },
  {
    id: "yemen-mokha",
    name: "Yemen Mokha",
    ...
    additionalSources: [
      {
        name: "Banyan Coffee Company",
        url: "https://www.banyancoffeecompany.com/product/yemen-coffee-mokha-hajjah/",
      },
    ],
    references:
      "Modern specialty Yemeni coffee traces much of its revival to Al Mokha and Port of Mokha.",
  },
  {
    id: "liberica",
    name: "Liberica",
    ...
    buySources: [
      ...
      {
        name: "Channel Roasters",
        url: "https://www.channelroasterscoffee.com/product/uganda-liberica/63",
      },
      {
        name: "Philippines Kapeng Barako",
        url: "https://www.neworleanscoffeeimports.com/product-page/philippines-liberica-barako-batangas-co-op-grown-1",
      },
    ],
    references:
      "Liberica represents less than roughly 2% of world coffee production and is considered one of the rarest commercially available species.",
  },
  {
    id: "eugenioides",
    name: "Eugenioides",
    ...
    typicalCost: "$75–$300+",
    availability:
      "Extremely limited. Often released in tiny lots by competition roasters and sold out within days.",
    buySources: [],
    additionalSources: [
      {
        name: "Search for availability",
        url: "https://www.google.com/search?q=eugenioides+coffee+beans",
      },
    ],
  ...
  },
  {
    ...
    references:
      "These roasters frequently secure Wush Wush lots when available. Community coffee experts consistently cite them as reliable rare-variety sources.",
  },
  {
    id: "sidra",
    name: "Sidra",
  ...
  },
  {
    ...
    tierLabel: "Competition Monsters",
    whyItMatters:
      "A genetic mystery that produces some of the most floral cups in specialty coffee.",
    origin: "Colombia",
    ...
    buySources: [
      {
        name: "Onyx Coffee Lab",
        url: "https://onyxcoffeelab.com",
        note: "Auction lots and specialty releases",
      },
      {
        name: "Passenger Coffee",
        url: "https://passengercoffee.com",
