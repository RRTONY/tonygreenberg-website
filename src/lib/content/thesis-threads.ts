...
export const CONTENT_RULES = {
  thesisConnection:
    "Every article must contain at least one sentence connecting its topic to the extractive-vs-regenerative thesis. Can be subtle — doesn't need to mention ImpactSoul by name.",
  ...
  comparisons:
    "When discussing any investment or business model, include a price-to-value comparison with at least one alternative/comparable.",
  closing:
    "End pieces with a forward-looking line that implies momentum, not a conclusion that closes the loop.",
} as const;
