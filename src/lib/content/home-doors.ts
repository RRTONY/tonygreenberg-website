...
// photos (door01-04) are served by the existing Tony Greenberg image
// endpoint, which remains allow-listed in `next.config.ts` for `next/image`.
// `icon`/`imgWidth`/`imgHeight` stay as a fallback path in
...
export const HOME_DOORS: HomeDoor[] = [
  {
    ...
    href: "#essays-archive",
    icon: BookOpen,
    img: "https://tonygreenberg.com/api/img/door01_634cd4d4.webp",
    imgWidth: 1200,
    imgHeight: 1607,
  ...
  },
  {
    ...
    href: "/find-my",
    icon: Compass,
    img: "https://tonygreenberg.com/api/img/door02_8abcc1e9.webp",
    imgWidth: 1200,
    imgHeight: 1607,
  ...
  },
  {
    ...
    href: "/ecosystem",
    icon: Handshake,
    img: "https://tonygreenberg.com/api/img/door03_ac43a96c.webp",
    imgWidth: 1200,
    imgHeight: 1607,
  ...
  },
  {
    ...
    icon: Microscope,
    img: "https://tonygreenberg.com/api/img/door04_f682151b.webp",
    imgWidth: 1200,
    imgHeight: 1607,
