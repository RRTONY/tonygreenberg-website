...
export const DIRECTORY: DirectorySection[] = [
  {
    ...
    items: [
      ...
      { name: "Find Your Mirror", hook: "6 dimensions. 18 questions. A radar chart that doesn't care about your feelings.", status: "live", url: "/the-mirror" },
      { name: "Find Your Level", hook: "Where you sit on the consciousness scale — and what's keeping you there.", status: "live", url: "/consciousness-scale" },
      { name: "Find Your Score", hook: "85 years of Harvard data says relationships predict everything.", status: "live", url: "/grant-study" },
