...
export const ARCHETYPES: MeArchetype[] = [
  {
    ...
    description:
      "Your deepest work is relational. You've built walls so sophisticated you forgot they were walls — and now you're ready to dismantle them. The articles below aren't advice. They're mirrors. The sites aren't tools. They're practice fields for the kind of connection that changes your molecular structure.",
    articles: [
    ...
    sites: [
      {
        ...
        why: "15 questions. 5 domains. The invisible architecture of your intimacy, mapped.",
      },
      {
        name: "Find Your Team",
        url: "/flow-circuit",
        why: "The neurochemistry of connection — who you build with, measured not guessed.",
      },
      {
        name: "Find Your Water",
        url: "https://aqwaterqpr-wvzsc3ph.manus.space",
        why: "The element that teaches you to flow, not force.",
      },
    ],
    deeperAssessments: [
      {
        label: "Find Your Score",
        path: "/assessments/grant-study",
        why: "85 years of Harvard data says relationships predict everything. Let's see yours.",
      },
      {
        label: "Find Your Mirror",
        path: "/the-mirror",
        why: "6 dimensions. 18 questions. A radar chart that doesn't care about your feelings.",
      },
    ],
    nextStep: { label: "Find Your Partner", path: "https://intimacyassess-tcir3hon.manus.space" },
    shareText:
      "Turns out I'm a Magnetic Partner — my deepest work is relational truth. 5 questions, zero BS. What are you?",
  },
  {
    id: "purpose",
    ...
    description:
      "Your mind works in infrastructure. While others debate symptoms, you're already sketching the replacement. The articles below will sharpen your pattern recognition. The sites will show you systems already being built. Your tribe is smaller than you think — and more powerful than you know.",
    articles: [
    ...
    sites: [
      {
        ...
        why: "The operating system for what comes after extraction.",
      },
      {
        name: "Find Your Capital",
        url: "https://portfoliofamilyoffice.manus.space",
        why: "How aligned money actually moves.",
      },
    ],
    deeperAssessments: [
      {
        label: "Find Your Purpose",
        path: "/assessments/dharma-finder",
        why: "25 questions stolen from Schmachtenberger. Not what you should do — what you can't stop doing.",
      },
      {
        label: "Find Your Mirror",
        path: "/the-mirror",
        why: "6 dimensions. 18 questions. Systems thinkers love data about themselves.",
      },
    ],
    nextStep: { label: "Find Your Blueprint", path: "/living-declaration" },
    shareText:
      "Apparently I'm a Systems Architect — I see what replaces the broken. 5 questions told me what I already knew. Your turn:",
  },
  {
    id: "body",
    ...
    description:
      "You've tried the hacks. The protocols. The 47-step morning routines. Now you're ready for something deeper — understanding your own biochemistry not as a problem to solve but as a language to learn. The articles below decode that language. The sites give you the lab.",
    articles: [
    ...
    sites: [
      {
        ...
        why: "Your biochemistry decoded — not as a problem, as a language.",
      },
      {
        name: "Find Your Water",
        url: "https://aqwaterqpr-wvzsc3ph.manus.space",
        why: "Water as medicine, not commodity.",
      },
      {
        name: "Find Your Mezcal",
        url: "https://mezcalagave-ahru9fq8.manus.space",
        why: "The sacred in the everyday ritual.",
      },
    ],
    deeperAssessments: [
      {
        label: "Find Your Level",
        path: "/assessments/consciousness-scale",
        why: "Hawkins calibrated 17 levels from Shame to Enlightenment. Your body already knows which one.",
      },
      {
        label: "Find Your Mirror",
        path: "/the-mirror",
        why: "6 dimensions including the body you've been negotiating with. Time to listen.",
      },
    ],
    nextStep: { label: "Find Your Chemistry", path: "https://regenhealth-4nns6jnd.manus.space" },
    shareText:
      "So I'm a Temple Keeper — my body's been talking and I finally listened. 5 questions, no hacks. What does your mirror say?",
  },
  {
    id: "truth",
    ...
    description:
      "You have an allergy to bullshit that most people mistake for cynicism. It's not. It's precision. You see through systems, relationships, and narratives to the structural truth underneath — and you're done being polite about it. The articles below are written by someone with the same allergy.",
    articles: [
      "the-great-ai-swindle-how-big-tech-is-selling-you-a-future-it-cant-deliver",
      "the-trust-economy-why-the-next-trillion-dollar-companies-will-be-built-on-radical-transparency",
      "the-gdp-delusion-why-the-worlds-favorite-metric-is-its-most-dangerous-lie",
    ...
    sites: [
      {
        name: "Find Your Evidence",
        url: "/homeaglow-the-anatomy-of-a-consumer-fraud",
        why: "What happens when someone actually follows the receipts.",
      },
      {
        name: "Find Your Blueprint",
        url: "/living-declaration",
        why: "Truth as operating system.",
      },
    ...
    deeperAssessments: [
      {
        label: "Find Your Purpose",
        path: "/assessments/dharma-finder",
        why: "Truth without purpose is just complaining. 25 questions to find what yours is for.",
      },
      {
        label: "Find Your Level",
        path: "/assessments/consciousness-scale",
        why: "Hawkins says truth-telling starts at 200. Where do you actually calibrate?",
      },
    ],
    nextStep: { label: "Find Your Living Declaration", path: "/living-declaration" },
    shareText:
      "Confirmed: I'm a Truth Speaker — allergic to bullshit with clinical precision. 5 questions stripped the paint off. Dare you:",
  },
  {
    id: "tribe",
    name: "The Tribe Weaver",
    tagline:
      "You don't just want to find your people. You want to build the place where people find each other.",
    description:
      "Connection isn't a nice-to-have for you — it's infrastructure. You understand that the most powerful technology on earth is a room full of aligned humans. The articles below map the territory. The community is where you start building.",
    articles: [
      "the-decay-of-modern-day-communication-and-how-it-is-affecting-your-relationships",
      "the-ties-that-bind-interpersonal-relationships-and-the-art-of-meaningful-connection",
      "the-trust-economy-why-the-next-trillion-dollar-companies-will-be-built-on-radical-transparency",
    ...
    sites: [
      {
        name: "Find Your Partner",
        url: "https://intimacyassess-tcir3hon.manus.space",
        why: "Understand how you connect before you connect.",
      },
      {
        name: "Find Your Capital",
        url: "https://portfoliofamilyoffice.manus.space",
        why: "Aligned capital builds aligned communities.",
      },
    ],
    deeperAssessments: [
      {
        label: "Find Your Score",
        path: "/assessments/grant-study",
        why: "You build tribes. But how deep are the ones you're already in? Harvard wants to know.",
      },
      {
        label: "Find Your Mirror",
        path: "/the-mirror",
        why: "Before you weave others together, see the full picture of where you stand.",
      },
    ],
    nextStep: { label: "Find Your Tribe", path: "/community" },
    shareText:
      "I'm a Tribe Weaver — I build the rooms where the right people find each other. 5 questions. What are you building?",
  },
  {
    id: "consciousness",
    ...
    description:
      "Whether through meditation, medicine, crisis, or quiet revelation — you've glimpsed something beyond the default settings. Now you want to understand it. Not as woo. As architecture. The articles below treat consciousness as engineering, not escapism. The sites are your lab.",
    articles: [
      "the-molecule-as-mirror-what-psychedelics-reveal-about-consciousness",
      "the-science-of-being-alone-why-solitude-is-a-superpower",
      "love-as-dharma-a-science-based-playbook-for-magnetic-partnership",
    ...
    sites: [
      {
        name: "Find Your Team",
        url: "/flow-circuit",
        why: "Consciousness as measurable team dynamics.",
      },
      {
        name: "Find Your Water",
        url: "https://aqwaterqpr-wvzsc3ph.manus.space",
        why: "The element that teaches presence.",
      },
      {
        name: "Find Your Chemistry",
        url: "https://regenhealth-4nns6jnd.manus.space",
        why: "Optimize the vessel for the signal.",
      },
    ],
    deeperAssessments: [
      {
        label: "Find Your Level",
        path: "/assessments/consciousness-scale",
        why: "17 levels. Shame to Enlightenment. You've glimpsed the edge — now get coordinates.",
      },
      {
        label: "Find Your Mirror",
        path: "/the-mirror",
        why: "Consciousness without self-knowledge is just tripping. 6 dimensions of ground truth.",
      },
    ],
    nextStep: { label: "Find Your Mirror", path: "/the-mirror" },
    shareText:
      "I'm a Consciousness Explorer — awareness as architecture, not escapism. 5 questions cracked the code. Ready to look?",
  },
];
...
export const WOUND_CARDS: WoundCard[] = [
    ...
    links: [
      {
        ...
        path: "https://intimacyassess-tcir3hon.manus.space",
        type: "assessment",
      },
  ...
  },
  {
    ...
    links: [
      {
        label: "Find Your Chemistry",
        path: "https://regenhealth-4nns6jnd.manus.space",
        type: "tool",
      },
  ...
  },
  {
    ...
    links: [
      ...
      {
        label: "Find Your Evidence",
        path: "/homeaglow-the-anatomy-of-a-consumer-fraud",
        type: "reading",
      },
    ],
  },
  ...
  },
  {
    ...
    links: [
      {
        label: "Find Your Capital",
        path: "https://portfoliofamilyoffice.manus.space",
        type: "tool",
      },
      { label: "Find Your Blueprint", path: "/living-declaration", type: "tool" },
      { label: "Find Your Purpose", path: "/assessments/dharma-finder", type: "assessment" },
...
export const DIRECTORY: DirectorySection[] = [
  {
    ...
    items: [
      {
        name: "Find My",
        hook: "5 questions. Zero right answers. One reckoning.",
        status: "live",
        url: "/find-my",
      },
      {
      ...
      },
      {
        ...
        hook: "6 dimensions. 18 questions. A radar chart that doesn't care about your feelings.",
        status: "live",
        url: "/the-mirror",
      },
      {
        name: "Find Your Level",
        hook: "Where you sit on the consciousness scale — and what's keeping you there.",
        status: "live",
        url: "/consciousness-scale",
      },
      {
        name: "Find Your Score",
        hook: "85 years of Harvard data says relationships predict everything.",
        status: "live",
        url: "/grant-study",
      },
      {
        name: "Find Your Spirit",
        hook: "35 questions across 10 dimensions. Map your beliefs and discover which of 6 spiritual traditions align with your authentic identity.",
        status: "live",
  ...
  },
  {
    ...
    items: [
      {
        name: "Find Your Partner",
        hook: "15 questions across 5 domains. The invisible architecture of your intimacy, mapped.",
        status: "live",
        url: "https://intimacyassess-tcir3hon.manus.space",
      },
      {
        name: "Find Your Tribe",
        hook: "The people who think like you do at 2am.",
        status: "live",
        url: "/community",
      },
      {
        name: "Find Your Team",
        hook: "The neurochemistry of connection — who you build with, measured not guessed.",
        status: "coming",
        url: "/flow-circuit",
      },
      {
        name: "Find Your Attachment Style",
        hook: "Why you cling, why you run, and what to do about it.",
        status: "live",
        url: "/find-your-attachment-style",
      },
      {
        name: "Find Your Love Language",
        hook: "Not the book. The actual operating system underneath.",
        status: "live",
        url: "/find-your-love-language",
      },
      {
        name: "Find Your Sexuality",
        hook: "12 archetypes. The intersection of desire, identity, and honesty.",
        status: "live",
        url: "/find-your-sexuality",
      },
    ],
  },
  {
    ...
    items: [
      {
        name: "Find Your Chemistry",
        hook: "Your body is a lab. Time to read the results.",
        status: "live",
        url: "https://regenhealth-4nns6jnd.manus.space",
      },
      {
        name: "Find Your Water",
        hook: "The element that teaches you to flow, not force.",
        status: "live",
        url: "https://aqwaterqpr-wvzsc3ph.manus.space",
      },
      {
        name: "Find Your Diet",
        hook: "Not a meal plan. A metabolic philosophy matched to your biology.",
        status: "live",
        url: "/find-your-diet",
      },
      {
        name: "Find Your Movement",
        hook: "The exercise your nervous system is actually asking for.",
        status: "live",
        url: "/find-your-movement",
      },
      {
        name: "Find Your Sleep",
        hook: "The architecture of rest you've been negotiating with instead of honoring.",
        status: "live",
        url: "/find-your-sleep",
      },
      {
        name: "Find Your Peptide",
        hook: "16 profiles across 7 axes. Real research, not a supplement funnel.",
        status: "live",
  ...
  },
  {
    ...
    items: [
      {
        name: "Find Your Mezcal",
        hook: "The agave that matches your soul — not your Instagram.",
        status: "live",
        url: "https://mezcalagave-ahru9fq8.manus.space",
      },
      {
        name: "Find Your Tequila",
        hook: "Highland or lowland. Blanco or añejo. A love letter in liquid form.",
        status: "live",
        url: "https://tequilaazul-fxqrr3js.manus.space",
      },
      {
        name: "Find Your Sake",
        hook: "Rice, water, koji, time. The most honest drink on earth.",
        status: "live",
        url: "/find-your-sake",
      },
      {
        name: "Find Your Coffee",
        hook: "Single origin isn't a flex. It's a relationship.",
        status: "live",
        url: "/find-your-coffee",
      },
      {
        name: "Find Your Kitchen",
        hook: "The restaurant that feeds who you actually are, not who you're performing.",
        status: "live",
  ...
  },
  {
    ...
    items: [
      {
        name: "Find Your Blueprint",
        hook: "The operating system for what comes after extraction.",
        status: "live",
        url: "/living-declaration",
      },
      {
        name: "Find Your Capital",
        hook: "How aligned money actually moves.",
        status: "live",
        url: "https://portfoliofamilyoffice.manus.space",
      },
      {
        name: "Find Your Therapy",
        hook: "CBT, IFS, somatic, psychedelic-assisted — matched to your wiring, not a waitlist.",
        status: "live",
        url: "/find-your-therapy",
      },
      {
        name: "Find Your Religion",
        hook: "Not which one is right. Which one is yours — or none at all. 20 questions mapping your worldview across 8 dimensions to 8 spiritual archetypes.",
        status: "live",
        url: "/find-your-religion",
      },
      {
        name: "Find Your Style",
        hook: "Clothing as identity architecture. What you wear is what you're saying without speaking.",
        status: "live",
        url: "/find-your-style",
      },
    ],
...
export const DIRECTORY_LIVE = DIRECTORY.reduce(
  (sum, s) => sum + s.items.filter((i) => i.status === "live").length,
  0,
);
