...
export type MirrorDimensionId =
  "relationships" | "purpose" | "body" | "truth" | "tribe" | "consciousness";
...
export const MIRROR_DIMENSIONS: MirrorDimension[] = [
  ...
  },
  {
    ...
    flowState:
      "Integrated awareness — you've done the work and it shows in how you move through the world",
...
export const MIRROR_ARTICLES: Record<string, MirrorArticle> = {
  "the-butchers-daughter-the-carbon-toll-and-the-cheese-that-ate-the-planet": {
    ...
    prompt:
      "Do you change your behavior when the evidence demands it — or do you negotiate with the truth?",
  },
  ...
  "marc-andreessen-rebuttal-2020": {
    ...
    prompt:
      "Can you disagree with someone you admire without losing respect for them — or yourself?",
  },
  ...
  "find-my-ev-paul-scott-wont-let-you-buy-a-gas-car": {
    ...
    prompt:
      "You have the math. You have the evidence. You have the budget guide. The only question left is whether you will act — or keep carrying excuses for an industry that does not care about you.",
  },
};
