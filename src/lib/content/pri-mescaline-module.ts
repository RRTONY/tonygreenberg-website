...
export const MESCALINE_PHARMACOLOGY: ReceptorRow[] = [
  {
    ...
    clinicalUse: "Primary psychedelic; depression, neuroplasticity",
  },
  ...
  { receptor: "\u03B11A/\u03B12A", action: "Agonist", clinicalUse: "Arousal, sympathomimetic" },
  {
    ...
    action: "No affinity",
    clinicalUse: "No serotonin dump (unlike MDMA/SSRIs)",
  },
];
...
export const LATUDA_MIRROR_ONELINER =
  "Latuda suppresses the serotonin system daily. Mescaline resets it once.";
...
export const OUTCOMES_SOURCE =
  "Agin-Liebes et al., ACS Pharmacology 2021 (n=452 naturalistic users)";
export const OUTCOMES_SPIRITUAL =
  "35\u201350% rated it single most spiritually significant experience of their life";
...
export const PHARMA_ALTERNATIVES: PharmaAltRow[] = [
  {
    ...
    category: "SSRI",
    plantAlt: "Psilocybin; Mescaline",
    supplementAlt: "St. John\u2019s Wort; Saffron; Omega-3 EPA",
    evidence: "Strong (Psilo)",
  },
  {
    drug: "Escitalopram (Lexapro)",
    category: "SSRI",
    plantAlt: "Psilocybin (head-to-head trial)",
    supplementAlt: "Rhodiola; Ashwagandha KSM-66; SAMe",
    evidence: "Strong",
  },
  {
    drug: "Venlafaxine (Effexor)",
    category: "SNRI",
    plantAlt: "MDMA therapy; Ketamine",
    supplementAlt: "5-HTP; Mag Threonate; NAC",
    evidence: "Moderate",
  },
  {
    drug: "Bupropion (Wellbutrin)",
    category: "NDRI",
    plantAlt: "Ibogaine; Psilocybin (smoking)",
    supplementAlt: "Tyrosine; Mucuna pruriens",
    evidence: "Strong (Psilo+smoking)",
  },
  {
    drug: "Lurasidone (Latuda)",
    category: "Antipsychotic",
    plantAlt: "Mescaline/Peyote; Psilocybin",
    supplementAlt: "Lion\u2019s Mane; Omega-3; Glycine 8g",
    evidence: "Emerging (Mesc)",
  },
  {
    drug: "Quetiapine (Seroquel)",
    category: "Antipsychotic",
    plantAlt: "Holotropic Breathwork; Microdose",
    supplementAlt: "Magnesium Glycinate; L-Theanine",
    evidence: "Emerging",
  },
  {
    drug: "Aripiprazole (Abilify)",
    category: "Antipsychotic",
    plantAlt: "Microdose Psilocybin; CBD",
    supplementAlt: "Bacopa; NAC; Sarcosine",
    evidence: "Emerging",
  },
  {
    drug: "Alprazolam (Xanax)",
    category: "Benzo",
    plantAlt: "Rap\u00e9h; Breathwork; Cacao",
    supplementAlt: "Kava (200\u2013300mg); GABA+L-Theanine",
    evidence: "Moderate (Kava)",
  },
  {
    drug: "Buspirone (Buspar)",
    category: "5-HT1A",
    plantAlt: "Mescaline; Psilocybin",
    supplementAlt: "Ashwagandha; CBD; Rhodiola",
    evidence: "Moderate",
  },
  {
    drug: "Lithium (Lithobid)",
    category: "Mood stabilizer",
    plantAlt: "\u26A0\uFE0F Contraindicated with most psychedelics",
    supplementAlt: "Lithium Orotate 5\u201320mg; Omega-3; Inositol",
    evidence: "Moderate",
  },
  {
    drug: "Valproate (Depakote)",
    category: "Mood stabilizer",
    plantAlt: "Psilocybin (cluster HA); LSD micro",
    supplementAlt: "Magnesium; Riboflavin 400mg",
    evidence: "Emerging",
  },
  {
    drug: "Prazosin (PTSD)",
    category: "Alpha blocker",
    plantAlt: "MDMA therapy; Mescaline",
    supplementAlt: "Phosphatidylserine; Lion\u2019s Mane; CBD",
    evidence: "Strong (MDMA)",
  },
  {
    drug: "Methylphenidate (Ritalin)",
    category: "Stimulant/ADHD",
    plantAlt: "Microdosing; Lion\u2019s Mane Stack",
    supplementAlt: "Bacopa; Omega-3; Zinc; PS",
    evidence: "Emerging",
  },
  {
    drug: "Naltrexone (Vivitrol)",
    category: "Opioid antagonist",
    plantAlt: "Ibogaine; Peyote (alcohol); Psilocybin",
    supplementAlt: "NAC; Kudzu; Milk Thistle",
    evidence: "Strong (Ibogaine+Peyote)",
  },
  {
    drug: "Varenicline (Chantix)",
    category: "Smoking cessation",
    plantAlt: "Psilocybin (80% quit, Hopkins)",
  ...
  },
  {
    ...
    category: "Sleep",
    plantAlt: "CBD; Breathwork",
    supplementAlt: "Mag Glycinate; Glycine 3g; L-Theanine",
    evidence: "Moderate",
  },
];
...
export const SUPPLEMENT_STACKS: SupplementPhase[] = [
  {
    ...
    items: [
      ...
      },
      {
        ...
        dosage: "300\u2013600mg 2x/day",
        searchUrl: "https://amazon.com/s?k=ashwagandha+ksm-66",
      },
      {
        name: "NAC",
        dosage: "600mg 2x (stop 48hr before)",
  ...
  },
  {
    ...
    items: [
      {
        name: "Ginger root",
        dosage: "500mg 1hr before (nausea)",
        searchUrl: "https://amazon.com/s?k=ginger+root+capsules",
      },
      {
        name: "Niacin (flush)",
        dosage: "100\u2013500mg emergency grounding",
        searchUrl: "https://amazon.com/s?k=niacin+flush",
      },
      {
        name: "Electrolytes (LMNT)",
        dosage: "1 packet pre + during",
  ...
  },
  {
    ...
    items: [
      ...
      {
        name: "5-HTP",
        dosage: "100mg evening (MDMA only; never with SSRIs)",
        searchUrl: "https://amazon.com/s?k=5-htp+100mg",
      },
      {
        name: "Microdose protocol (Fadiman)",
        dosage: "0.1g psilocybin / every 3 days",
        searchUrl: "",
      },
    ],
  },
...
export const MESCALINE_DISCLAIMER =
