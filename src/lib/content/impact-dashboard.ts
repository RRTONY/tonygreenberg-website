...
export const PORTFOLIO_CATEGORIES: PortfolioCategory[] = [
  { name: "Enterprise Technology & AI", color: "#3498DB", companies: 1, avgHawkins: 400, avgComposite: 7.9, keyMetric: "$10B+ benchmarked", iconKey: "zap" },
  { name: "Social Impact & Tokenization", color: "#D4B96A", companies: 1, avgHawkins: 540, avgComposite: 9.1, keyMetric: "4 live token ecosystems", iconKey: "target" },
  { name: "Psychedelic Medicine", color: "#9B59B6", companies: 6, avgHawkins: 507, avgComposite: 7.4, keyMetric: "FDA Breakthrough Therapy", iconKey: "flask" },
  { name: "Impact Venture & Finance", color: "#27AE60", companies: 7, avgHawkins: 380, avgComposite: 6.8, keyMetric: "1.2M people impacted", iconKey: "gem" },
  { name: "Web3, DAOs & Governance", color: "#3498DB", companies: 4, avgHawkins: 350, avgComposite: 6.2, keyMetric: "Decentralized governance", iconKey: "link" },
  { name: "Blockchain Infrastructure", color: "#E67E22", companies: 6, avgHawkins: 320, avgComposite: 5.9, keyMetric: "Cross-chain protocols", iconKey: "building" },
  { name: "Identity & Trust", color: "#1ABC9C", companies: 2, avgHawkins: 410, avgComposite: 7.1, keyMetric: "55% YoY revenue growth", iconKey: "lock" },
  { name: "Health & Wellness Tech", color: "#E74C3C", companies: 2, avgHawkins: 360, avgComposite: 6.4, keyMetric: "Novel therapeutics", iconKey: "heart" },
];
