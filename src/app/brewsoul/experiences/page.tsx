...
export const metadata: Metadata = {
  ...
  description: "The best coffee experiences in the world — origin farm tours, legendary cafés, cupping labs, and roastery visits. Curated, not sponsored.",
...
export default function BrewSoulExperiencesPage() {
  return (
    <section className="mx-auto max-w-225 px-6 py-12">
      <div className="mb-2 font-mono text-xs tracking-[0.25em] text-[#C5A23C] uppercase">Beyond the Cup</div>
      <h1 className="mb-2 font-heading text-3xl font-bold text-[#2C1810] sm:text-4xl">Experience Map</h1>
      <p className="mb-8 max-w-2xl text-[0.95rem] leading-relaxed text-[#6B5B4F]">
        The best coffee experiences in the world — from origin farm tours to legendary cafés, cupping labs, and immersive roastery visits. Curated, not
        sponsored.
      </p>
