...
export const metadata: Metadata = {
  ...
  description:
    "Meet the people who grow your coffee — verified for transparency, fair labor, and environmental stewardship.",
  ...
  return (
    <section className="mx-auto max-w-225 px-6 py-12">
      ...
      <p className="mb-10 max-w-2xl text-[0.95rem] leading-relaxed text-[#6B5B4F]">
        Meet the people who grow your coffee. Every farm profiled here has been verified for
        transparency, fair labor practices, and environmental stewardship.
      </p>
            ...
            <div className="p-6">
              ...
              <div className="flex flex-wrap gap-1.5">
                {f.varieties.map((v) => (
                  <span
                    key={v}
                    className="rounded-full bg-[#4A7C59]/6 px-2 py-0.5 font-mono text-[0.65rem] text-[#4A7C59]"
                  >
                    {v}
                  </span>
                ))}
              ...
              {f.certifications.length > 0 && (
                <div className="mt-2 flex flex-wrap gap-1.5">
                  {f.certifications.map((c) => (
                    <span
                      key={c}
                      className="rounded-full bg-[#C5A23C]/6 px-2 py-0.5 font-mono text-[0.6rem] text-[#8B6914]"
                    >
                      {c}
                    </span>
                  ))}
      ...
      <NextSteps
        steps={[
          ...
          {
            label: "Browse Farm Coffees",
            path: "/brewsoul/browse",
            description: "Taste the origin",
          },
        ]}
      />
    </section>
