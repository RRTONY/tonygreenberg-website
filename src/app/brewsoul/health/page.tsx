...
export const metadata: Metadata = {
  ...
  description: "The complete science of coffee and health: longevity, cognition, cardiovascular effects, caffeine genetics, and mycotoxin risk. Every claim cited.",
  alternates: { canonical: "/brewsoul/health" },
};

const LONGEVITY = [
  { title: "All-Cause Mortality", finding: "3-5 cups/day → 15% lower risk of death from any cause", study: "Poole et al., BMJ 2017", n: ">1M participants" },
  { title: "Type 2 Diabetes", finding: "Each daily cup → 6% lower risk. One of the most robust findings in coffee research.", study: "Ding et al., Diabetes Care 2014", n: "1.1M participants, 28 studies" },
  { title: "Liver Protection", finding: "2+ cups/day → 44% lower cirrhosis risk, 40% lower liver cancer risk. Coffee is the #1 dietary protector of the liver.", study: "Kennedy et al., Alimentary Pharmacology 2016", n: "430K participants" },
  { title: "Cardiovascular Disease", finding: "3-5 cups/day → 15% lower CVD risk. J-shaped curve: moderate intake protective, extreme intake neutral.", study: "Ding et al., Circulation 2014", n: "1.3M participants" },
  { title: "Parkinson's Disease", finding: "25-30% lower risk with regular consumption. Caffeine appears to be the protective compound — decaf shows weaker association.", study: "Qi & Li, Geriatrics & Gerontology International 2014", n: "680K participants" },
  { title: "Depression", finding: "4+ cups/day → 20% lower risk. Caffeine's dopaminergic effects may be protective.", study: "Wang et al., Australian & NZ Journal of Psychiatry 2016", n: "346K participants" },
  { title: "Colorectal Cancer", finding: "4+ cups/day → 15% lower risk. Both caffeinated and decaf show benefit, suggesting polyphenols are the active agent.", study: "Gan et al., BMC Cancer 2017", n: "5.4M participants" },
  { title: "Alzheimer's Disease", finding: "3-5 cups/day → 65% lower risk in midlife drinkers. Caffeine may block beta-amyloid accumulation.", study: "Eskelinen et al., Journal of Alzheimer's Disease 2009", n: "1,409 participants, 21-year follow-up" },
];

const RISKS: { title: string; detail: string; citation: string; severity: "HIGH" | "MODERATE" | "LOW" }[] = [
...
const CAFFEINE_METABOLISM = [
  { gene: "CYP1A2 — Fast Metabolizer", pct: "~50% of population", halfLife: "2-4 hours", effect: "Coffee is protective. 2-3 cups/day associated with lower heart attack risk.", advice: "You can drink coffee later in the day with less sleep impact. Still cut off by 2pm for optimal sleep.", fast: true },
  { gene: "CYP1A2 — Slow Metabolizer", pct: "~50% of population", halfLife: "6-10 hours", effect: "Coffee may increase heart attack risk at high doses. Anxiety more likely.", advice: "Limit to 1-2 cups before noon. Switch to decaf after 10am. Your genetics make timing critical.", fast: false },
];
  ...
  return (
    <div className="bg-[#f5efe0] text-[#2d1810]">
      ...
      <section className="relative flex min-h-[70vh] items-center justify-center overflow-hidden bg-linear-to-br from-[#2a4c5c] via-[#1a0e08] to-[#3a7a4a] px-7 py-20 text-center">
        <div className="relative z-1 max-w-3xl">
          ...
          <p className="mx-auto mb-10 max-w-xl text-[clamp(16px,2vw,20px)] leading-relaxed text-[#f5efe0]/70">
            Every claim peer-reviewed. Every citation linked. Caffeine metabolism, cortisol timing, mycotoxin risk, compound science, and the longevity data
            that changes how you drink.
          </p>
      ...
      <section className="bg-[#ede4d0] px-7 py-20">
        <div className="mx-auto max-w-275">
          ...
          <p className="mb-4.5 max-w-180 text-[17px] leading-[1.7] text-[#2d1810]">
            Coffee is the single most studied beverage in nutritional science. The data is overwhelming: moderate consumption (3-5 cups/day) is associated
            with lower risk of death from virtually every major disease. These aren&apos;t wellness blog claims — they&apos;re meta-analyses of millions of
            participants published in the world&apos;s top medical journals.
          </p>

          <div className="my-7 grid gap-4 [grid-template-columns:repeat(auto-fit,minmax(300px,1fr))]">
            {LONGEVITY.map((l) => (
              <div key={l.title} className="rounded-lg border border-[#5d3a28]/8 border-l-4 border-l-[#3a7a4a] bg-white p-5">
          ...
          <div className="mt-4 rounded-lg border-l-4 border-l-[#c4873b] bg-white p-6">
            ...
            <p className="text-[17px] leading-[1.7] text-[#2d1810]">
              Nearly all benefits follow a J-shaped or U-shaped curve. The sweet spot is 3-5 cups/day for most outcomes. Below 3 cups, benefits are present
              but smaller. Above 5-6 cups, benefits plateau and some risks increase. The simplification principle: 3 cups of high-quality coffee beats 6
              cups of commodity coffee for every measured outcome.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="bg-linear-to-b from-[#1a0e08] to-[#2d1810] px-7 py-20">
        <div className="mx-auto max-w-275">
          <div className="mb-3 font-mono text-[11px] tracking-[0.3em] text-[#e8dcc8]/80 uppercase">The Real Risks</div>
          ...
          <p className="mb-6 max-w-180 text-[17px] leading-[1.7] text-[#f5efe0]/88">
            Coffee isn&apos;t universally beneficial. These are the evidence-based risks — not wellness panic, not coffee-industry denial. Manage these and
            coffee becomes net positive for almost everyone.
          </p>
      ...
      <section className="bg-[#f5efe0] px-7 py-20">
        <div className="mx-auto max-w-275">
          ...
          <p className="mb-4.5 max-w-180 text-[17px] leading-[1.7] text-[#2d1810]">
            ...
            longevity tool or a cardiovascular risk. Most people don&apos;t know which they are — but your body gives clear signals.
          </p>
          ...
          <div className="my-7 grid gap-5 [grid-template-columns:repeat(auto-fit,minmax(320px,1fr))]">
            {CAFFEINE_METABOLISM.map((m) => (
              ...
              >
                <div className={`mb-3 font-mono text-[11px] font-semibold tracking-wide ${m.fast ? "text-[#3a7a4a]" : "text-[#8b4c2a]"}`}>{m.gene}</div>
                ...
                <div className="rounded-md bg-[#ede4d0] p-3">
                  <div className="mb-1 font-mono text-[9px] tracking-wide text-[#6b5a4e]">Recommendation</div>
          ...
          <div className="rounded-lg border-l-4 border-l-[#4a7c8c] bg-[#ede4d0] p-6">
            ...
            <p className="text-[17px] leading-[1.7] text-[#2d1810]">
              If you can drink espresso after dinner and sleep fine, you&apos;re likely a fast metabolizer. If a single cup makes you jittery or anxious,
              you&apos;re likely slow. Genetic testing (23andMe, AncestryDNA) can confirm via the CYP1A2 SNP rs762551. But your body&apos;s signals are
              usually sufficient.
            </p>
          </div>
        </div>
      ...
      <section className="bg-[#ede4d0] px-7 py-20">
        <div className="mx-auto max-w-275">
          ...
          <p className="mb-4.5 max-w-180 text-[17px] leading-[1.7] text-[#2d1810]">
            ...
            accumulation drives sleep pressure. Here&apos;s the science-backed schedule.
          </p>
      ...
      <section className="bg-[#f5efe0] px-7 py-20">
        <div className="mx-auto max-w-275">
          ...
          <p className="mb-4.5 max-w-180 text-[17px] leading-[1.7] text-[#2d1810]">
            ...
            roast level, brew method, and whether organic/biodynamic matters.
          </p>
          ...
          <div className="mt-5 rounded-lg border-l-4 border-l-[#4a5e3c] bg-white p-6">
            ...
            <p className="text-[17px] leading-[1.7] text-[#2d1810]">
              Light roast = maximum CGA, trigonelline, and caffeine. Dark roast = maximum melanoidins, minimum acrylamide, lower caffeine. Medium roast is
              the optimal tradeoff for most health goals. If you&apos;re drinking biodynamic for maximum nutritional value, choose light or medium roast —
              you&apos;re paying a premium for compounds that dark roasting destroys.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="bg-linear-to-b from-[#2d3a24] to-[#1a0e08] px-7 py-20">
        <div className="mx-auto max-w-275">
          <div className="mb-3 font-mono text-[11px] tracking-[0.3em] text-[#e8dcc8]/80 uppercase">The Hidden Threat</div>
          <h2 className="mb-6 font-heading text-[clamp(28px,4vw,44px)] leading-[1.15] font-bold text-[#f5efe0] italic">
            Mycotoxins, Mold & What They Don&apos;t Tell You
          </h2>
          <p className="mb-6 max-w-180 text-[17px] leading-[1.7] text-[#f5efe0]/88">
            Coffee is one of the most mycotoxin-prone crops on earth. Improper drying, storage, and processing create conditions for mold growth. Most
            commercial coffee is never tested. The brands that test and disclose are the ones worth buying.
          </p>

          <div className="my-7 grid gap-4 [grid-template-columns:repeat(auto-fit,minmax(300px,1fr))]">
            {MYCOTOXINS.map((m) => (
              <div key={m.toxin} className="rounded-lg border border-white/10 border-t-3 border-t-[#8b4c2a] bg-white/5 p-6">
                <div className="mb-2 font-mono text-[11px] font-semibold tracking-wide text-[#8b4c2a]">{m.toxin}</div>
          ...
          <div className="mt-4 rounded-lg border border-white/10 bg-white/5 p-6">
            ...
            <p className="text-[17px] leading-[1.7] text-[#f5efe0]/88">
              Purity Coffee (350+ compounds), Lifeboost (450+ toxins), Holistic Roasters (mold, mycotoxins, heavy metals, pesticides). These three brands
              publish their testing protocols. Most specialty roasters don&apos;t test at all — they rely on SCA grading, which doesn&apos;t include
              mycotoxin screening. &ldquo;Specialty grade&rdquo; ≠ &ldquo;mold-free.&rdquo;
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="bg-[#f5efe0] px-7 py-20">
        <div className="mx-auto max-w-275">
          ...
          <p className="mb-4.5 max-w-180 text-[17px] leading-[1.7] text-[#2d1810]">
            All of this research points to the same conclusion: fewer cups, better cups, right timing. Here&apos;s the evidence-based protocol that
          ...
          <div className="my-7 rounded-lg bg-[#1a0e08] p-8">
            <div className="grid gap-6 [grid-template-columns:repeat(auto-fit,minmax(280px,1fr))]">
              {PROTOCOL.map((p) => (
                <div key={p.n} className={`rounded-md border border-white/10 bg-white/5 p-6 border-t-3 ${p.colorClass}`}>
          ...
          <div className="rounded-lg border-l-4 border-l-[#c4873b] bg-[#ede4d0] p-6">
            ...
            <p className="text-[17px] leading-[1.7] text-[#2d1810]">
              2-3 cups of biodynamic coffee per day (1-2 caf + 1 decaf) costs ~$1.50-2.50/day. The average American spends $5.40/day on coffee (NCA 2024).
              You spend less, get more bioactive compounds per cup, avoid mycotoxins and pesticides, protect your sleep, and fund regenerative agriculture.
              Fewer cups. Better cups. Lower cost. Higher impact. That&apos;s simplification.
            </p>
          </div>
        </div>
      </section>
      ...
      <footer className="bg-[#1a0e08] px-7 py-12 text-center">
        <div className="mb-2 font-heading text-2xl font-bold text-[#f5efe0] italic">BrewSoul · Coffee & Health</div>
