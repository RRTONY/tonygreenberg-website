...
export const metadata: Metadata = {
  ...
  description:
    "The definitive reference for specialty coffee varieties — genetics, cup profiles, and rarity.",
  ...
  return (
    <section className="mx-auto max-w-225 px-6 py-12">
      ...
      <p className="mb-8 max-w-2xl text-[0.95rem] leading-relaxed text-[#6B5B4F]">
        Every coffee variety has a story — where it was discovered, how it mutated, what it tastes
        like. This is the most comprehensive variety guide outside the World Coffee Research
        catalog.
      </p>
