  ...
  return (
    <div>
      <section className="border-b-3 border-[#8b4c2a] bg-linear-to-br from-[#1a0e08] to-[#2d3a24] px-6 py-[clamp(48px,8vw,80px)] pb-12 text-center">
        <div className="mb-4 font-mono text-[11px] tracking-[0.2em] text-[#D4AF37]">Tony G Guest Series</div>
      ...
      <section className="mx-auto max-w-200 px-6 pt-12">
        <div className="mb-10 rounded-lg border-l-4 border-l-[#8b4c2a] bg-linear-to-br from-[#f5efe0] to-[#f9f1e6] p-[clamp(24px,4vw,36px)]">
          <h2 className="mb-4 font-heading text-[clamp(18px,3vw,24px)] text-[#8b4c2a] italic">Why We&apos;re Profiling Shanita Nicholas</h2>
          <p className="mb-3.5 text-base leading-[1.8] text-[#2d1810]">
            The coffee industry has plenty of storytellers. It has very few truth-tellers. Shanita Nicholas is one of the rare people who holds degrees from
            Columbia in both chemical engineering and law, co-founded a nationally recognized Black women-owned specialty brand (Sip &amp; Sonder), earned
            her Q Grader certification, and then walked away from the comfortable narrative to ask the question nobody in specialty coffee wants to answer:{" "}
            <em>Why are the people who grow this still broke?</em>
          </p>
          <p className="mb-3.5 text-base leading-[1.8] text-[#2d1810]">
      ...
      <section className="mx-auto max-w-200 px-6">
        <div className="mb-10 flex flex-col items-center gap-5 rounded-lg bg-white p-[clamp(24px,4vw,40px)] text-center shadow-[0_4px_15px_rgba(0,0,0,0.08)]">
          ...
          <div className="min-w-55 flex-1">
            ...
            <p className="my-1.5 text-sm leading-relaxed text-[#6b5a4e]">
              <strong>Background:</strong> B.S. Chemical Engineering (Columbia), J.D./M.B.A. (Columbia), Certified Q Grader (2023)
            </p>
            <p className="my-1.5 text-sm leading-relaxed text-[#6b5a4e]">
              <strong>Impact:</strong> Co-founded Sip &amp; Sonder (2017)—Black women-owned specialty coffee brand. Now scaling origin-roasting networks
              through Quantum Seeds to move manufacturing and profit to coffee-producing countries.
            </p>
          </div>
        </div>
