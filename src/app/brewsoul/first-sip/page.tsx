    ...
    <div>
      ...
      <section className="relative flex min-h-[70vh] items-center justify-center overflow-hidden bg-linear-to-b from-[#2C1810] via-[#3D2B1F] to-[#FAFAF7]">
        <div className="relative z-10 max-w-2xl px-6 text-center">
          ...
          <p className="mx-auto mb-6 max-w-lg text-base leading-relaxed text-[#F5F0E6]/85">
            A manifesto on coffee, capital, and consciousness — and your guided entry point into the
            tools, economics, health science, and comparisons that live inside this site.
          </p>
      ...
      <section className="bg-linear-to-b from-[#FAFAF7] via-[#F0E8D8] to-[#F5F0E6] px-6 py-16">
        <article className="mx-auto max-w-2xl text-[#2C1810]">
          <p className="mb-5 text-[1.05rem] leading-loose">
            There are revolutions that start with marches in the streets. And there are revolutions
            that begin in kitchens — in the quiet moment when a hand reaches for a cup.
          </p>
          <p className="mb-5 text-[1.05rem] leading-loose">
            Before markets open. Before the news scroll begins. Before anyone decides what to be
            outraged about today.
          </p>
          ...
          <p className="mb-10 text-[1.05rem] leading-loose">
            Coffee is the most universal ceremony of modern civilization. Presidents drink it.
            Artists drink it. Entrepreneurs drink it. Bus drivers drink it. Entire economies lean on
            it. And yet it remains astonishingly misunderstood — especially by the people who
          ...
          <p className="mb-5 text-[1.05rem] leading-loose">
            Coffee is a $100-plus-billion global industry. Roughly 170 to 180 million 60-kilogram
            bags of beans are produced annually. Millions of smallholder farmers depend on it for
            survival. Entire national identities are intertwined with it.
          </p>
          <p className="mb-5 text-[1.05rem] leading-loose">
            And still, most consumers know only the poetry on the label — never the arithmetic
            behind the price. If you want to see that arithmetic laid bare, the{" "}
            <Link
              href="/brewsoul/economics"
              className="font-semibold text-[#8B6914] underline underline-offset-3"
            >
              Coffee Economics
            </Link>{" "}
            tool on this site breaks down exactly where your dollar goes — farmgate to shelf — for
            every brand we&apos;ve analyzed.
          </p>

          <Pullquote>
            The system captures value closest to the cup and pushes risk and volatility closest to
            the soil.
          </Pullquote>

          <p className="mb-5 text-[1.05rem] leading-loose">
            In past commodity crises, producing countries&apos; share of final retail value has been
            documented at single digits — sometimes below ten percent. Less than ten cents of every
            dollar you spend ends up with the people who grew the beans. The rest flows into
            roasting, marketing, branding, rent, equipment, and giant advertising budgets.
          </p>
          <p className="mb-10 text-[1.05rem] leading-loose">
            No one actor is malicious. But the structure is asymmetrical. A $7 latte in Los Angeles
            may contain well under a dollar&apos;s worth of green coffee. That is not a conspiracy —
            it is a system, and the system was knowingly designed that way.
          </p>
          ...
          <p className="mb-5 text-[1.05rem] leading-loose">
            Tadesse Meskela spent decades on the ground with farmers in Ethiopia, organizing
            cooperatives and fighting for fairer prices. He helped build unions that returned
            millions of dollars directly to farming communities — funding schools, water systems,
            and clinics. His work proved something fundamental: when farmers get fairer shares,
            everyone benefits.
          </p>
          <p className="mb-5 text-[1.05rem] leading-loose">
            But farming is still hard. Reports from rural supply chains in Uganda and Rwanda show
            that more than a third of coffee growers reported no profit for the previous season.
            Nearly half had no savings to handle emergencies. Financial vulnerability is not an
            abstract number — it is a lived reality for families whose work fuels your morning brew.
          </p>
          <p className="mb-10 text-[1.05rem] leading-loose">
            And climate change is tightening the vise. Arabica thrives in a narrow range of
            temperatures and rainfall. When those patterns shift, farmers are forced into expensive
            irrigation or lose harvests entirely — while the global price system bounces around
            benchmarks that have little to do with the true cost of living, planting, and
            harvesting.
          </p>
          ...
          <p className="mb-5 text-[1.05rem] leading-loose">
            Most stories on Instagram and marketing pages speak in flavors and adjectives — notes of
            jasmine, dark chocolate, &quot;ethical sourcing,&quot; &quot;direct trade,&quot;
            &quot;regenerative.&quot; These words are seductive. They make us feel good.
          </p>
          <p className="mb-5 text-[1.05rem] leading-loose">
            But most of them are unregulated branding terms. &quot;Direct trade&quot; sounds
            righteous. It often is. But it lacks an independent certification framework, so its
            meaning varies from producer to producer, roaster to roaster. Even established
            certification systems like Fair Trade and Rainforest Alliance are not magic. They
            provide stability and price floors, but they often fail to capture the full economic
            reality for farmers — and sometimes pay premiums that never fully reach the farm.
          </p>
          <p className="mb-10 text-[1.05rem] leading-loose">
            This is where the{" "}
            <Link
              href="/brewsoul/compare"
              className="font-semibold text-[#8B6914] underline underline-offset-3"
            >
              Compare Coffees
            </Link>{" "}
            tool earns its place. It puts brands side by side not on flavor poetry, but on sourcing
            transparency, pricing structure, and certification rigor — the data behind the label.
          </p>

          <Pullquote>
            Good intentions collide with structural complexity. It does not mean coffee is evil. It
            means coffee deserves deeper respect — which includes real transparency.
          </Pullquote>
          ...
          <p className="mb-5 text-[1.05rem] leading-loose">
            Caffeine is one of the most widely consumed psychoactive compounds on Earth. It blocks
            adenosine receptors, delays fatigue, sharpens focus, and for many people, awakens mood
            and productivity. Epidemiological research often shows neutral or even positive
            associations with moderate consumption — reduced risk of certain diseases, improved
            cognitive outcomes in long-term cohorts.
          </p>
          <p className="mb-5 text-[1.05rem] leading-loose">
            But it also elevates cortisol, disrupts sleep architecture, increases heart rate, and
            raises anxiety in susceptible individuals. The &quot;morning fog&quot; we treat with
            caffeine is often the residue of yesterday&apos;s dependency.
          </p>
          <p className="mb-5 text-[1.05rem] leading-loose">
            Dave Asprey argues the real problem is not coffee itself but the quality of what&apos;s
            in the cup — pointing to mold exposure, poor storage, and mycotoxins. Critics say the
            risk levels vary and can be overstated. Both sides agree: transparency and quality
            control matter. Without them, consumers are drinking poetry without seeing the
            spreadsheet.
          </p>
          <p className="mb-10 text-[1.05rem] leading-loose">
            That&apos;s what the{" "}
            <Link
              href="/brewsoul/health"
              className="font-semibold text-[#8B6914] underline underline-offset-3"
            >
              Coffee &amp; Health
            </Link>{" "}
            section is built for — peer-reviewed research on caffeine metabolism, cortisol impact,
            sleep disruption, and real contaminant risks, organized so you can decide based on your
            biology, not someone&apos;s branding budget. And if you want a personalized read on how
            coffee interacts with your body and habits, the{" "}
            <Link
              href="/brewsoul/prescription"
              className="font-semibold text-[#8B6914] underline underline-offset-3"
            >
              Coffee Prescription
            </Link>{" "}
          ...
          <p className="mb-5 text-[1.05rem] leading-loose">
            We are not here to abolish coffee. We are here to outgrow extractive capitalism —
            starting with the first sip of the day.
          </p>
          <p className="mb-8 text-[1.05rem] leading-loose">
            If you pay $22 or $25 for a bag, then &quot;extraordinary&quot; must mean something
            measurable — not just a pretty word on a label. If the majority of your money funds
            Instagram ads rather than farm resilience, you are not drinking craft — you are
            subsidizing artistry without accountability.
          </p>
          ...
          <p className="mb-8 text-[1.05rem] leading-loose">
            Coffee can be the most regenerative daily transaction on Earth — if we make it so. Two
            billion daily sips. Two billion opportunities to choose transparency over mystique. Two
            billion chances to reward soil health, fair pricing, and supply chain integrity.
          </p>
            ...
            <div className="grid gap-2 [grid-template-columns:repeat(auto-fit,minmax(220px,1fr))]">
              {DEMANDS.map((d) => (
                <div key={d} className="flex items-center gap-2">
                  <Check aria-hidden="true" className="size-3.5 shrink-0 text-[#C5A23C]" />
          ...
          <p className="mb-10 text-[1.05rem] leading-loose">
            This is not purity cultism. It is visibility. Because opaque systems favor extraction.
            Transparent systems favor regeneration.
          </p>
          ...
          <p className="mb-5 text-[1.05rem] leading-loose">
            If coffee supports you, use it intentionally. If it disrupts your sleep or nervous
            system, respect that too. And if you want to understand how what you eat alongside
            coffee changes the experience entirely — absorption, acidity, nutrient interaction — the{" "}
            <Link
              href="/brewsoul/pairings"
              className="font-semibold text-[#8B6914] underline underline-offset-3"
            >
              Coffee Pairings
            </Link>{" "}
          ...
          <p className="mb-5 text-[1.05rem] leading-loose">
            This is not a manifesto about abstinence or indulgence. This is about alignment —
            between your spend and fairness, between your biology and choice, between story and
            spreadsheet.
          </p>

          <Pullquote>
            Extractive systems thrive on unconscious repetition. Regenerative systems begin with
      ...
      <section className="bg-linear-to-b from-[#F5F0E6] via-[#E8DCC8] to-[#F0E8D8] px-6 py-16 pb-20">
        <div className="mx-auto max-w-4xl">
          <div className="mb-10 text-center">
            ...
            <h2 className="mb-3 font-heading text-3xl font-bold text-[#2C1810]">
              Five Tools. One Mission.
            </h2>
            <p className="mx-auto max-w-lg text-[#6B5B4F]">
              This essay is the why. Below are the how — five interactive tools built to replace
              marketing poetry with measurable transparency.
            </p>
          </div>
              ...
              return (
                ...
                >
                  <div className="mb-3 flex items-center gap-3">
                    <span className="font-mono text-xs tracking-wide text-[#C5A23C]">
                      {tool.num}
                    </span>
                    <Icon aria-hidden="true" className="size-5 text-[#8B6914]" />
                  </div>
                  <h3 className="mb-2 font-heading text-lg font-bold text-[#2C1810]">
                    {tool.title}
                  </h3>
                  <p className="mb-4 text-sm leading-relaxed text-[#6B5B4F]">{tool.desc}</p>
                  <div className="font-mono text-[0.72rem] font-semibold text-[#8B6914]">
                    {tool.cta}
      ...
      <section className="bg-linear-to-b from-[#FAFAF7] via-[#F0E8D8] to-[#F5F0E6] px-6 py-14 pb-16">
        <div className="mx-auto max-w-2xl">
          <div className="mb-8 text-center">
            ...
            <h2 className="mb-2 font-heading text-2xl font-bold text-[#2C1810]">
              The Deeper Dives
            </h2>
            <p className="text-[0.95rem] text-[#6B5B4F]">
      ...
      <section className="relative bg-linear-to-b from-[#3D2B1F] to-[#2C1810] px-6 py-20 pb-12">
        <div className="mx-auto max-w-lg text-center">
          ...
          <p className="mb-6 text-[1.05rem] leading-loose font-light text-[#F5F0E6]/70">
            And it begins with a quiet question:
          </p>
          <p className="mb-2 font-heading text-3xl font-black text-[#D4B96A] sm:text-4xl">
            Who gets paid when I wake up?
          </p>
          <p className="mt-6 font-mono text-sm font-bold tracking-[0.2em] text-[#F5F0E6] uppercase">
            Choose well.
          </p>
        </div>
        ...
        <div className="mx-auto mt-12 max-w-2xl border-t border-[#C5A23C]/15 pt-8">
          ...
          {[
            ...
            <p
              key={c}
              className="mb-1.5 text-[0.82rem] leading-relaxed font-light text-[#F5F0E6]/50"
            >
              {c}
            </p>
          ))}
      ...
      <section className="bg-linear-to-b from-[#FAFAF7] via-[#F0E8D8] to-[#F5F0E6] px-6 pt-12 pb-4">
        <div className="mx-auto max-w-md text-center">
          <p className="mb-2 font-mono text-xs tracking-[0.25em] text-[#C5A23C] uppercase">
            Stay Informed
          </p>
          <p className="mb-4 text-[#2C1810]">
            Get coffee intelligence, crusade updates, and new tool releases delivered weekly.
          </p>
            ...
            steps={[
              {
                ...
                path: "/brewsoul/prescription",
                description: "Get your personalized coffee analysis",
              },
              {
                label: "Compare Coffees",
                path: "/brewsoul/compare",
                description: "Side-by-side brand transparency",
              },
              {
                label: "Browse the Catalog",
                path: "/brewsoul/browse",
                description: "Explore every coffee we've reviewed",
              },
            ]}
          />
        </div>
