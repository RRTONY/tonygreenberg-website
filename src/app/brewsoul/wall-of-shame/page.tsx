...
export const metadata: Metadata = {
  ...
  description:
    "The coffee industry practices, brands, and myths that exploit farmers, mislead consumers, or perpetuate harm.",
        ...
        steps={[
          {
            ...
            description: "Find the good stuff",
          },
          {
            label: "Mold-Free Verified",
            path: "/brewsoul/mold-free",
            description: "Tested & clean",
          },
          {
            label: "Chain Rankings",
            path: "/brewsoul/chains",
            description: "Who's actually good?",
          },
        ]}
      />
    </section>
