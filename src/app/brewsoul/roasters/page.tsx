...
export const metadata: Metadata = {
  ...
  description:
    "Roasters profiled for sourcing transparently, roasting with intention, and paying farmers fairly.",
  ...
  return (
    <section className="mx-auto max-w-225 px-6 py-12">
      ...
      <p className="mb-8 max-w-2xl text-[0.95rem] leading-relaxed text-[#6B5B4F]">
        We profile the roasters that source transparently, roast with intention, and pay farmers
        fairly.
      </p>
      ...
      <NextSteps
        steps={[
          {
            label: "Browse Their Coffees",
            path: "/brewsoul/browse",
            description: "Taste their work",
          },
