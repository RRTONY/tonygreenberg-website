    ...
    <div className="min-h-screen overflow-x-hidden bg-linear-to-b from-[#1a1208] via-[#0f0d08] to-[#0a0806] text-amber-50">
      <section className="relative flex h-[50vh] min-h-100 items-end overflow-hidden">
        ...
        <div className="relative z-1 mx-auto w-full max-w-6xl px-6 pb-8">
          <Link
            href="/brewsoul/cities"
            className="mb-4 inline-block text-sm text-amber-400/60 hover:text-amber-400"
          >
            <BackIcon aria-hidden="true" /> All Cities
          </Link>
          <div className="flex items-end justify-between gap-4">
            <div>
              <div className="mb-2 flex items-center gap-3">
                <span className="rounded-full border border-amber-500/20 bg-amber-500/10 px-2 py-0.5 font-mono text-xs text-amber-500/70">
      ...
      <section className="px-6 pb-8">
        <div className="mx-auto max-w-6xl">
          <GlassCard className="p-6">
            <p className="text-center text-lg leading-relaxed text-amber-200/70 italic">
              &ldquo;{city.verdict}&rdquo;
            </p>
          </GlassCard>
        </div>
      </section>
          ...
          <div className="mx-auto max-w-6xl">
            <GlassCard className="p-12 text-center">
              ...
              <p className="mx-auto mb-6 max-w-lg text-amber-200/60">
                {city.name} is on our scoring schedule. City stats and metadata are live. Best 25,
                Worst 25, chain report cards, and bridge drinks are being compiled.
              </p>
              <Link
                href="/brewsoul/cities"
                className="inline-block rounded-xl bg-linear-to-r from-amber-600 to-amber-500 px-6 py-3 font-semibold text-white"
              >
                <BackIcon aria-hidden="true" /> Back to All Cities
              </Link>
            </GlassCard>
          </div>
        </section>
