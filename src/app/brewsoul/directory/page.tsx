...
export const metadata: Metadata = {
  ...
  description:
    "A curated directory of every page inside BrewSoul — specialty coffee intelligence, research, reference, and tools.",
  ...
  return (
    <div className="mx-auto max-w-225 px-6 pt-12 pb-20">
      <div className="mb-10 text-center">
        <div className="mb-3 font-mono text-xs tracking-[0.25em] text-[#C5A23C] uppercase">
          Complete Index
        </div>
        <h1 className="mb-4 font-heading text-[clamp(2rem,5vw,3rem)] leading-[1.15] font-bold text-[#2C1810]">
          Everything Inside BrewSoul
        </h1>
        <p className="mx-auto max-w-150 text-[1.1rem] leading-relaxed text-[#6B5B4F]">
          {BREWSOUL_TOTAL_PAGES} pages of coffee intelligence. Every page free.
        </p>
      </div>
      ...
      <div className="mt-8 rounded-xl border border-[#6F4E37]/10 bg-[#6F4E37]/4 p-8 text-center">
        <div className="mb-2 font-heading text-[1.3rem] font-bold text-[#2C1810]">
          Don&apos;t know where to start?
        </div>
        <p className="mb-5 text-[0.95rem] text-[#6B5B4F]">
          Take the 2-minute Taste Quiz and we&apos;ll point you to the pages that matter for your
          palate.
        </p>
        <div className="flex flex-wrap justify-center gap-4">
          <Link
            href="/brewsoul/quiz"
            className="rounded-md bg-[#6F4E37] px-6 py-3 font-mono text-[0.75rem] tracking-[0.15em] text-[#FAFAF7] uppercase"
          >
            Take the Quiz
          </Link>
          <Link
            href="/brewsoul/first-sip"
            className="rounded-md border border-[#6F4E37]/30 px-6 py-3 font-mono text-[0.75rem] tracking-[0.15em] text-[#6F4E37] uppercase"
          >
            Read The First Sip
          </Link>
        </div>
