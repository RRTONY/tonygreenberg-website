  ...
  return (
    <div>
      ...
      <section className="bg-linear-to-b from-[#F0E8D8] via-[#E8DCC8] to-[#F5F0E6] px-6 py-16 text-center">
        <div className="mb-4 font-mono text-xs tracking-[0.3em] text-[#8B2500] uppercase">The 2025 Crisis</div>
        <h2 className="mx-auto mb-6 max-w-lg font-heading text-2xl font-bold text-[#1A1A1A] sm:text-3xl">
          Arabica hit $4.41/lb.
          <br />
      ...
      <section className="bg-linear-to-b from-[#F5F0E6] to-[#FAFAF7] px-6 py-16">
        <div className="mx-auto max-w-2xl">
          <div className="mb-8 text-center">
            <div className="mb-2 font-mono text-xs tracking-[0.3em] text-[#8B2500] uppercase">Accountability</div>
          ...
          <div className="grid gap-4 [grid-template-columns:repeat(auto-fill,minmax(240px,1fr))]">
            {RESEARCH_CARDS.map((card) => (
              ...
              >
                ...
                <div className="mb-1.5 font-heading text-lg font-bold text-[#2C1810]">{card.title}</div>
