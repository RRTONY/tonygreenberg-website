...
const CATEGORY_CLASSES: Record<
  string,
  { text: string; iconBg: string; dashedBorder: string; dashedBg: string }
> = {
  mezcal: {
    text: "text-[#92400E]",
    iconBg: "bg-[#92400E]/15",
    dashedBorder: "border-[#92400E]/30",
    dashedBg: "bg-[#92400E]/5",
  },
  tequila: {
    text: "text-[#B45309]",
    iconBg: "bg-[#B45309]/15",
    dashedBorder: "border-[#B45309]/30",
    dashedBg: "bg-[#B45309]/5",
  },
  sake: {
    text: "text-[#4338CA]",
    iconBg: "bg-[#4338CA]/15",
    dashedBorder: "border-[#4338CA]/30",
    dashedBg: "bg-[#4338CA]/5",
  },
  coffee: {
    text: "text-[#78350F]",
    iconBg: "bg-[#78350F]/15",
    dashedBorder: "border-[#78350F]/30",
    dashedBg: "bg-[#78350F]/5",
  },
  wine: {
    text: "text-[#7F1D1D]",
    iconBg: "bg-[#7F1D1D]/15",
    dashedBorder: "border-[#7F1D1D]/30",
    dashedBg: "bg-[#7F1D1D]/5",
  },
};
...
const CATEGORIES: Category[] = [
  ...
  },
  {
    ...
    comingSoon:
      "KUCHIKAMI — a sake education site — is in development. The mouth that chews the gods.",
  },
  {
    id: "coffee",
    title: "Coffee",
    ...
    <div>
          ...
          >
            <div className="mx-auto max-w-3xl px-6 py-16 sm:px-10 md:py-20">
              <div className="mb-8 flex items-start gap-4">
                <div
                  className={`flex size-12 shrink-0 items-center justify-center rounded-xl ${c.iconBg}`}
                >
                  ...
                  >
                    <div className="mb-3 flex items-center justify-between">
                      <div className={`font-mono text-xs tracking-wide uppercase ${c.text}`}>
                        Explore the Site <ForwardIcon aria-hidden="true" />
                      </div>
                      <ArrowUpRight
                        size={16}
              ...
              {cat.digest && (
                <div className="mb-6 rounded-lg border border-border bg-card px-8 py-6">
                  ...
                  {cat.digest.items.map((item, di) => (
                    ...
                    >
                      <div
                        className={`mb-1 font-mono text-[0.65rem] tracking-wide uppercase ${c.text}`}
                      >
                        {item.tag}
                      </div>
              ...
              {cat.comingSoon && (
                <div
                  className={`mb-6 rounded-lg border border-dashed px-6 py-5 ${c.dashedBorder} ${c.dashedBg}`}
                >
      ...
      <section className="bg-[#0A0A10] px-6 py-20 text-center sm:px-10">
        <div className="mx-auto max-w-2xl">
          ...
          <p className="mx-auto mb-8 max-w-lg leading-relaxed text-white/60">
            ...
            touch at 3am. A winemaker who lets the grapes speak instead of the marketing department.
            The common thread isn&apos;t the liquid — it&apos;s the refusal to cut corners. Same
            principle that drives everything else I do.
          </p>
          <Link
            href="/the-letter"
      ...
      <div className="border-t border-border py-6 text-center">
        <Link href="/recent-creations" className="font-mono text-sm tracking-wide text-brand-gold">
          Continue to Recent Creations <ForwardIcon aria-hidden="true" />
        </Link>
      </div>
    </div>
  );
