      ...
      <section className="bg-card px-6 py-16">
        <div className="mx-auto max-w-5xl">
          ...
          <p className="mx-auto mt-8 max-w-2xl text-center text-sm text-muted-foreground italic">
            ...
            voluntary framing suggests a calculated exit — leaving on their own terms before
      ...
      <section className="px-6 py-16">
        <div className="mx-auto max-w-2xl">
          ...
          <p className="mb-5 leading-relaxed text-foreground/80">
            Peptide Sciences provided Certificates of Analysis. But theirs were internal —
            meaning the company tested its own products and handed you a document. There was no
            independent way to verify those results. It&apos;s like a restaurant grading its own
            health inspection.
          </p>
          <p className="mb-5 leading-relaxed text-foreground/80">
            A real COA comes from an accredited third-party lab — ISO/IEC 17025 certified — with
            a batch ID you can query directly on the lab&apos;s own public database, without the
            vendor in the loop at all.
          </p>
          <p className="mb-8 leading-relaxed text-foreground/80">
            The gold standard right now: <strong>Janoshik Analytical</strong> (janoshik.com).
            Every batch gets a unique reference ID. You go to their site, type in the ID, see the
            original unmodified lab results. No PDF that could be photoshopped. No
      ...
      <section className="bg-card px-6 py-16">
        <div className="mx-auto max-w-5xl">
          ...
          <p className="mt-6 text-xs leading-relaxed text-muted-foreground">
            ...
            community track records on r/Peptides and Eroids, FDA warning letter registry, and
            court records. No vendor paid for inclusion or ranking.
          </p>
        </div>
      </section>
        ...
        <div className="mx-auto max-w-2xl">
          <blockquote className="border-l-4 border-[#C84B2A] pl-6">
            <p className="mb-4 text-lg leading-relaxed italic">
              ...
              infrastructure is built on opacity instead of trust. A decade, $7M/month, and it
              ended with three sentences. Find My Peptides exists because the information layer
              should never be controlled by the same people selling you something.&quot;
            </p>
