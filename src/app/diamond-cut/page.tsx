    ...
    <div>
      ...
      <div className="mx-auto max-w-2xl px-6 py-14 sm:px-10">
        ...
        <p className="mb-4 leading-relaxed text-foreground/80">
          Tony is not a great CEO. He is a magnificent number two. A consigliere. The person who has
          guided top CXOs at Fortune 50 companies for 25 years — not by running the company, but by
          seeing what they cannot see from inside it.
        </p>
        <p className="mb-4 leading-relaxed text-foreground/80">
          ...
          specific skill. It is not coaching. It is not consulting. It is pattern recognition built
          on scar tissue from thousands of deals.
        </p>
