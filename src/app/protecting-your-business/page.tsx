...
const TIMELINE = [
  ...
  { date: "Apr 2026", event: "Subsequent employer contacted and warned.", badge: "Employer Warned", source: "Correspondence records" },
];
...
const COST_ROWS = [
  ...
  { label: "Legal fees (filing, correspondence, collections)", amount: "$5,000–$15,000", color: "text-amber-700" },
  { label: "Platform dispute resolution time", amount: "40+ hours", color: "text-amber-700" },
  { label: "Credit disruption (Amex relationship impact)", amount: "Unquantifiable", color: "text-muted-foreground" },
  { label: "Management distraction and emotional cost", amount: "Unquantifiable", color: "text-muted-foreground" },
  { label: "Opportunity cost of diverted attention", amount: "Unquantifiable", color: "text-muted-foreground" },
];
...
const REMOVAL_STEPS = [
  { title: "Full Financial Restitution With Interest", text: "Pay the remaining $26,795 plus contractual interest at 1.5% per month from November 2025 through the date of payment. As of April 2026, the total exceeds $28,800. Wire transfer or cashier's check only. No payment plans. No installments. No promises. Money in the account, verified and cleared." },
  { title: "Teach a University Course on Embezzlement", text: "Develop and deliver a semester-length course at an accredited university on the mechanics of workplace embezzlement, contractor fraud, and financial manipulation. Proof of completion required — syllabus, university confirmation, and student evaluations." },
  { title: "Write and Publish a Personal Account", text: "Write a minimum 5,000-word article — published under her real name on a credible platform — detailing her path into financial crime, the specific decisions she made, the rationalizations she used, and what she has learned. Not a PR rehabilitation piece. A genuine, unflinching accounting." },
  { title: "Complete 200 Hours of Verified Community Service", text: "Serve 200 hours with a verified nonprofit focused on financial literacy or fraud prevention. ACFE, local Legal Aid societies, or Small Business Development Centers qualify. Hours must be documented and verified by the organization." },
  { title: "Formal Written Apology to Every Affected Party", text: "Write individual, specific apologies to every person and organization affected — not a form letter. Each must acknowledge the specific harm and take full responsibility without deflection, without invoking hardship, and without the word \"but.\"" },
  { title: "Complete a Certified Ethics Program", text: "Enroll in and complete a nationally recognized ethics certification — such as the CCEP through the Society of Corporate Compliance and Ethics. Provide proof of certification." },
  { title: "Undergo a Forensic Psychological Evaluation", text: "Complete a forensic psychological evaluation by a licensed professional specializing in financial crime behavior. Share the results with affected parties as evidence of genuine self-examination. This is not punishment. This is the beginning of understanding." },
  { title: "Mentor Three Small Business Owners on Fraud Prevention", text: "Volunteer as a mentor to three small business owners through SCORE or similar, specifically teaching them how to protect themselves from the exact tactics she used. Each mentorship must last minimum six months with documented sessions." },
];
...
function QuoteBlock({ quote, attribution }: { quote: string; attribution: string }) {
  return (
    <div className="my-6 rounded-md border border-amber-700/25 border-l-4 border-l-amber-700 bg-amber-700/5 p-7">
      ...
      <div className="font-mono text-xs tracking-wide text-amber-800 uppercase">— {attribution}</div>
    </div>
  );
}
...
function Badge({ children, variant = "red" }: { children: React.ReactNode; variant?: "red" | "amber" }) {
  return (
    <span
              ...
              <div className="grid grid-cols-2 gap-4">
                {[
                  ...
                  <div key={f.label}>
                    ...
                    <div className={`font-heading text-lg font-bold ${f.highlight ? "text-red-800" : "text-foreground"}`}>
                      {f.value}
                    </div>
                    <div className="font-mono text-[0.55rem] text-muted-foreground">Source: {f.source}</div>
                  </div>
                ))}
              </div>
            </div>
      ...
      <div className="mx-auto max-w-2xl px-6 pb-16 sm:px-10">
        <div className="mb-10 rounded-md border border-amber-700/25 bg-amber-700/5 p-7">
          ...
          <div className="text-lg leading-relaxed font-medium text-amber-950 dark:text-amber-200">
            I got taken. Twenty-five years in enterprise technology, $10 billion benchmarked, and
            a woman with two theft convictions walked through my door and I handed her the keys.
            The duty to warn you is bigger than my ego. If I stay quiet, the next victim is on me.
          </div>
        </div>
        ...
        <Section id="case" num="01" title="The Case Against Kristi Klawiter">
          <P>
            ...
            references that checked out on the surface. She was good at this. That is, after
            all, what convicted forgers do.
          </P>
          <P>
            Over five months she submitted <strong className="text-red-800">11 unauthorized
            invoices</strong> totaling <strong className="text-red-800">$46,795</strong>, each
            structured below approval thresholds and timed to periods of high activity.
            <Cite>Braintrust payment records</Cite> This was not impulsive. This was
            architecture.
          </P>
          <P>
            Confronted with the evidence, she returned <strong className="text-foreground">
            $20,000</strong>
            ...
            defaulted. The promissory note, it turned out, was just another forgery — of good
            faith.
          </P>
          <P>
            <strong className="text-foreground">What a courthouse search would have
            revealed:</strong> prior guilty pleas for theft and forgery in New Jersey — Monmouth
            County 17-005347 and Morris County 16-002436. Three years probation. Court-ordered
            restitution at $300 per month.<Cite>NJ court records</Cite> She never disclosed them.
            I never found them. That is the $75 background check I did not run.
          </P>
          <OpinionBox>
          ...
          <div className="relative border-l-2 border-red-800/30 pl-6">
            {TIMELINE.map((item) => (
              <div key={item.date} className="relative mb-7">
                ...
                <p className="font-mono text-[0.65rem] text-muted-foreground">Source: {item.source}</p>
              </div>
            ))}
          </div>
        </Section>
        ...
        <Section id="manipulation" num="03" title="The Playbook: What She Did When She Got Caught">
          <P>
            Every business owner who catches a thief will face the same script. Knowing the
            playbook in advance is worth more than any background check. The following tactics
            are documented in emails, text messages, and recorded conversations.
          ...
          <NumberedItem num={2} title="Mental Illness as a Shield">
            Klawiter claimed mental health struggles not as genuine vulnerability but as a
            tactical shield.<Cite>Text messages</Cite> The message: &quot;if you hold me
            accountable, you are punishing someone who is mentally ill.&quot; The emotional
            equivalent of a human shield.
          </NumberedItem>
          <QuoteBlock
          ...
          <NumberedItem num={3} title="Self-Harm Threats as Leverage">
            ...
            contact emergency services (988 Suicide &amp; Crisis Lifeline) and continue your
            legal process. You are not a therapist. You are a fraud victim. Those are different
            jobs.
          </NumberedItem>
          <NumberedItem num={4} title="The Perpetual Payment Promise">
            &quot;I&apos;ll have a plan within 48 hours.&quot; &quot;The money was sent to the
            wrong account.&quot; &quot;I&apos;m working on it.&quot;
            <Cite>Email correspondence, Nov 2025–Apr 2026</Cite> The promissory note she signed
            was itself a tactic: the appearance of good faith from someone with no intention of
            honoring it. Not once. Not partially. Not ever.
          </NumberedItem>
          <NumberedItem num={5} title="Performed Remorse Without Restitution">
            ...
            arrives with a cashier&apos;s check. Performed remorse arrives with tears and a
            request for more time.
          </NumberedItem>
          <NumberedItem num={6} title="Identity Obfuscation Across Platforms">
            Kris Management, LLC in Florida. Criminal records in New Jersey. Profiles on
            Braintrust, Upwork, LinkedIn, and 9am.works — each with a slightly different
            professional history.<Cite>Platform profile records</Cite> Deliberate obfuscation, in
            my opinion, designed to prevent employers from connecting the dots. It worked on me.
          </NumberedItem>
          <AlertBox>
        ...
        <Section id="red-flags" num="04" title="10 Ways to Spot a Thief Before They Spot Your Checkbook">
          <P>
            Every one of these appeared in this case. Field notes from a man who missed all ten.
            If you see three or more, stop everything and audit immediately.
          </P>
        ...
        <Section id="damage" num="05" title="The Real Cost: It Is Never Just the Money">
          <P>
            $46,795 is the headline number. The real cost includes everything that breaks
            downstream when someone detonates a fraud bomb inside your business.
          </P>
          ...
          <OpinionBox>
            The money is recoverable in theory. The six months of distraction, the erosion of
            trust in your own judgment, the conversations you did not have because you were
        ...
        <Section id="background-checks" num="06" title="The $75 Background Check I Did Not Run">
          <P>
            Standard background checks search databases, not courthouses. Many courts —
            especially in New Jersey, where Klawiter&apos;s convictions were filed — do not
            report automatically.<Cite>Industry documentation</Cite> The database said she was
            fine. The courthouse said she was not.
          </P>
          <div className="my-6 rounded-md border border-border bg-card p-6">
          ...
          <AlertBox>
            <strong>The arithmetic:</strong> Cost of a thorough background check: $75 to $200.
              ...
              <thead>
                <tr className="bg-red-800/5">
                  {["Service", "Price", "Court Records", "Best For"].map((h) => (
                    <th key={h} className="px-4 py-3 text-left font-mono text-xs tracking-wide text-red-800 uppercase">
                      {h}
                    </th>
                  ))}
                </tr>
              ...
              <tbody>
                {BG_CHECK_SERVICES.map((row) => (
                  <tr key={row[0]} className="border-t border-border">
                    {row.map((cell, j) => (
                      <td key={cell} className={`px-4 py-2.5 text-foreground/80 ${j === 0 ? "font-semibold text-foreground" : ""}`}>
                        {cell}
                      </td>
                    ))}
                  </tr>
        ...
        <Section id="protection" num="07" title="The 12-Point Checklist I Built After Getting Robbed">
        ...
        <Section id="tools" num="08" title="Prevention Tools vs. the Cost of Trusting the Wrong Person">
          ...
          <div className="rounded-md border border-border bg-card p-6 text-center">
            ...
            <div className="font-heading text-lg text-foreground">
              Annual cost of every prevention tool: <strong className="text-green-700">~$3,600</strong>
            </div>
        ...
        <Section id="reporting" num="09" title="Where to Report Fraud">
          <P>
            File everywhere. No single agency will solve it — but the cumulative paper trail
            makes it impossible for the next employer to miss.
          </P>
          {REPORTING.map((item) => (
            <div key={item.name} className="border-b border-border py-3 last:border-b-0">
              <div className="mb-1 font-heading text-base font-bold text-foreground">
                {item.url ? (
                  <a href={item.url} target="_blank" rel="noopener noreferrer" className="underline decoration-red-800 underline-offset-2">
                    {item.name}
                  </a>
                ) : (
                  item.name
        ...
        <Section id="why-this-exists" num="10" title="Why I Published This (And Why It Was Hard)">
          <P>
            My first instinct was to absorb the loss quietly. That is what most business owners
            do. But the next company that hires Kristi Klawiter without knowing her history will
            lose money too. And they will ask: <strong className="text-foreground">did anyone
            know? Did anyone try to warn us?</strong>
          </P>
          <AlertBox>
            You are complicit if you do not take people to the mat. As a business owner. As a
            human. As everything. Karma-wise, you are allowing others to get hurt. I am a
            protector by nature. You can be too.
          </AlertBox>
          <P>
            <strong className="text-foreground">RampRate is a Certified B Corporation</strong>.
            <Cite>B Lab certification</Cite> In 25 years, we have <strong className="text-foreground">
            never sued anyone and never been sued</strong>. This article is not litigation — it
            is documentation.
          </P>
          <OpinionBox>
        ...
        <Section id="path-to-removal" num="11" title="Path to Removal: How Kristi Klawiter Can Get This Taken Down">
          <P>
            This article is permanent by default. Klawiter has the power to get it removed
            entirely. Redemption requires action, not promises. Every step below must be
        ...
        <div className="mt-8 rounded-md border border-border bg-card p-7">
          ...
          <p className="leading-[1.85] text-foreground/80">
            ...
            spend. When someone steals from you, you document everything and turn it into
            something useful. This is that document.
          </p>
        </div>
        ...
        <div className="mt-6 rounded-md border border-border bg-card p-6">
          ...
          <div className="space-y-3 text-sm leading-[1.85] text-muted-foreground">
            <p>
              <strong className="text-foreground/80">Factual basis:</strong> Every factual claim
              in this article is drawn from specific, identified sources: invoices and payment
              records from the Braintrust platform, a signed promissory note dated November 2025,
              New Jersey court records (Monmouth County case 17-005347 and Morris County case
              16-002436), an FBI Internet Crime Complaint Center (IC3) filing, a Santa Monica
              Police Department report, bank transfer records, and direct email and text
              correspondence.
            </p>
            <p>
              ...
              &quot;Author&apos;s Opinion&quot; callout boxes. All other statements are presented
              as documented facts with source citations.
            </p>
            <p>
              <strong className="text-foreground/80">Privacy:</strong> No private identifying
              information (Social Security number, date of birth, home address) is published.
              All information presented is drawn from public court records, business filings,
              publicly available platform profiles, or direct correspondence with the author.
            </p>
            <p>
              ...
              convictions. It is published in good faith for the purpose of consumer protection
              and public awareness.
            </p>
            <p>
              <strong className="text-foreground/80">Not legal advice:</strong> This article is
              informational and educational. It does not constitute legal advice. Consult a
