...
export const metadata: Metadata = {
  ...
  description: "A 15-question assessment mapping your coffee archetype across 6 dimensions — roast, origin, ritual, social context, caffeine, and flavor complexity.",
