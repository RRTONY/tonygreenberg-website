...
import { ImpactFuturismExplorer, type FuturismPost } from "@/components/blog/impact-futurism-explorer";
...
export default async function ImpactFuturismPage() {
  const posts = await sanityFetch<FuturismPost[]>({ query: allPostsForArchiveQuery, tags: ["post"] });
