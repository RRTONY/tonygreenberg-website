    ...
    <div>
      ...
      <div className="mx-auto max-w-2xl px-6 py-12">
        ...
        <p className="mb-4 leading-relaxed text-foreground/80">
          The Ecosystem is a curated network of builders, investors, and thought leaders working at
          the intersection of consciousness-aligned capital, regenerative economics, and systems
          change.
        </p>
        <p className="leading-relaxed text-foreground/80">
          This isn&apos;t a community — it&apos;s a collaboration engine. Members share deal flow,
          co-create ventures, and leverage collective expertise to accelerate projects that matter.
        </p>
      </div>
      ...
      <div className="border-t border-border py-6 text-center">
        <Link href="/find-my" className="font-mono text-sm tracking-wide text-brand-gold">
          Explore the Assessments <ForwardIcon aria-hidden="true" />
        </Link>
      </div>
    </div>
  );
