  ...
  return (
    <div className="mx-auto max-w-3xl px-6 py-10">
      ...
      <p className="mb-4 text-foreground/80">
        Four payment processing companies through what we call &quot;the corridor&quot; — a payments
        infrastructure play at the intersection of traditional card processing, stablecoin
      ...
      <blockquote className="mb-10 text-center font-heading text-xl italic text-foreground">
        The future of payments isn&apos;t crypto OR traditional rails. It&apos;s the bridge between
        them. We&apos;re not betting on one side — we&apos;re building the infrastructure that makes
      ...
      <div className="mb-10 rounded-r-md border-l-4 border-brand-gold bg-brand-gold/5 p-6">
        ...
        <p className="leading-relaxed text-foreground/80">
          ...
          decade of finance aren&apos;t building consumer apps — they&apos;re building the plumbing
          that every consumer app will eventually depend on.
        </p>
      </div>

      <div className="border-t border-border py-6 text-center">
        <Link href="/the-body" className="font-mono text-sm tracking-wide text-brand-gold">
          Continue to The Body <ForwardIcon aria-hidden="true" />
        </Link>
      </div>
    </div>
  );
