...
import {
  ...
  CRUSADE_ARTICLES,
  TRUST_ARTICLES,
} from "@/lib/content/attention-theft";
...
const IMG = {
  ...
  sacred:
    "https://d2xsxph8kpxj0f.cloudfront.net/310519663242884547/gXhndHxpF4hLjcgkrqbdCP/manifesto-glamour-sacred-QNMeMG2mvDZqqvgSUsVrLM.webp",
  weapons:
    "https://d2xsxph8kpxj0f.cloudfront.net/310519663242884547/gXhndHxpF4hLjcgkrqbdCP/manifesto-glamour-weapons_82cdd78e.jpg",
  legal:
    "https://d2xsxph8kpxj0f.cloudfront.net/310519663242884547/gXhndHxpF4hLjcgkrqbdCP/manifesto-glamour-legal_e83b2084.jpg",
  blocker:
    "https://d2xsxph8kpxj0f.cloudfront.net/310519663242884547/gXhndHxpF4hLjcgkrqbdCP/manifesto-glamour-blocker-jHEBDsmZ33rTwcjbakiiKi.webp",
  report:
    "https://d2xsxph8kpxj0f.cloudfront.net/310519663242884547/gXhndHxpF4hLjcgkrqbdCP/manifesto-glamour-report_7aea41eb.jpg",
};

export const metadata: Metadata = {
  title: "Attention Theft — The Manifesto",
  description:
    "The case against attention theft: why your inbox is a crime scene and what to do about it.",
  ...
  return (
    <div className={`relative overflow-hidden ${className}`}>
      <Image
        ...
        fill
        sizes="100vw"
        className="object-cover brightness-[0.8] saturate-[1.3] contrast-[1.1]"
      />
    ...
    <div>
      ...
      <section className="relative overflow-hidden">
        <div className="absolute inset-0">
          <Image
            ...
            sizes="100vw"
            priority
            className="object-cover brightness-[0.85] saturate-[1.2] contrast-[1.05]"
          />
          ...
          <div className="inline-block rounded-2xl border border-white/50 bg-white/75 px-8 py-8 shadow-[0_8px_40px_rgba(0,0,0,0.1)] backdrop-blur-xl md:px-10 md:py-10">
            ...
            <div className="mb-6 max-w-3xl rounded-xl border border-crusade-red/15 bg-white/80 px-6 py-5 shadow-[0_4px_24px_rgba(200,22,26,0.08)] backdrop-blur-xl">
              <p className="text-base leading-[1.8] text-crusade-ink md:text-lg">
                This is not a rant. This is a <strong className="text-crusade-red">crusade</strong>.
                Email is the church of modern commerce — the infrastructure that enables human
                abundance to flow. Spammers are committing heresy against it. We don&apos;t just
                complain. We organize. We build weapons. We collapse their economics.{" "}
                <strong className="text-crusade-crimson">We win.</strong>
              </p>
            </div>
      ...
      <section className="bg-crusade-warm-white px-5 py-20 md:py-28">
        <div className="mx-auto max-w-5xl">
          ...
          <SectionIntro>
            Before we talk about the war, let&apos;s be clear about what we&apos;re protecting.
            Email isn&apos;t just a tool. It&apos;s one of the most profound inventions in human
            history.
          </SectionIntro>
          ...
          <div className="mt-10 grid gap-5 md:grid-cols-3">
            {[
              {
                Icon: Shield,
                title: "The Church of Commerce",
                text: "The sacred space where trust is built, deals are made, relationships are formed, and human abundance flows between strangers who become partners.",
                colorClass: "text-brand-gold",
              },
              {
                Icon: Sprout,
                title: "The Garden of Opportunity",
                text: "Where job offers arrive. Where clients say yes. Where old friends reconnect. Where mentors share wisdom. Where lives change direction.",
                colorClass: "text-crusade-teal",
              },
              {
                Icon: Handshake,
                title: "The Portal to Abundance",
                text: "Every legitimate email represents someone choosing to invest their attention in another person — an act of trust and genuine human connection.",
                colorClass: "text-crusade-ember",
              },
            ].map((card) => (
          ...
          <GlassCard variant="teal" className="mt-12">
            <div className="grid items-center gap-8 md:grid-cols-[auto_1fr]">
              ...
              <div>
                <h3 className="mb-3 font-heading text-2xl font-bold text-crusade-teal">
                  The Great Equalizer
                </h3>
                <p className="mb-3 text-base leading-[1.8] text-crusade-muted">
                  A person in a village in India can reach a CEO in New York — instantly, for free,
                  with no gatekeeper. A startup founder can pitch a hundred investors in a day.
                </p>
                <p className="text-base leading-[1.8] text-crusade-brown">
                  Before email, communication at scale required money. Email made reach infinite and
                  cost zero.{" "}
                  <strong className="text-crusade-teal">
                    The kid with an idea had the same inbox as the billionaire.
                  </strong>
                </p>
              </div>
            </div>
          ...
          <PullQuote>
            &ldquo;Email democratized access. It&apos;s the infrastructure that lets strangers
            become partners, ideas become companies, and individuals become movements.&rdquo;
          </PullQuote>
        </div>
      </section>
      ...
      <section
        id="heresy"
        className="bg-linear-to-b from-crusade-sand via-crusade-red/4 to-crusade-sand px-5 py-20 md:py-28"
      >
        <div className="mx-auto max-w-5xl">
          <SectionLabel>The Heresy</SectionLabel>
          <SectionTitle className="text-crusade-red">
            What They&apos;re Doing To Our Cathedral
          </SectionTitle>
          <SectionIntro>
            Every morning I wake up to an inbox that has been violated. Not by colleagues. Not by
            partners. By strangers who decided their need to sell is more important than my need to
            think, to work, to live.
          </SectionIntro>

          <div className="mt-10 grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
            <StatCard
              number="$997B"
              label="Annual Economic Theft"
              source="Basex Research, inflation-adjusted"
            />
            <StatCard
              number="23 min"
              label="Recovery Per Interruption"
              source="UC Irvine, Dr. Gloria Mark"
            />
            <StatCard
              number="65+ hrs"
              label="Daily Productivity Destroyed"
              source="170 spam × 23 min recovery"
            />
            <StatCard
              number="45-85%"
          ...
          <PullQuote>
            &ldquo;AI didn&apos;t just give spammers a bigger megaphone. It gave them an
            industrial-scale desecration machine pointed directly at our sacred space.&rdquo;
          </PullQuote>
            ...
            <div className="flex items-start gap-4">
              ...
              <div>
                <p className="mb-4 text-lg leading-[1.8] text-crusade-ink">
                  Before AI, a spammer could send maybe 500 personalized emails a day. With AI, a
                  single bad actor can generate{" "}
                  <strong className="text-crusade-red">
                    10,000+ unique, personalized spam messages per hour
                  </strong>{" "}
              ...
              <table className="w-full min-w-160 text-left">
                <thead>
                  <tr className="bg-crusade-red/8">
                    <th className="px-5 py-3 font-heading text-sm font-bold text-crusade-ink">
                      Metric
                    </th>
                    <th className="px-5 py-3 text-right font-heading text-sm font-bold text-crusade-ink">
                      Value
                    </th>
                    ...
                    >
                      <td className="px-5 py-3 text-base leading-relaxed text-crusade-brown">
                        {row.highlight && (
                          <AlertTriangle
                            size={14}
                            className="-mt-0.5 mr-2 inline text-crusade-red"
                          />
                        )}
                        {row.metric}
                      </td>
                      <td
                        className={`px-5 py-3 text-right font-heading text-lg font-bold whitespace-nowrap ${row.highlight ? "text-crusade-red" : "text-crusade-ink"}`}
                      >
                        {row.value}
                      </td>
                ...
                <li key={s.text} className="flex items-start gap-2">
                  ...
                  {s.url ? (
                    <a
                      ...
                      className="text-sm leading-relaxed text-crusade-muted hover:underline"
                    >
                      {s.text}
                    </a>
                  ) : (
      ...
      <section id="weapons" className="bg-background px-5 py-20 md:py-28">
        <div className="mx-auto max-w-5xl">
          ...
          <SectionIntro>
            You don&apos;t need to do all ten. But every weapon you deploy makes the economics of
            spam worse for the attacker and better for you. Pick three. Start today.
          </SectionIntro>
                ...
                <div className="relative z-10 flex items-start gap-4">
                  <div
                    className={`flex size-14 shrink-0 items-center justify-center rounded-xl border ${
                      idx < 3
                        ? "border-crusade-red/20 bg-crusade-red/12"
                        : "border-black/6 bg-black/3"
                    }`}
                  >
                    <Flame
                      size={26}
                      className={idx < 3 ? "text-crusade-red" : "text-crusade-ink"}
                    />
                  </div>
                  <div className="flex-1">
                    <span
                      className={`rounded-full px-2.5 py-1 text-[10px] font-bold tracking-wider uppercase ${
                        idx < 3
                          ? "border border-crusade-red/15 bg-crusade-red/10 text-crusade-red"
                          : "border border-black/6 bg-black/3 text-crusade-muted"
                      }`}
                    >
                      Weapon {w.num}
                    </span>
                    <h3 className="mt-2 mb-0.5 font-heading text-xl font-bold text-crusade-ink">
                      {w.title}
                    </h3>
          ...
          <PullQuote>
            &ldquo;You don&apos;t have to win the war in a day. You just have to make their
            economics worse every day until the system collapses.&rdquo;
          </PullQuote>
        </div>
      </section>
      ...
      <section id="legal" className="bg-crusade-warm-white px-5 py-20 md:py-28">
        <div className="mx-auto max-w-5xl">
          ...
          <SectionIntro>
            The laws that exist, the laws we need, and how to demand them. The legal infrastructure
            of attention protection is decades behind the technology of attention theft.
          </SectionIntro>
          <LegalArsenal />
        </div>
      </section>
      ...
      <section id="report" className="bg-background px-5 py-20 md:py-28">
        <div className="mx-auto max-w-3xl">
          ...
          <SectionIntro>
            Spammers count on anonymity. A public accountability database is on the roadmap — for
            now, every report goes straight to Tony, reviewed by hand.
          </SectionIntro>
          <div className="mt-10">
            <ReportSpammerForm />
          </div>
        ...
        <div className="mx-auto max-w-4xl">
          ...
          <GlassCard className="mx-auto mb-12 max-w-2xl text-left">
            {[
              ...
              <p
                key={vow}
                className="mb-3 flex items-start gap-3 font-heading text-lg leading-[1.7] text-crusade-ink last:mb-0"
              >
          ...
          <PullQuote>
            &ldquo;Every report makes the economics of spam worse for the attacker. You are the
            enforcement mechanism the law forgot to build.&rdquo;
          </PullQuote>
        </div>
      </section>
    </div>
