...
const HAWKINS_LEVELS = [
  {
    ...
    range: "200-249",
    color: "#C75B12",
    desc: "Taking action despite uncertainty",
  },
  {
    label: "Neutrality",
    range: "250-299",
    color: "#8B6914",
    desc: "Flexible, pragmatic, adaptable",
  },
  {
    label: "Willingness",
    range: "300-349",
    color: "#1565C0",
    desc: "Open, optimistic, growth-oriented",
  },
  {
    label: "Acceptance",
    range: "350-399",
    color: "#2E7D32",
    desc: "Transformative, purpose-driven",
  },
  {
    label: "Enlightened",
    range: "400+",
    color: "#7B2D8E",
    desc: "Visionary, regenerative, transcendent",
  },
];
  ...
  return (
    <div>
      <div className="bg-linear-to-b from-background to-secondary px-6 pt-16 pb-12 sm:px-10">
        <Link
          href="/"
          className="mb-6 inline-block font-mono text-xs tracking-wide text-brand-gold uppercase"
        >
          <BackIcon aria-hidden="true" /> Back to The Broadsheet
        </Link>
        <h1 className="mb-4 font-heading text-4xl font-bold text-foreground sm:text-5xl">
          The Rolodex
        </h1>
        <p className="max-w-xl text-lg text-foreground/70">
          {CLIENTS.length} companies across 25 years. Every engagement measured, every relationship
          maintained. This is who trusts RampRate with their infrastructure.
        </p>
      </div>
      ...
      <div className="border-t border-border px-6 py-12 sm:px-10">
        <div className="mx-auto max-w-3xl">
          ...
          <p className="mb-8 leading-relaxed text-foreground/70">
            Dr. David Hawkins&apos; Map of Consciousness calibrates organizations on a logarithmic
            scale from 1 to 1,000. Scores above 200 indicate constructive energy. Above 350
            indicates acceptance and integration. Above 400 indicates reason and enlightened
            purpose. These scores reflect our assessment of each organization&apos;s alignment with
            regenerative, conscious business practices.
          </p>
          <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
            {HAWKINS_LEVELS.map((level) => (
              <div
                key={level.label}
                className="p-4"
                style={{ borderLeft: `3px solid ${level.color}`, background: `${level.color}0d` }}
              >
                <p
