...
const NUMBERED_PRACTICES = [
  {
    num: "1",
    title: "Choose satisficing over maximizing.",
    body: "Set clear criteria for \"good enough.\" Once met, stop searching. The maximizer's pursuit is a trap algorithms exploit. The satisficer's contentment is a fortress they cannot breach.",
  },
  {
    num: "2",
    title: "Embrace voluntary simplification.",
    body: "Reduce complexity by choice before circumstances compel it. This is not deprivation but liberation. Own fewer things. Maintain fewer accounts. Cultivate fewer but deeper relationships.",
  },
  {
    num: "3",
    title: "Build at human scale.",
    body: "Robin Dunbar discovered humans can maintain approximately 150 stable relationships. Invest in these Dunbar-scale communities — your 15-50 deep bonds, your 5 inner circle. These sustain you when large systems fail.",
  },
  {
    num: "4",
    title: "Redefine abundance.",
    body: 'True abundance is not accumulation; it is alignment. When resources flow toward your conscious intentions, scarcity dissolves. Shift from "Do I have enough?" to "Am I contributing enough?"',
  },
  {
    num: "5",
    title: "Let the titans compete.",
    body: "Large corporations, governments, and AI systems will compete for dominance. You don't need to participate. Turn inward. Build community. Create meaning. Redirect attention to what you can actually affect.",
  },
  {
    num: "6",
    title: "Love more, need less.",
    body: "The ultimate hedge against AI dominance and civilizational stress is genuine human love, presence, and connection. These require no external energy, scale poorly (which is their strength), and constitute the irreducible core of flourishing.",
  },
];

const STEPS = [
  {
    label: "On your information diet",
    text: "Limit news to one focused session daily. Eliminate notifications except direct messages from people you know.",
  },
  {
    label: "On your finances",
    text: "Maintain 6-12 months liquidity. Avoid debt that creates dependency. Invest in resilience — skills, relationships, community.",
  },
  {
    label: "On your relationships",
    text: "Quality over quantity. Depth over breadth. Difficult conversations now, boundary-setting now, repair work now.",
  },
  {
    label: "On your mind",
    text: "Invest in practices that restore your nervous system: meditation, nature, exercise, connection, sleep. These are not luxuries. They are infrastructure.",
  },
];
...
const ECOSYSTEM_MAP = [
  {
    ...
    proof:
      "The QPR Index scores intellectual rigor across 91 essays. The Flow Circuit maps team performance. Human OS V2.0 diagnoses decision-making patterns. The Gem Spark maps serendipity.",
    links: [{ label: "Human OS", href: "/humanos" }],
  },
  {
    principle: "Optimize the Vessel",
    proof:
      "The Regenerative Protocol tracks biological optimization. SoulSmoke and LiquidSun honor what enters the body. Sacred Waters maps the molecule that remembers.",
    links: [{ label: "The Liquid Library", href: "/spirits" }],
  },
  {
    principle: "Shrink the Footprint",
    proof:
      "The Dairy Tax calculated the true carbon cost of cheese. ImpactSoul tokenizes assets for ocean cleanup. FusionRamp/STRATUM bridges Web3 to enterprise reality.",
    links: [
      {
        label: "Dairy Tax Essay",
        href: "/blog/the-butchers-daughter-the-carbon-toll-and-the-cheese-that-ate-the-planet",
      },
  ...
  },
  {
    ...
    proof:
      "The Intimacy Assessment maps your relationship intelligence. The Relationship Circuit threads four essays on love. The community invites you to find your tribe.",
    links: [
      { label: "Journeys", href: "/journeys" },
      { label: "Community", href: "/community" },
      {
        label: "Love as Dharma",
  ...
  },
  {
    ...
    proof:
      "Homeaglow Exposed holds corporations accountable. Vancefolio enforces portfolio intelligence. Every essay is scored, rated, and open to reaction.",
    links: [
  ...
  },
  {
    ...
    proof:
      "This page. The Life Assessment below. Find Your Journey maps your path. The community you build here becomes the infrastructure for what comes next.",
    links: [
      { label: "Community", href: "/community" },
    ...
    <div>
      <div className="bg-linear-to-b from-background to-secondary px-6 py-24 text-center sm:px-10 dark:from-[#0A0A10] dark:to-background">
        ...
        <p className="mx-auto max-w-xl text-lg text-foreground/70">
          We&apos;re going to measure how fast people can become their best self — and connect them
          to the biochemistry, the community, and the accountability infrastructure that makes it
          possible. The most abundant life. The lowest carbon footprint. A better humanity for the
          future.
        </p>
      </div>
      ...
      <div className="article-body mx-auto max-w-2xl px-6 py-14 leading-[1.9] sm:px-10 [&>p]:mb-4">
        ...
        <p>
          This Living Declaration is the answer. Not a final answer — a living one. It will change
          as you change it. Because the most important thing I&apos;ve learned in twenty-five years
          of building is this: the best architecture is the one your community finishes for you.
        </p>
      </div>
      ...
      <div className="article-body mx-auto max-w-2xl px-6 py-14 leading-[1.9] sm:px-10 [&>p]:mb-4">
        ...
        <p>
          ...
          <strong>Ray Kurzweil</strong> to celebrate human potential and ingenuity. Yet even in that
          heady age of tech optimism — on the eve of Arab Spring when social media was undermining
        ...
        <p>
          ...
          product for an additional dollar — and how the process could be so slow and imperceptible
          that we would fail to notice it like a frog slowly being boiled alive. Few listened. The
          congregation was drunk on possibility.
        </p>
        <p>
          ...
          that we needed technology built to fit humans &quot;like a glove instead of a cast.&quot;
          The thesis has only become more urgent.
        </p>
        <p>
          Today we both can claim the mantle of prophecy. In the last five years, we&apos;ve made as
          big a leap as any since splitting the atom. Yet the value of this change to humanity is
          just as ambiguous as the nuclear age. With superhuman intelligence at our fingertips, we
          haven&apos;t become supermen. We&apos;ve become shallower, more anxious, and less capable.
        </p>
        <div className="my-8 text-center">
          ...
          >
            Read the Original &quot;Boiling the Human&quot; Essay <ForwardIcon aria-hidden="true" />
          </Link>
        </div>
        ...
        <p>
          ...
          direction become more relevant every day. They&apos;ve reached hundreds of millions with
          their message. The world is finally listening.
        </p>
      </div>
      ...
      <div className="article-body mx-auto max-w-2xl px-6 py-14 leading-[1.9] sm:px-10 [&>p]:mb-4">
        ...
        <p>
          Yet I did not write this to add to the chorus of doom. Fear is not just a poor foundation
          for flourishing — it&apos;s a surrender to the very forces you think you&apos;re fighting.
          The attention economy profits from your anxiety. Don&apos;t let them.
        </p>
        <p>
        ...
        <p>
          ...
          moderation, community, presence, contentment. The Stoics knew this two thousand years ago.
          The Buddhists knew it five hundred years before that. This convergence reflects invariant
        ...
        <p>
          ...
          (who stop at &quot;good enough&quot;). The finding was counterintuitive: satisficers are
          happier.
        </p>
      </div>
      ...
      <div className="mx-auto max-w-2xl px-6 py-14 sm:px-10">
        ...
        <div className="mt-8 border-t border-border pt-8">
          ...
          <p className="leading-relaxed text-foreground/80">
            ...
            blossoming. Maximize your closest relationships. Satisfice on secondary decisions that
            drain bandwidth without adding meaning.
          </p>
        </div>
      ...
      <div className="article-body mx-auto max-w-2xl px-6 py-14 leading-[1.9] sm:px-10 [&>p]:mb-4">
        ...
        <p>
          ...
          assisting others, find your own serenity first. Then join me in designing systems-breakers
          to help us find ourselves again.
        </p>
        <p>
          When I build{" "}
          <a
        ...
        <p>
          ...
          He&apos;s building a startup society prototype near Singapore, arguing technology should
          &quot;reduce the barrier to exit&quot; by giving people alternatives to broken systems.
          But we converge on a crucial point: a startup society must be &quot;about community
          culture first, and technological innovation second.&quot; Technology serves values, not
          the reverse.
        </p>
        <p>
        ...
        <div className="mt-8 border-t border-border pt-8">
          ...
          <p>
            ...
            absorbed its own mythology, and why that matters for everything this Living Declaration
            is about.
          </p>
        </div>
      </div>
      ...
      <div className="article-body mx-auto max-w-2xl px-6 py-14 text-center leading-[1.9] sm:px-10 [&>p]:mb-4">
        ...
        <p>
          The storm is coming — or perhaps it is already here. You cannot control the storm. But you
          can become the kind of person who navigates storms with grace. You can build the kind of
          community that weathers storms together. And once you do, you can start systemic change to
      ...
      <div className="article-body mx-auto max-w-2xl px-6 py-14 leading-[1.9] sm:px-10 [&>p]:mb-4">
        ...
        <p>
          Each person I&apos;ve met, each conversation I&apos;ve had, each advisor who signed up for
          my bag of cookies — they are all part of the development of my ideals. And for that, I
          appreciate each one of them.
        </p>
        <p>
          These ideals are belief systems: thoughts attached to feelings. This construct was brought
          out by{" "}
          <Link href="/the-territory" className="text-brand-gold underline underline-offset-2">
            Arnold Patent
          </Link>{" "}
          ...
          , after studying with him for much time in Maui. And I&apos;m profoundly influenced by my
          partner and glorious artist Clarisse Abelarde, whose work has been a constant inspiration
          to my creativity and my love for humankind.
        </p>
        <p>
          Every advisor who joined this journey, every skeptic who challenged my assumptions, every
          visionary who saw what I couldn&apos;t yet articulate — they each added a piece to the
          puzzle. The Human OS framework you see here is not mine alone. It&apos;s the distillation
          of collective wisdom, the simplification of profound complexity that only emerges when
          diverse minds collide and collaborate.
        </p>
        <p>
          This is how we absorb AI and AGI into our lives. This is how we find our place in the sun.
          Not through individual genius, but through the patient accumulation of insight, the
          willingness to learn and unlearn, and the humility to recognize that the formula for
          navigating this new era was always going to be a collaborative effort.
        </p>
      ...
      <div className="mx-auto max-w-2xl px-6 py-14 sm:px-10">
        ...
        <h2 className="mb-8 font-heading text-2xl font-bold text-foreground sm:text-3xl">
          ...
          <em className="text-brand-gold not-italic">What We Measure.</em>
        </h2>
        {PRINCIPLES.map((p) => (
      ...
      <div className="mx-auto max-w-4xl px-6 py-14 sm:px-10">
        ...
        <p className="mb-8 max-w-2xl text-foreground/70">
          Every principle in this Living Declaration maps to something that already exists — a site,
          a protocol, an investment, an essay, a community. The infrastructure isn&apos;t
        ...
        <div className="grid gap-5 sm:grid-cols-2 lg:grid-cols-3">
          {ECOSYSTEM_MAP.map((item) => (
            ...
            >
              ...
              <p className="mb-4 flex-1 text-sm leading-relaxed text-foreground/70">{item.proof}</p>
      ...
      <div className="mx-auto max-w-2xl px-6 py-14 text-center sm:px-10">
        ...
        <p className="mb-8 text-foreground/70">
          The ideas in this Living Declaration aren&apos;t abstract — they&apos;re diagnostic. Take
          the assessment to discover your decision-making pattern, understand your relationship with
          technology, and find out where you sit on the spectrum between maximizer and satisficer.
          Then share your results with someone who needs to read this.
        </p>
        <Link
          href="/assessments"
        ...
        <div>
          ...
          >
            Or Explore Human OS V2.0 <ForwardIcon aria-hidden="true" />
          </Link>
        </div>
      </div>
      ...
      <div className="mx-auto max-w-2xl px-6 py-14 sm:px-10">
        ...
        <p className="mb-8 text-foreground/70">
          ...
          measure? What indices don&apos;t exist yet that should? What community would you build if
          you had the infrastructure? What does your most abundant life look like? Send your answers
          directly — one question or all of them, there are no wrong answers, only honest ones.
        </p>
        <a
        ...
        >
          Submit My Blueprint <ForwardIcon aria-hidden="true" />
        </a>
      ...
      <div className="bg-secondary px-6 py-16 text-center sm:px-10 dark:bg-[#0A0A10]">
        ...
        >
          Enter the Community <ForwardIcon aria-hidden="true" />
        </Link>
        <div className="mb-3">
          <Link
            href="/assessments"
          ...
          >
            Or Take the Assessment First <ForwardIcon aria-hidden="true" />
          </Link>
        </div>
        <div>
          <Link
            ...
            className="inline-block rounded-md border border-red-800/30 px-6 py-2.5 font-mono text-xs tracking-wide text-red-800 uppercase"
          >
            Explore Human OS V2.0 <ForwardIcon aria-hidden="true" />
          </Link>
        </div>
      </div>
      ...
      <div className="border-t border-border py-6 text-center">
        <Link href="/community" className="font-mono text-sm tracking-wide text-brand-gold">
          Continue to The Community <ForwardIcon aria-hidden="true" />
        </Link>
      </div>
    </div>
  );
