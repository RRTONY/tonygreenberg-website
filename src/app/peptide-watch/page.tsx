    ...
    <div>
      ...
      <div className="mx-auto max-w-4xl px-6 py-16">
        ...
        <section className="mb-20">
          ...
          <p className="mb-8 leading-relaxed text-foreground/80">
            Different stakeholders face different risks. Select your role below to get the
            checklist built specifically for your position in the peptide supply chain.
          </p>
        ...
        <section className="mb-20">
          ...
          <p className="mb-6 leading-relaxed text-foreground/80">
            ...
            Finnrick Analytics, the independent testing platform that has exposed the reality
            behind vendor claims.
          </p>
          <div className="mb-6 rounded-r border-l-4 border-[#B86A28] bg-[#B86A28]/8 p-6">
            ...
            <p className="mb-3 text-sm leading-relaxed text-foreground/80">
              ...
              samples from 196 vendors across 15 products as of March 2026. Tests run in
              commercial labs for purity and quantity. Results are published publicly. Vendors are
              rated A through E. The platform accepts free mail-in samples from U.S. researchers
              and has recently added optional endotoxin contamination testing.
            </p>
            <p className="mb-3 text-sm leading-relaxed text-foreground/80">
            ...
            <p className="text-sm leading-relaxed text-foreground/80">
              ...
              vs. advertised value at the 95th percentile. Retatrutide counterfeit detection
              flagged across Peptide Sciences samples in November 2025. Tirzepatide average score
              of 7.0 across 1,477 samples from 121 vendors. Best-rated vendors for key compounds:
              Aavant Research (tirzepatide, A rating) and Peptide Partners (BPC-157, A rating).
            </p>
          </div>
          <div className="rounded-md border border-[#2A5AA0]/20 bg-[#2A5AA0]/5 p-5 text-sm leading-relaxed text-foreground/80">
            <strong className="text-[#2A5AA0]">On blockchain and QR authentication:</strong> FDA&apos;s
            DSCSA pilot program demonstrated feasibility of blockchain-based package-level tracing
            using MediLedger and 2D Data Matrix barcodes. That is real pharma infrastructure. Most
            peptide vendor &quot;QR codes&quot; are glorified hyperlinks — they open a webpage, not
            a tamper-resistant provenance ledger. If the QR does not tie the physical package to a
            serialized lot history that cannot be casually rewritten, it is mostly decor. Do not
        ...
        <section className="mb-20">
          ...
          <p className="mb-6 leading-relaxed text-foreground/80">
            ...
            allowed Peptide Sciences and vendors like it to operate openly is closing. What does
            not yet exist — and what would stop criminals fastest — is an organized, funded,
        ...
        <section className="mb-20">
          ...
          <h3 className="mb-3 text-lg font-bold text-foreground">What to Collect Before Reporting</h3>
          ...
          <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
            {REPORT_CHANNELS.map((ch) => (
              <div key={ch.agency} className="rounded-md border-2 border-foreground p-5 text-center">
                <h4 className="mb-2 font-heading text-lg font-black text-foreground">{ch.agency}</h4>
        ...
        <section className="mb-20">
          ...
          <p className="mb-6 leading-relaxed text-foreground/80">
            This guide is architected as a high-efficiency, low-token-use knowledge model for
            Manus AI deployment. Here is how each component maps to an automated workflow layer.
          </p>
          <div className="flex flex-col gap-3">
            {MANUS_LAYERS.map((layer) => (
              <div key={layer.num} className="rounded-md border border-[#2A5AA0]/20 bg-[#2A5AA0]/5 p-4 text-sm">
        ...
        <div className="mb-20 rounded-md bg-[#C84B2A] p-8 text-white">
          <p className="font-heading text-lg leading-relaxed font-bold md:text-xl">
            ...
            bent the wrong way. Demand is huge. Margins are huge. Verification is weak. Most
            buyers outsource skepticism to charisma. Bad idea.&quot;
          </p>
        </div>
        ...
        <section className="mb-20">
          ...
          <p className="mb-4 leading-relaxed text-foreground/80">
            ...
            physician trusts a distributor. The distributor trusts an importer. The importer
            trusts a broker. The broker trusts a Chinese manufacturer. The buyer trusts the
            physician. By the time the vial hits your hand, everybody feels reassured and nobody
            has actually verified the chain.
          </p>
          <p className="mb-4 text-lg font-bold text-foreground">
            Never trust reputation. Never trust branding. Never trust a white coat. Never trust a
            QR code that only opens a webpage. Trust chain of custody, batch data, and independent
            verification.
          </p>
        ...
        <section className="mb-16">
          ...
          <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
            {[
              ...
              { href: "/quiz_25q", title: "Peptide Knowledge Quiz", desc: "Test your peptide safety knowledge" },
              { href: "/whats-legal", title: "What's Legal", desc: "Regulatory status for 17 real compounds" },
            ].map((link) => (
              <Link
                key={link.href}
                href={link.href}
