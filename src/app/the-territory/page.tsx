  ...
  return (
    <div className="mx-auto max-w-3xl px-6 py-10">
      ...
      <p className="mb-10 text-foreground/80">
        None of this was built alone. These are the people and ideas that shaped how I think,
        what I build, and why I bother. Some are mentors. Some are partners. Some are ideas that
        hit me like a truck and never let go.
      </p>
      ...
      <blockquote className="my-10 text-center font-heading text-xl italic text-foreground">
        The people in your life are not resources to be managed. They are mirrors. They show you
        who you are when you&apos;re not performing. Pay attention to the ones who stay when the
        show is over.
      </blockquote>
      ...
      <p className="mb-10 text-foreground/80">
        Radical transparency, obsessive documentation, and the power of showing up. Half of
        success is being in the room. The other half is knowing which room.
      </p>
