...
const CHECKLIST: CheckItem[] = [
  {
    id: 1,
    title: "The Lab Is Named and Findable",
    description:
      'The issuing lab should have a name, a website, and an accreditation you can look up independently. "Internal Quality Lab" is not a lab. Check: A2LA.org (US) or the ILAC database (international).',
    passLabel: "Named, accredited, independently queryable",
  },
  {
    id: 2,
    title: "It Is ISO/IEC 17025 Accredited",
    description:
      "This is the international standard for testing laboratories. If a lab doesn't hold this accreditation, their results carry no independent weight.",
    passLabel: "Accreditation confirmed on official registry",
  },
  {
    id: 3,
    title: "It Is Batch-Specific (Not Generic)",
    description:
      'Your COA should reference the exact lot number on your vials. "Generic product testing" means the document applies to some vial from some batch at some point. Useless.',
    passLabel: "Lot/batch number matches your order",
  },
  {
    id: 4,
    title: "HPLC Purity Is 98% or Higher (99%+ Is Better)",
    description:
      "High-Performance Liquid Chromatography measures purity. Below 98% is a problem. 95% means 5 out of every 100 molecules are something else. That matters.",
    passLabel: "98% minimum documented",
  },
  {
    id: 5,
    title: "Mass Spectrometry Confirms Molecular Identity",
    description:
      "Purity tells you how clean the sample is. Mass spectrometry tells you what it actually is. You want both. A 99% pure sample of the wrong compound is a 99% pure problem.",
    passLabel: "MS confirmation present",
  },
  {
    id: 6,
    title: "Endotoxin Testing Is Included",
    description:
      "A peptide can be 99% pure and still contain dangerous levels of bacterial endotoxins from manufacturing contamination. Most COAs skip this. It shouldn't be skipped.",
    passLabel: "Endotoxin test result documented",
  },
  {
    id: 7,
    title: "You Can Verify It Yourself Without the Vendor",
    description:
      "The gold standard: Janoshik Analytical (janoshik.com). Every Janoshik-tested batch gets a public reference ID. You go to their site, enter the ID, see the original results. No vendor. No PDF. No trust required — just verification.",
    passLabel: "Public verification pathway exists",
  },
];
