...
const SERIES: SeriesDef[] = [
  ...
  },
  {
    ...
    posts: ["the-buyers-and-sellers-honesty-dance-1", "the-buyers-sellers-honesty-dance-2"],
    category: "Business & Capital",
  },
  {
  ...
  return (
    <div>
      <div className="bg-linear-to-b from-background to-secondary px-6 pt-16 pb-10 sm:px-10">
        ...
        >
          <BackIcon aria-hidden="true" /> Back to The Blog
        </Link>
      ...
      <div className="mx-auto max-w-4xl px-6 py-12 sm:px-10">
        <div className="grid gap-8">
          {SERIES.map((series) => {
            const c = CATEGORY_CLASSES[series.category] ?? {
            ...
            return (
              ...
              >
                <div>
                  <span
                    className={`mb-3 inline-block rounded-sm px-2.5 py-1 font-mono text-xs tracking-wide uppercase ${c.text} ${c.bg}`}
                  >
                  ...
                  {seriesPosts[0] && (
                    ...
                    >
                      Start Reading <ForwardIcon aria-hidden="true" />
                    </Link>
                  )}
                </div>
      ...
      <div className="border-t border-border py-6 text-center">
        <Link href="/search" className="font-mono text-sm tracking-wide text-brand-gold">
          Search All Essays <ForwardIcon aria-hidden="true" />
        </Link>
      </div>
    </div>
  );
