...
const PORTFOLIO: PortCo[] = [
  {
    ...
    description:
      "IT sourcing & benchmarking firm. $10B+ benchmarked. SPY Index holds 1M+ data points. B Corp certified.",
    investmentThesis:
      "Trust is the ultimate moat in enterprise procurement. After 25 years of benchmarking every major cloud, colocation, and network deal, RampRate's data advantage is compounding — not depreciating. The SPY Index is the Bloomberg Terminal of infrastructure sourcing.",
    hawkinsScore: 400,
    ...
    competitors: [
      {
        name: "Gartner",
        description: "Global research & advisory — broader but shallower in sourcing",
        type: "competitor",
      },
      {
        name: "ISG (TPI)",
        description: "IT services sourcing — traditional RFP-driven model",
        type: "competitor",
      },
      {
        name: "Everest Group",
        description: "IT services research — strong in outsourcing analytics",
        type: "competitor",
      },
    ],
    status: "Active",
  ...
  },
  {
    ...
    description:
      "Certified B Corp tokenizing high-value cultural and real estate assets to fund regenerative impact. Four live token ecosystems: BEYOND, REX, SPACE, BEING.",
    investmentThesis:
      "Philanthropy is broken because it separates giving from owning. Asset-backed impact tokens let communities own a piece of the mission — a dinosaur skeleton, ocean cleanup infrastructure, digital access points. When you tokenize meaning, you create markets for things that matter.",
    hawkinsScore: 540,
    ...
    competitors: [
      {
        name: "Republic",
        description: "Crowdfunding platform — broader but less impact-focused",
        type: "competitor",
      },
      {
        name: "Giveth",
        description: "Blockchain-native giving — decentralized but less structured",
        type: "competitor",
      },
      {
        name: "Flowcarbon",
        description: "Tokenized carbon credits — similar mechanism, different asset class",
        type: "competitor",
      },
    ],
    status: "Active",
  ...
  },
  {
    ...
    description:
      "Mycological therapeutics for mental health, neurodegeneration, and immune support.",
    investmentThesis:
      "Fungi are the original internet — 2.4 billion years of networked intelligence. When you pair mycological science with clinical-grade therapeutic development, you get medicine that works with biology instead of against it. This is consciousness infrastructure.",
    hawkinsScore: 600,
    ...
    competitors: [
      {
        ...
        description: "Psilocybin therapy — FDA Breakthrough, synthetic approach",
        type: "competitor",
      },
      {
        name: "MAPS/Lykos",
        description: "MDMA-assisted therapy — regulatory pioneer",
        type: "competitor",
      },
      {
        name: "Numinus",
        description: "Psychedelic-assisted therapy clinics — service model",
        type: "competitor",
      },
    ],
    status: "Active",
  ...
  },
  {
    ...
    category: "Psychedelic Medicine",
    description:
      "FDA Breakthrough Therapy designation. Psychedelic-assisted therapy for treatment-resistant depression.",
    investmentThesis:
      "The FDA Breakthrough designation isn't just regulatory — it's civilizational. When the most conservative institution in medicine says 'this matters enough to fast-track,' you're watching a paradigm shift in real time. Beckley's research rigor plus Atai's capital structure creates the bridge between counterculture wisdom and clinical legitimacy.",
    hawkinsScore: 500,
    ...
    competitors: [
      {
        name: "Compass Pathways",
        description: "Direct competitor — synthetic psilocybin, larger market cap",
        type: "competitor",
      },
      {
        name: "MindMed",
        description: "LSD-based therapeutics — different molecule, similar market",
        type: "competitor",
      },
      {
        name: "Cybin",
        description: "Deuterated psilocybin — novel chemistry approach",
        type: "competitor",
      },
    ],
    status: "Active",
  ...
  },
  {
    ...
    investmentThesis:
      "The psychedelic renaissance needs plumbing. Wake Network is building the connective tissue between practitioners, patients, and researchers. When an industry goes from underground to mainstream, the network layer captures disproportionate value.",
    hawkinsScore: 500,
    ...
    competitors: [
      {
        name: "Psychable",
        description: "Psychedelic provider directory — simpler model",
        type: "competitor",
      },
      {
        name: "Mindbloom",
        description: "At-home ketamine therapy — consumer-facing",
        type: "competitor",
      },
    ],
    status: "Active",
  ...
  },
  {
    ...
    competitors: [
      {
        name: "Medable",
        description: "Decentralized clinical trials — broader pharma focus",
        type: "competitor",
      },
      {
        name: "Science 37",
        description: "Virtual clinical trials — similar model, different market",
        type: "competitor",
      },
    ],
    status: "Active",
  ...
  },
  {
    ...
    investmentThesis:
      "Not everyone is ready for a mushroom journey. Tripp meets people where they are — in a headset, in their living room, on their lunch break. VR-induced altered states are the gateway drug to consciousness expansion. When Apple ships spatial computing to a billion people, Tripp is the meditation app that actually changes your brain.",
    hawkinsScore: 460,
    ...
    competitors: [
      {
        name: "Calm",
        description: "Meditation app — massive user base, no VR",
        type: "competitor",
      },
      {
        name: "Headspace/XR",
        description: "Mindfulness + emerging XR experiments",
        type: "competitor",
      },
      {
        name: "Innerworld",
        description: "VR mental health support communities",
        type: "competitor",
      },
    ],
    status: "Active",
  ...
  },
  {
    ...
    description:
      "Four payment processing companies at the intersection of traditional card processing, stablecoin settlement, and cross-border remittance.",
    investmentThesis:
      "Payments is a $2T industry built on 1970s rails. The corridor between traditional card processing and stablecoin settlement is where the next decade of value creation lives. Four companies, each holding a different piece of the pipe. Details under NDA, but the opportunity is measured in billions.",
    hawkinsScore: 350,
    ...
    competitors: [
      {
        name: "Stripe",
        description: "Dominant payment processor — API-first, massive scale",
        type: "competitor",
      },
      {
        name: "Circle (USDC)",
        description: "Stablecoin infrastructure — regulatory-first approach",
        type: "competitor",
      },
      {
        name: "Wise",
        description: "Cross-border payments — consumer-focused, transparent pricing",
        type: "competitor",
      },
    ],
    status: "Stealth",
  ...
  },
  {
    ...
    investmentThesis:
      "The best companies emerge at intersections that nobody else sees. Menagerie is the studio that holds all seven doors open simultaneously and builds companies in the spaces between them. It's not a fund — it's a foundry.",
    hawkinsScore: 460,
    ...
    competitors: [
      {
        name: "Idealab",
        description: "Bill Gross's venture studio — pioneered the model",
        type: "competitor",
      },
      {
        name: "Pioneer Square Labs",
        description: "Seattle-based venture studio — similar structure",
        type: "competitor",
      },
      {
        name: "Atomic",
        description: "Jack Abraham's venture studio — consumer-focused",
        type: "competitor",
      },
    ],
    status: "Active",
  ...
  return (
    <div className="mx-auto max-w-3xl px-6 py-10">
      ...
      <p className="mb-10 max-w-2xl leading-relaxed text-foreground/80">
        Every company and cause here passes through three gates before it gets my time. Then it gets
        scored on seven dimensions of impact, measured against Howard W. Buffett&apos;s Impact Rate
        of Return framework, and calibrated on David Hawkins&apos; Map of Consciousness. This
        isn&apos;t a portfolio — it&apos;s an operating system for making sure the work goes where
        it actually matters.
      </p>
      ...
      <div className="border-t border-border py-6 text-center">
        <Link href="/blog" className="font-mono text-sm tracking-wide text-brand-gold">
          Read the Blog <ForwardIcon aria-hidden="true" />
        </Link>
      </div>
    </div>
  );
