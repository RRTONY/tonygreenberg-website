...
const tdClass =
  "border-b border-[#E8E2D8] px-3 py-2.5 align-top text-[.95rem] leading-[1.55] text-pri-brown";
const thDarkClass =
...
const UPDATED_RESEARCH = [
  {
    condition: "Opioid withdrawal elimination",
    result: "80–90%",
    source: "Mash et al., Ann NY Acad Sci 2000",
  },
  {
    condition: "Opioid abstinence at 6 months (n=88)",
    result: "54%",
    source: "Davis et al., J Psychedelic Studies 2017",
  },
  {
    condition: "Opioid craving reduction at 12 months",
    result: "50–60%",
  ...
  {
    condition: "SOF veterans — PTSD reduction at 1 month",
    result: "88%",
    source: "Cherian et al., Nature Medicine, Jan 2024",
  },
  {
    condition: "SOF veterans — depression reduction at 1 month",
    result: "87%",
    source: "Cherian et al., Nature Medicine 2024",
  },
  {
    condition: "SOF veterans — anxiety reduction at 1 month",
    result: "81%",
    source: "Cherian et al., Nature Medicine 2024",
  },
  {
    condition: "SOF veterans no longer meeting PTSD criteria at 1 year",
    result: "71%",
    source: "Williams et al., Nature Mental Health, July 2025",
  },
  {
    condition: "Mission Within veterans — no longer meet PTSD criteria",
    result: "80%",
    source: "missionwithin.org, verified June 2026",
  },
  {
    condition: "Safety across 19,071 patients at 11 clinics",
    result: "6 deaths — all opioid-use-disorder; zero in non-SUD",
    source: "Research Square multisite analysis, June 2026",
  },
];
...
const ADDITIONAL_FACILITIES = [
  {
    name: "Iboga Wellness Institute",
    location: "International",
    focus: "Navigation · complex case coordination",
    url: "https://theibogainstitute.org",
  },
  {
    name: "New Roots Ibogaine",
    location: "Mexico",
    focus: "Opioid replacement specialists",
    url: "https://newrootsibogaine.com",
  },
  {
    name: "Transcend Ibogaine",
    location: "Cancún, MX (Level 2)",
    focus: "Bilingual · cardiology-trained",
    url: "https://transcendibogaine.com",
  },
  {
    name: "Root Healing",
    location: "Portugal",
    focus: "Bwiti lineage · depression",
    url: "https://roothealing.com",
  },
  {
    name: "Iboga Wellness Center",
    location: "Costa Rica",
    focus: "Bwiti-informed · spiritual",
    url: "https://ibogawellness.com",
  },
  {
    name: "Awakening Soul",
    location: "Costa Rica",
    focus: "Life reset · small groups",
    url: "https://awakeningsoul.com",
  },
];
...
const QUICK_REFERENCE = [
  {
    name: "The Mission Within",
    loc: "Baja California, MX",
    travel: "Level 3 (regional)",
    vet: "⭐ Primary",
    nagoya: "No",
    price: "Contact",
  },
...
const LEGAL_STATUS_ITEMS = [
  {
    ...
    detail:
      "US State Dept Level 3: Reconsider Travel. Regional organized crime advisory — not facility-specific.",
  },
  {
    label: "Quintana Roo (Cancún, Cozumel)",
    detail: "US State Dept Level 2: Exercise Increased Caution.",
  },
  {
    label: "April 2026: White House Executive Order",
    detail:
      "Directed FDA and DEA to facilitate a Right to Try pathway for ibogaine. Ibogaine remains Schedule I — this initiates a regulatory process only.",
  },
  {
    label: "Texas SB 2308 (2025)",
    detail:
      "$50 million for ibogaine clinical trials through UTHealth Houston and UTMB Galveston. Largest single public investment in psychedelic medicine research in US history.",
  },
  {
    label: "VA and Military",
    detail:
      "Treatment in Mexico does not affect VA eligibility, disability rating, or benefit status. No reporting mechanism exists.",
  },
];
    ...
    <div className="min-h-screen bg-pri-cream font-body">
      ...
      <section className="relative flex min-h-[85vh] flex-col justify-end overflow-hidden">
        <Image
          ...
          fill
          sizes="100vw"
          className="object-cover brightness-50 contrast-110 saturate-110"
        />
        ...
        <div className="relative z-10 mx-auto w-full max-w-225 px-6 pb-16">
          <Link
            ...
            className="mb-6 inline-flex items-center gap-1.5 text-sm font-semibold tracking-[0.08em] text-[#D4B96A] uppercase"
          >
            <BackIcon aria-hidden="true" /> Back to PRI
          </Link>
          ...
          <h1 className="mb-4 font-heading text-[clamp(2.2rem,6vw,4rem)] text-[#FAFAF7]">
            Iboga vs Ibogaine
          </h1>
          <p className="max-w-175 text-[clamp(1.1rem,2.5vw,1.35rem)] leading-[1.6] text-[#E8E2D8]">
            Twelve companion alkaloids in sacred synergy — or one purified molecule under cardiac
            monitoring. The Bwiti have known for centuries what Western medicine is only now
            beginning to measure.
          </p>
          <div className="mt-8 flex flex-wrap gap-4">
            <span className="rounded border border-[#D4B96A]/40 bg-[#D4B96A]/15 px-4 py-1.5 text-sm font-semibold text-[#D4B96A]">
              Iboga: 24–72 hrs
            </span>
            <span className="rounded border border-[#D4B96A]/40 bg-[#D4B96A]/15 px-4 py-1.5 text-sm font-semibold text-[#D4B96A]">
              Ibogaine: 18–36 hrs
      ...
      <PriSection id="alkaloids">
        <div className="relative mb-8 h-[clamp(180px,25vw,280px)] max-h-85 w-full overflow-hidden rounded-xl">
          <Image
            src={IBOGA_IMAGES.alkaloidComparison}
            alt="Alkaloid comparison visualization"
            fill
            sizes="100vw"
        ...
        <h2 className="mb-4 font-heading text-[clamp(1.6rem,4vw,2.5rem)] text-pri-ink">
          The Entourage Effect
        </h2>
        <p className="mb-6 max-w-200 text-[1.05rem] leading-[1.75] text-pri-brown">
          Tabernanthe iboga root bark contains at least twelve identified indole alkaloids —
          approximately 6% of the dried bark by weight. Ibogaine is the most abundant (50–80% of
          total alkaloid content), but the companion alkaloids — ibogamine, tabernanthine,
          voacangine, coronaridine, ibogaline, and noribogaine — each contribute distinct
          pharmacological actions. Traditional Bwiti practitioners have always insisted the whole
          root bark is greater than any single compound. Western pharmacology is beginning to agree.
        </p>
        <div className="mb-6 rounded-md border-l-4 border-[#E65100] bg-[#FFF3E0] p-5">
          ...
          <p className="m-0 text-[1.05rem] leading-[1.75] text-pri-brown">
            Like cannabis (THC + CBD + terpenes) and ayahuasca (DMT + harmalines), iboga&apos;s full
            alkaloid profile may produce synergistic effects that isolated ibogaine cannot
            replicate. Coronaridine alone shows independent anti-addictive properties at NIDA.
            Tabernanthine provides the stimulant phase. Voacangine contributes anti-inflammatory
            action.
          </p>
        </div>
      ...
      <PriSection id="pharmacology" dark>
        ...
        <h2 className="mb-4 font-heading text-[clamp(1.6rem,4vw,2.5rem)] text-pri-cream">
          Multi-Target Mechanism
        </h2>
        <p className="mb-6 max-w-200 text-[1.05rem] leading-[1.75] text-pri-cream/80">
          Ibogaine is pharmacologically unique among psychedelics — it simultaneously engages
          opioid, glutamate, serotonin, dopamine, and nicotinic systems. No other known compound
          hits this many addiction-relevant targets in a single dose. Its primary metabolite,
          noribogaine, extends the therapeutic window to 24–48 hours with stronger mu-opioid and
            ...
            <tbody>
              {IBOGAINE_PHARMACOLOGY.map((r, i) => (
                <tr key={r.receptor} className={i % 2 ? "bg-white/3" : ""}>
                  ...
                  <td className={`${tdDarkClass} font-mono whitespace-nowrap`}>
                    {r.ibogaineKi || "—"}
                  </td>
                </tr>
              ))}
        ...
        <div className="mt-6 rounded-md border-l-4 border-[#E57373] bg-[#C62828]/12 p-5">
          ...
          <p className="m-0 text-[1.05rem] leading-[1.75] text-pri-cream/80">
            Ibogaine&apos;s half-life is 4–7 hours. But its metabolite noribogaine persists for
            24–48 hours with stronger mu-opioid and SERT binding. This is why opioid withdrawal
            relief extends far beyond ibogaine&apos;s direct action — and why cardiac monitoring
            must continue for at least 72 hours post-treatment.
          </p>
        </div>
      </PriSection>
      ...
      <PriSection id="comparison">
        <div className="mb-8 grid grid-cols-1 gap-4 sm:grid-cols-2">
          <div className="relative h-65 max-h-65 overflow-hidden rounded-xl">
            <Image
              src={IBOGA_IMAGES.bwitiTradition}
              alt="Bwiti tradition"
              fill
          ...
          <div className="relative h-65 max-h-65 overflow-hidden rounded-xl">
            <Image
              src={IBOGA_IMAGES.clinicalSetting}
              alt="Clinical ibogaine treatment"
              fill
              sizes="(max-width: 768px) 100vw, 50vw"
              className="object-cover"
            />
        ...
        <p className="mb-6 max-w-200 text-[1.05rem] leading-[1.75] text-pri-brown">
          The Bwiti tradition and Western ibogaine clinics approach the same plant from opposite
          ends of the epistemological spectrum. One treats the root bark as a living intelligence —
          a teacher plant that communicates through visions, purging, and ancestor contact. The
          other isolates the most pharmacologically active molecule and administers it under EKG
          monitoring. Both save lives. Neither is wrong.
        </p>
        <div className="overflow-x-auto">
      ...
      <PriSection id="outcomes" dark>
        ...
        <p className="mb-6 max-w-200 text-[1.05rem] leading-[1.75] text-pri-cream/80">
          Most clinical data is on ibogaine HCl, not whole iboga — because clinical trials require
          standardized dosing. The Bwiti tradition has thousands of years of observational evidence
          but limited Western-style controlled studies. What exists is compelling: single-dose
          ibogaine eliminates opioid withdrawal in 80–90% of cases and sustains craving reduction at
          12 months in over half of participants.
        </p>
        <div className="overflow-x-auto">
            ...
            <tbody>
              {IBOGAINE_OUTCOMES.map((r, i) => (
                <tr key={r.condition} className={i % 2 ? "bg-white/3" : ""}>
                  ...
                  <td className={`${tdDarkClass} font-mono font-bold text-[#D4B96A]`}>
                    {r.improved}
                  </td>
        ...
        <div className="mt-6 rounded-md border-l-4 border-[#FFB74D] bg-[#E65100]/12 p-5">
          ...
          <p className="m-0 text-[1.05rem] leading-[1.75] text-pri-cream/80">
            Most studies are observational, not randomized controlled trials. Sample sizes are small
            (n=12–88). Publication bias likely inflates success rates. Ibogaine is not FDA-approved.
            The Stanford TBI trial (2024) is the most rigorous to date. Whole-iboga outcomes data is
            almost entirely anecdotal from Bwiti practitioners.
          </p>
        </div>
      </PriSection>
      ...
      <PriSection id="pharma-alternatives">
        <PriEyebrow>
          Pharma <ForwardIcon aria-hidden="true" /> Plant Alternatives
        </PriEyebrow>
        <h2 className="mb-4 font-heading text-[clamp(1.6rem,4vw,2.5rem)] text-pri-ink">
          What Iboga Replaces
        </h2>
        <p className="mb-6 max-w-200 text-[1.05rem] leading-[1.75] text-pri-brown">
          Ibogaine&apos;s multi-receptor profile means it mechanistically overlaps with several
          pharmaceutical categories — opioid agonists, antagonists, NMDA modulators, SSRIs, and
          smoking cessation agents. A single ibogaine session can address what would otherwise
          require 3–5 separate prescriptions with their respective side-effect profiles.
        </p>
        <IbogaPharmaTable />
      </PriSection>
      ...
      <PriSection id="supplements" dark>
        ...
        <p className="mb-6 max-w-200 text-[1.05rem] leading-[1.75] text-pri-cream/80">
          Ibogaine preparation is more medically intensive than any other psychedelic. Cardiac
          support (CoQ10, magnesium, potassium) is non-negotiable. The 4–8 week pre-treatment window
          is critical for building physiological resilience. Post-integration extends longer than
          most medicines due to noribogaine&apos;s sustained 24–48 hour half-life.
        </p>
                ...
                >
                  ...
                  {item.searchUrl && (
                    <a
                      ...
                      className="mt-1 inline-block text-[.8rem] text-pri-cream/50 underline"
                    >
                      Find on Amazon <ForwardIcon aria-hidden="true" />
                    </a>
                  )}
                </div>
              ))}
      ...
      <PriSection id="dimensions">
        ...
        <p className="mb-6 max-w-200 text-[1.05rem] leading-[1.75] text-pri-brown">
          Iboga and ibogaine demand the highest readiness thresholds of any medicine in the PRI. The
          24–72 hour duration, cardiac risk profile, and intensity of the visionary experience mean
          that every dimension must be at or near maximum before proceeding.
        </p>
        <div className="overflow-x-auto">
          <table className="w-full min-w-162.5 border-collapse">
            <thead>
      ...
      <PriSection id="selector" dark>
        ...
        <p className="mb-6 max-w-200 text-[1.05rem] leading-[1.75] text-pri-cream/80">
          Ibogaine is the strongest evidence-based medicine for opioid addiction interruption. For
          depression, ketamine acts faster. For PTSD, MDMA has the strongest trial data. For
          spiritual development, iboga (whole plant) in Bwiti context is unmatched in depth and
          duration. Know what you need before choosing.
        </p>
        <div className="overflow-x-auto">
          <table className="w-full min-w-187.5 border-collapse">
            <thead>
      ...
      <PriSection id="research-narrative">
        ...
        <p className="mb-6 max-w-200 text-[1.05rem] leading-[1.75] text-pri-brown">
          I sat Ibogaine at The Mission Within in Baja California alongside Navy SEALs. Men trained
          to feel nothing wept. Men who had spent years cycling through VA medications, residential
          rehab, and every approved protocol the United States government offers — undone and
          rebuilt by a molecule in a single night.
        </p>
        <p className="mb-6 max-w-200 text-[1.05rem] leading-[1.75] text-pri-brown">
          That is not anecdote. That is an 88% PTSD symptom reduction at one month, published in{" "}
          <em>Nature Medicine</em> by Stanford University in January 2024. That is 80% of
          participants at The Mission Within no longer meeting diagnostic criteria for PTSD — across
          1,200 veterans. That is the most significant psychiatric intervention data in a
          generation, happening 90 minutes south of the US border because the US government still
          classifies this plant as having &ldquo;no accepted medical use.&rdquo;
        </p>
        <p className="mb-6 max-w-200 text-[1.05rem] leading-[1.75] text-pri-brown">
          If you&apos;re here because you or someone you love is suffering and nothing has worked —
          you&apos;re in the right place. If you&apos;re here because you&apos;re curious about the
          most interesting molecule in neuropharmacology — also the right place.
        </p>
        <p className="mb-6 max-w-200 text-[1.05rem] leading-[1.75] text-pri-brown">
          This section will tell you what ibogaine actually is, what the research actually shows,
          which facilities are worth your life, and which ones you should run from. Then the Iboga
          Compass below will match you to the right path for your specific situation — or tell you
          clearly if ibogaine isn&apos;t right for you at all.
        </p>
        <p className="mb-8 max-w-200 text-[1.05rem] leading-[1.75] font-bold text-pri-brown">
          No paid placements. No ads. No bullshit.
        </p>

        <PriEyebrow>The Numbers</PriEyebrow>
        <h3 className="mb-4 font-heading text-[clamp(1.3rem,3vw,1.8rem)] text-pri-ink">
          Updated Research Data (2024–2026)
        </h3>
        <div className="overflow-x-auto">
          <table className="w-full min-w-162.5 border-collapse">
            <thead>
            ...
            <tbody>
              {UPDATED_RESEARCH.map((r, i) => (
                <tr key={r.condition} className={i % 2 ? "bg-pri-parchment" : ""}>
                  ...
                  <td className={`${tdClass} font-mono font-extrabold text-[#8B6914]`}>
                    {r.result}
                  </td>
        ...
        <div className="mt-6 rounded-md border-l-4 border-[#E65100] bg-[#FFF3E0] p-5">
          ...
          <p className="m-0 text-[1.05rem] leading-[1.75] text-pri-brown">
            Most studies are observational, not randomized controlled trials. Sample sizes are
            small. Ibogaine is not FDA-approved. The Research Square 2026 study — 19,071 patients —
            is the largest safety analysis to date. Six deaths, all in opioid-use-disorder patients
            at under-resourced settings. Zero in non-SUD patients under proper protocols.{" "}
            <strong>Proper protocols. That phrase is doing enormous work.</strong>
          </p>
        </div>
      </PriSection>
      ...
      <PriSection id="contraindications" dark>
        ...
        <p className="mb-6 max-w-200 text-[1.05rem] leading-[1.75] text-pri-cream/80">
          These are absolute contraindications. Not risk factors to manage. Hard stops. If any
          apply, ibogaine is not your path right now.
        </p>
        ...
        <ul className="mb-6 list-disc space-y-2 pl-6 text-[1.05rem] leading-[1.75] text-pri-cream/80">
          <li>
            <strong>Long QT Syndrome or QTc above 450ms on any EKG.</strong> In a 14-patient Dutch
            clinical study, 50% reached QTc above 500ms during treatment. Every known ibogaine
            fatality has involved either an undetected cardiac condition or inadequate monitoring.
          </li>
          <li>
            <strong>
              Diagnosed heart disease, arrhythmia, Brugada syndrome, or history of cardiac events.
            </strong>
          </li>
          <li>
            <strong>
              Family history of sudden cardiac death under 50 or known inherited Long QT.
            </strong>
          </li>
        </ul>
        <div className="mb-6 rounded-md border-l-4 border-[#E57373] bg-[#C62828]/12 p-5">
          <p className="m-0 text-[1.05rem] leading-[1.75] text-pri-cream/80">
            Any clinic that will take you without a 12-lead EKG reviewed by a physician is telling
            you something important about their standards.
          </p>
        </div>
        ...
        <ul className="mb-6 list-disc space-y-2 pl-6 text-[1.05rem] leading-[1.75] text-pri-cream/80">
          <li>
            <strong>Severe liver disease or liver enzymes above 2.5× normal.</strong> Ibogaine is
            metabolized via CYP450-2D6. Compromised liver means dangerous accumulation.
          </li>
          <li>
            <strong>Uncontrolled seizure disorder.</strong> Ibogaine doesn&apos;t cause seizures.
            But seizures during treatment can trigger fatal arrhythmias.
          </li>
          <li>
        ...
        <ul className="mb-6 list-disc pl-6 text-[1.05rem] leading-[1.75] text-pri-cream/80">
          <li>
            <strong>
              Active psychosis. Acute bipolar mania. Schizophrenia or schizoaffective disorder
              (active).
            </strong>{" "}
            Ibogaine is an oneirogen — a waking dream lasting 8–20 hours. In a stable person this is
            transformative. In an actively psychotic person this is dangerous.
          </li>
        </ul>

        <h3 className="mt-8 mb-3 font-heading text-xl text-[#FFB74D]">The Medications Problem</h3>
        <p className="mb-4 max-w-200 text-[1.05rem] leading-[1.75] text-pri-cream/80">
          Most people reading this have more preparation work to do than they realize.
        </p>
        <div className="grid grid-cols-[repeat(auto-fill,minmax(300px,1fr))] gap-4">
          <div className="rounded-lg border border-[#E57373]/30 bg-[#C62828]/10 p-4">
            <p className="m-0 mb-2 font-extrabold text-[#E57373]">
              Hard stops — physician clearance required
            </p>
          ...
          <div className="rounded-lg border border-[#FFB74D]/30 bg-[#FFB74D]/10 p-4">
            <p className="m-0 mb-2 font-extrabold text-[#FFB74D]">
              Supervised medical taper required
            </p>
            <ul className="m-0 list-disc space-y-1 pl-5 text-[.9rem] leading-[1.75] text-pri-cream/80">
        ...
        <p className="mt-4 text-[.9rem] leading-[1.6] text-pri-cream/70">
          Also avoid: grapefruit (72 hours before), St. John&apos;s Wort (2 weeks before),
          quinine/tonic water (prolongs QT — avoid completely).{" "}
          <strong>
            Full medication disclosure to your treatment team is non-negotiable. Undisclosed drug
            interactions are how people die.
          </strong>
        </p>
      </PriSection>
      ...
      <PriSection id="facilities">
        ...
        <h2 className="mb-6 font-heading text-[clamp(1.6rem,4vw,2.5rem)] text-pri-ink">
          Who&apos;s Doing It Right
        </h2>
        <p className="mb-6 max-w-200 text-[1.05rem] leading-[1.75] text-pri-brown">
          Twenty-two years of due diligence across $10 billion in restructured deals taught me one
          thing: the difference between a good deal and a catastrophic one is almost always the
          quality of the people managing it, not the underlying asset. Same principle applies here.
          The medicine is not the variable. The setting is.
        </p>
        <p className="mb-8 max-w-200 text-[1.05rem] leading-[1.75] text-pri-brown">
          Every facility listed below is verified from their public website and independent
          directories as of June 2026. Two that appeared on earlier versions of this list have been
          removed — I&apos;ll tell you why.
        </p>
            ...
            <div className="mb-3 flex flex-wrap items-start gap-4">
              <div>
                <h3 className="mb-1 flex items-center gap-2 font-heading text-xl text-pri-ink">
                  {f.star && <Star className="size-4 text-[#D4B96A]" fill="currentColor" />}{" "}
                  {f.name}
                </h3>
        ...
        <h3 className="mt-8 mb-4 font-heading text-xl text-pri-ink">
        ...
        <div className="mt-8 border-l-4 border-[#581C87] bg-[#F3E8FF] p-5">
          <p className="m-0 mb-2 font-extrabold text-[#581C87]">
            Two Facilities No Longer on This List
          </p>
          <p className="m-0 mb-2 text-[1.05rem] leading-[1.75] text-pri-brown">
            <strong>Ibogaine by David Dardashti</strong> — Removed. Multiple independently
            documented reviews describe unsafe conditions, absent medical oversight, threatened
            clients, and alleged misrepresentation. Do not go here.
          </p>
          <p className="m-0 text-[1.05rem] leading-[1.75] text-pri-brown">
            ...
            <tbody>
              {QUICK_REFERENCE.map((r, i) => (
                <tr key={r.name} className={i % 2 ? "bg-pri-parchment" : ""}>
                  ...
                  <td
                    className={`${tdClass} ${r.travel.includes("3") ? "text-[#E65100]" : r.travel.includes("2") ? "text-[#8B6914]" : ""}`}
                  >
                    {r.travel}
                  </td>
      ...
      <PriSection id="extractive-capitalism" dark>
        ...
        <p className="mb-6 max-w-200 text-[1.05rem] leading-[1.75] text-pri-cream/80">
          Of the seven biggest companies currently developing ibogaine as a pharmaceutical, none had
          made any public mention of following the Nagoya Protocol at the time of my research. The
          Nagoya Protocol governs access to genetic resources and traditional knowledge from
          indigenous communities. Gabon was the first country in the world to sign it.
        </p>
        <p className="mb-6 max-w-200 text-[1.05rem] leading-[1.75] text-pri-cream/80">
          What this means in plain English: Western pharmaceutical companies are taking a plant that
          Gabonese communities have stewarded for centuries, extracting the active compound,
          patenting novel formulations, and building businesses worth hundreds of millions of
          dollars — without returning anything meaningful to the people whose knowledge made this
          possible.
        </p>
        <p className="mb-6 max-w-200 text-[1.05rem] leading-[1.75] text-pri-cream/80">
          Ambio Life Sciences is the only ibogaine clinic in the world that is Nagoya-compliant.
          Beōnd plants three iboga trees in Gabon per treatment. These are not marketing claims —
          they are structural positions that should be part of your facility selection criteria.
        </p>
        <p className="mb-8 max-w-200 text-[1.05rem] leading-[1.75] text-pri-cream/80">
          This is the core of ImpactSoul&apos;s thesis: regenerative capital heals. Extractive
          capital destroys. Ibogaine is the most literal test of that proposition I have
          encountered.
        </p>
        <a
          href="https://tonygreenberg.com/psychedelics-could-become-extractive-capitalism/"
          className="inline-flex rounded-md bg-[#D4B96A] px-8 py-3 font-bold text-pri-ink"
        >
          Read the Full Argument <ForwardIcon aria-hidden="true" />
        </a>
      </PriSection>
      ...
      <PriSection id="legal-status">
        ...
        <p className="mb-6 max-w-200 text-[1.05rem] leading-[1.75] text-pri-brown">
          Ibogaine is Schedule I in the United States. US and Canadian citizens traveling to Mexico
          for treatment face zero domestic legal consequences.
        </p>
        <div className="grid grid-cols-[repeat(auto-fill,minmax(280px,1fr))] gap-4">
          {LEGAL_STATUS_ITEMS.map((item) => (
            <div
              key={item.label}
              className="rounded-lg border border-pri-border bg-pri-parchment p-4"
            >
      ...
      <PriSection id="sources">
        ...
        <h2 className="mb-6 font-heading text-[clamp(1.4rem,3vw,2rem)] text-pri-ink">
      ...
      <section className="bg-pri-ink px-5 py-8">
        <div className="mx-auto max-w-225">
          ...
          <div className="mt-8 text-center">
            <Link
              href="/psychedelic-readiness-index"
              className="inline-block rounded-md bg-[#D4B96A] px-8 py-3 font-bold text-pri-ink"
            >
              <BackIcon aria-hidden="true" /> Return to Psychedelic Readiness Index
            </Link>
          </div>
        </div>
      </section>
