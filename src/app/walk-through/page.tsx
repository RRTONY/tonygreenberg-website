      ...
      <div className="mx-auto max-w-2xl px-6 pb-16">
        <div className="rounded-r-md border-l-4 border-brand-gold bg-brand-gold/5 p-6">
          ...
          <p className="leading-relaxed text-foreground/80">
            Seven doors sounds like chaos. It&apos;s not. It&apos;s a system — each door
            reinforces the others. The enterprise data informs the tokenization models. The health
            protocols inform the psychedelic investments. The consumer advocacy sharpens the ethics
            across everything. The lesson: depth in multiple domains isn&apos;t distraction. It&apos;s
            architecture.
          </p>
        </div>
      </div>
