...
const PODCASTS = [
  {
    show: "Jeff Bullas Podcast",
    episode: "Exploring the Intersection Between AI and Humanity",
    ep: "Ep. 181",
    date: "June 2024",
    url: "https://www.jeffbullas.com/podcasts/ai-and-humanity-181/",
  },
  {
    show: "Building The Future Show",
    episode: "Tony Greenberg, CEO & Founder",
    ep: "Ep. 583",
    date: "February 2024",
    url: "https://www.youtube.com/watch?v=MfEt7jkBmOQ",
  },
  {
    show: "Edge of NFT",
    episode: "Can Crypto Save the World? Inside the Flying Pigs Project",
    ep: "",
    date: "February 2025",
    url: "https://www.youtube.com/watch?v=CqqROb_DmL4",
  },
  {
    show: "Enterprise Radio",
    episode: "Innovation Meets Impact with RampRate Founder and CEO",
    ep: "",
    date: "",
    url: "https://epodcastnetwork.com/meet-tony-greenberg-innovation-meets-impact-with-ramprate-founder-and-ceo/",
  },
  {
    show: "RampRate Podcast",
    episode: "How to Think When $100M's Are on the Line",
    ep: "Mini-Episode",
    date: "May 2016",
    url: "https://ramprate.com/mini-episode-tony-greenberg-ceo-of-ramprate/",
  },
];
...
const UNIQUE_PUBLICATIONS = [
  {
    ...
    articles: [
      {
        title: "Clout Vs. Klout: They're Not The Same, And Never Will Be",
        url: "https://www.forbes.com/sites/ciocentral/2012/04/18/clout-vs-klout-theyre-not-the-same-and-never-will-be/",
        date: "April 2012",
        note: "CIO Central Guest Post",
      },
    ],
  },
  {
    ...
    articles: [
      {
        title: "60% Of Trading In The US Is Now Filtered Through A High-Frequency Platform",
        url: "https://www.businessinsider.com/author/tony-greenberg",
        date: "February 2012",
        note: "",
      },
      {
        title: "When Valuations Don't Actually Mean Valuable",
        url: "https://www.businessinsider.com/author/tony-greenberg",
        date: "November 2011",
        note: "",
      },
      {
        title: "Amazon Should Prevail In The Race To Acquire Hulu",
        url: "https://www.businessinsider.com/author/tony-greenberg",
        date: "September 2011",
        note: "",
      },
...
const TESTIMONIALS: Testimonial[] = [
  {
    ...
    roi: 24,
    quote:
      "RampRate has been my most reliable global resource and is ready to perform for us at a moment's notice. Their inside knowledge and ability to handle high-level complex negotiations helped us move fast.",
    strategic:
      "They didn't just cut costs — they restructured our entire vendor architecture so we could scale World of Warcraft's infrastructure 3x without renegotiating a single contract.",
  },
  {
    name: "Phil Wiser",
    title: "EVP & CTO",
    ...
    roi: 22,
    quote:
      "They saved us millions, created agility and new budget out of thin air. They are a secret weapon in my tool box for truth, transparency and actionable direction.",
    strategic:
      "Over 16 years they became our strategic lens — not just sourcing, but helping us see which technology bets would define the next decade of media distribution.",
  },
  {
    name: "Dean Nelson",
    ...
    strategic:
      "They gave us a competitive intelligence layer we didn't know we needed — benchmarking our infrastructure against the entire market, not just our existing vendors.",
  },
  {
    ...
    roi: 21,
    quote:
      "The deal that RampRate got for the Walt Disney Internet Group was one of the best deals in IT services I saw during my tenure at Disney.",
    strategic:
      "They integrated into our product launch timeline — the infrastructure deal wasn't separate from the business strategy, it was the business strategy.",
  },
  {
    name: "Ian Rodgers",
    ...
    roi: 18,
    quote:
      "Within 30 hours of our decision-making, we were fully installed and up and running. Not only did RampRate save us an incredible amount of time, resources, and money.",
    strategic:
      "They accelerated our product launch by weeks. When Apple acquired us, the infrastructure was already built to scale — that clarity made the acquisition smoother.",
  },
  {
    name: "Peter Borner",
    title: "Head of IT",
    ...
    roi: 24,
    quote:
      "All in all, they made me look like a hero to my executive management. They are a secret weapon.",
    strategic:
      "They didn't just reduce costs on our outsourcing deals — they restructured the vendor relationships so my team could focus on digital transformation instead of contract management.",
  },
  {
    name: "Wulf Kaal",
    ...
    roi: 16,
    quote:
      "Tony Greenberg is fun to work with even in highly contentious and stressful business environments. He has a unique ability to bring out the good and turn even the worst situations around.",
    strategic:
      "Tony's network gave us instantaneous connectivity at the highest level — introductions that would have taken us years to build happened in days, with real yield.",
  },
  {
    name: "Andrew Robbins",
    ...
    roi: 24,
    quote:
      "They work fast, saved us over 40% and months of due diligence which we just didn't have.",
    strategic:
      "They handled emergency decisions with the confidentiality and speed our film release schedule demanded — the infrastructure was invisible to the audience, exactly as it should be.",
  },
  {
    name: "Gary Share",
    ...
    roi: 19,
    quote:
      "RampRate is an invaluable partner for us. They helped us cut the clutter, gain insight and distill our team's thoughts for over 50 digital media, IT and product studies.",
    strategic:
      "They became our external brain trust — translating market complexity into actionable product strategy across 50+ studies that shaped how we positioned Windows.",
  },
  {
    ...
    roi: 24,
    quote:
      "They paid for themselves by accelerating our growth by years and remain a vital resource for the team.",
    strategic:
      "From refined strategies to world-class investor introductions to preserving our equity — they gave us the credibility to capture opportunities we couldn't even access without them.",
  },
  {
    name: "Todd Miller",
    title: "CIO",
    ...
    roi: 14,
    quote:
      "They bring uniquely rare data and a solid practice to the table. They opened my eyes to the possibilities of outsourcing on a broader scale.",
    strategic:
      "They didn't just optimize our existing contracts — they showed us an entirely different way to think about our technology stack that we hadn't considered.",
  },
  {
    name: "Ryan Hughes",
    ...
    roi: 24,
    quote:
      "RampRate did an outstanding job helping us deliver content for a breakthrough pay-per-view feature the NHL is offering hockey fans.",
    strategic:
      "They provided a total solution — encryption, pricing, DRM, customer service — that turned a streaming experiment into a revenue-generating product line.",
  },
  {
    name: "Charles Butler",
    ...
    roi: 17,
    quote:
      "WOW is the best I can say. They lowered overall prices between 17-36% and helped us achieve breakthrough innovative best-of-breed SLA coverage.",
    strategic:
      "They brought in providers we hadn't considered and forced everyone to compete — the result wasn't just savings, it was a fundamentally better architecture.",
  },
  {
    name: "Richard Titus",
    ...
    roi: 24,
    quote:
      "I would recommend either he or his firm unequivocally for business planning, scale or cost containment. Globally astute consummate analysts and deal pros extraordinaire.",
    strategic:
      "Tony understands media, IT and infrastructure like no one I've ever met — he sees the connections between industries that most people treat as separate worlds.",
  },
  {
    name: "Jay Samit",
    title: "Former EVP",
    ...
    roi: 12,
    quote:
      "In a field filled with prognosticators who claim to know the next great thing, RampRate applies sound business judgment and analytics to assist senior management in making crucial, time-sensitive decisions.",
    strategic:
      "They cut through the noise with data, not opinions — when you're making decisions that affect billions in market cap, that clarity is worth more than any consulting deck.",
  },
  {
    name: "Niles Triget",
    title: "Operations",
    ...
    strategic:
      "They mapped our entire infrastructure needs against our IP business model — the sourcing strategy was inseparable from the product strategy.",
  },
  {
    name: "Ron Vaisbort",
    title: "Executive",
    ...
    roi: 20,
    quote:
      "RampRate defines professionalism and they run a world-class team. They remain on the vanguard — staying on top of all the major digital media trends.",
    strategic:
      "Across four different companies I worked at, they delivered the same caliber of strategic insight — their institutional knowledge compounds with every engagement.",
  },
  {
    name: "Blair Harrison",
    title: "CEO",
    ...
    roi: 24,
    quote:
      "Using RampRate as a partner in these decisions is one of the smartest moves a business-minded CTO and management team can make!",
    strategic:
      "They reduced our monthly expenditure by over 75% while building partnerships that became the foundation of our content distribution strategy.",
  },
  {
    ...
    roi: 10,
    quote:
      "Tony and his team are very well connected in the global high-tech community. He is also a generous giver of his time and energy to worthy causes, driving impact to become measurable and reportable.",
    strategic:
      "Tony doesn't just connect you to people — he connects you to the right people at the right moment, with context that makes the introduction land.",
  },
];
...
const PARODY_QUOTES = [
  {
    ...
    quote:
      "I spent fifty years navigating the balance of power between nations. Greenberg does the same thing between corporations, consciousness, and dinosaur bones. The man has more active fronts than NATO.",
  ...
  },
  {
    ...
    quote:
      "Most tech CEOs I interview are selling one thing. Tony walked into the room selling seven things, and somehow each one made the others more interesting. I've never seen anyone tokenize a T-Rex skeleton and make it sound like the most logical thing in the world.",
  ...
  },
  {
    ...
    title: "CNN Anchor",
    quote:
      "I've covered wars, hurricanes, and congressional hearings. Nothing prepared me for a man who benchmarks $10 billion in IT contracts by day and funds ocean cleanup by night. The range is genuinely unsettling.",
    note: "On range",
  },
  {
    ...
    quote:
      "We talk about stakeholder capitalism like it's a theory. This guy built four token ecosystems that actually fund the things we put in legislation. I'm not sure if he's ahead of us or just impatient.",
  ...
  },
  {
    ...
    quote:
      "Software is eating the world. Greenberg is feeding it psychedelics and teaching it to meditate. I don't know whether to invest or schedule a therapy session.",
  ...
  },
  {
    ...
    quote:
      "I've interviewed heads of state who had less strategic clarity than this man has about the intersection of payments infrastructure and mental health. It shouldn't make sense. It does.",
  ...
  },
  {
    ...
    quote:
      "He's running seven companies across seven industries and somehow none of them are on fire. I find that suspicious.",
  ...
  },
  {
    ...
    quote:
      "He calls it kintsugi — the gold in the cracks. Twenty-five years of building, breaking, and rebuilding in public. That's not a metaphor. That's a vulnerability practice most leaders can't even imagine.",
...
const STATS = [
  {
    label: "Average Score",
    value: `${Math.round(TESTIMONIALS.reduce((a, t) => a + t.score, 0) / TESTIMONIALS.length)}%`,
  },
  {
    label: "Average ROI",
    value: `${Math.round(TESTIMONIALS.reduce((a, t) => a + t.roi, 0) / TESTIMONIALS.length)}x`,
  },
  ...
  return (
    <div className="mx-auto max-w-3xl px-6 py-10">
      ...
      <p className="mb-10 max-w-2xl text-foreground/80">
        ...
        Businesses attract capital when they are documented on the mission and the possibility — not
        when they are raising money.
      </p>
      ...
      <p className="mb-8 text-foreground/80">
        Every client who walks through our door has a version of one of these asks. Not &ldquo;raise
        me money&rdquo; — but the kind of asks that make a company so compelling that capital chases
        them. Here are ten real scenarios, with exact names, exact targets, and exact reasons
          ...
          return (
            <div key={prompt.id} className="rounded-md border border-border bg-card p-6">
              ...
              {isInternal ? (
                ...
                >
                  Learn more <ForwardIcon aria-hidden="true" />
                </Link>
              ) : (
                <a
                  href={prompt.link}
      ...
      {/* ── KEYNOTES & SPEAKING ── */}
      <p className="mb-2 font-mono text-xs tracking-[0.2em] text-brand-gold uppercase">On Stage</p>
      <h2 className="mb-5 font-heading text-2xl font-bold text-foreground">Keynotes & Speaking</h2>
      ...
      {/* ── PODCASTS ── */}
      <p className="mb-2 font-mono text-xs tracking-[0.2em] text-brand-gold uppercase">On Air</p>
      ...
      <p className="mb-2 font-mono text-xs tracking-[0.2em] text-brand-gold uppercase">In Print</p>
      <h2 className="mb-3 font-heading text-2xl font-bold text-foreground">Also Published</h2>
      ...
      {/* ── TESTIMONIALS ── */}
      <p className="mb-2 font-mono text-xs tracking-[0.2em] text-brand-gold uppercase">The Proof</p>
      <h2 className="mb-4 font-heading text-2xl font-bold text-foreground">What They Said After</h2>
      <p className="mb-3 text-foreground/80">
        Every engagement scored. Every relationship earned. These aren&apos;t marketing quotes —
        they&apos;re the words of CTOs, COOs, and CIOs who bet their budgets, their reputations, and
      ...
      <div className="mb-8 flex flex-wrap items-center gap-4 rounded-md border border-brand-gold/15 bg-brand-gold/5 p-5">
        ...
        <p className="text-foreground/80">
          ...
          typically deliver <strong className="text-foreground">10–24x</strong>. The ROI isn&apos;t
          theoretical — it&apos;s measured against what your team actually ships.
        </p>
      </div>
      ...
      <div className="mb-10 rounded-md bg-[#0A0A10] p-8 text-center">
        ...
        <p className="font-heading text-lg leading-relaxed text-white/90">
          Speaker at the H+ Summit at Harvard University, 2010 — on the same stage as Ray Kurzweil.
          Author of &ldquo;Boiling the Human.&rdquo; Twenty-five years building the infrastructure
          of trust. Published across Forbes, Business Insider, HuffPost, and Medium. Presented at
          the Clinton Global Initiative. CEO of RampRate. Chief Impact Officer of ImpactSoul.
        </p>
      </div>

      <div className="border-t border-border py-6 text-center">
        <Link href="/pick-up-the-phone" className="font-mono text-sm tracking-wide text-brand-gold">
          Continue to Pick Up the Phone <ForwardIcon aria-hidden="true" />
        </Link>
      </div>
    </div>
  );
