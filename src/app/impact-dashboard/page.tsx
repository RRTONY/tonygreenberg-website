  ...
  return (
    <div>
      ...
      <section className="mx-auto -mt-8 max-w-3xl px-6 sm:px-10">
        <div className="rounded-2xl border border-brand-gold/15 bg-card p-7">
          <p className="mb-3 leading-relaxed text-foreground/80">
            ...
            SPACE, BEING), a 100-charity accountability index, a 12-dimension SoulScore engine,
            and Howard W. Buffett&apos;s Impact Rate of Return framework into one real-time view.
          </p>
          <p className="mb-3 leading-relaxed text-foreground/80">
      ...
      <footer className="bg-linear-to-br from-[#3D2E14] to-[#5A4020] px-6 py-10 text-center sm:px-10">
        <p className="mb-2 font-mono text-sm text-brand-gold">Impact Measurement Dashboard — ImpactSoul</p>
        <p className="font-mono text-xs tracking-wide text-white/70">
          4 Token Ecosystems · 100 Charities Scored · 12 SoulScore Dimensions · {AGGREGATE.portfolioCompanies}+
          Portfolio Companies · iRR Framework
        </p>
