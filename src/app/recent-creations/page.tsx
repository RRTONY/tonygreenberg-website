...
export const metadata: Metadata = {
  ...
  description:
    "A living portfolio of digital creation. Eleven sites, eleven ideas that needed a home.",
        ...
        <div className="mx-auto max-w-4xl">
          ...
          <div className="max-w-lg rounded-xl border border-brand-gold/15 bg-brand-gold/5 p-6 text-sm text-muted-foreground">
            <p className="mb-2">
              ...
              portfolio of digital products Tony has designed and shipped — interactive diagnostics,
              educational platforms, consumer investigations, and intelligence engines. Each one is
              a standalone site you can use right now.
            </p>
            <p className="mb-2">
              <strong className="text-brand-gold">Why it matters:</strong> These aren&apos;t mockups
              or pitch decks. Every card links to a working product. They demonstrate a specific
              thesis: that meaningful software can be built in days when the thinking has been done
              in decades.
            </p>
            <p>
            ...
            return (
              ...
              >
                <div
                  ...
                  style={{
                    background: `linear-gradient(135deg, ${project.accent}14 0%, transparent 100%)`,
                  }}
                >
