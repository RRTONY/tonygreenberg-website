...
const FORMATS = [
  ...
  { title: "Executive offsite", copy: "A room built for strategic friction, not another slide deck." },
  { title: "Workshop", copy: "A working session for teams ready to examine the system they are inside." },
];
    ...
    <div>
      ...
      <section className="border-y border-border bg-muted/40 px-6 py-16 sm:px-10">
        <div className="mx-auto max-w-4xl">
          ...
          <div className="grid gap-3.5 sm:grid-cols-2">
            {FORMATS.map((format) => (
              <div key={format.title} className="rounded-md border border-border bg-background/70 p-5">
      ...
      <div className="mx-auto max-w-2xl px-6 py-16 text-center sm:px-10">
        ...
        <p className="mb-6 leading-relaxed text-foreground/70">
          Send the audience, the moment, and the question the room cannot quite ask itself. If
          there is a fit, Tony will help shape the conversation from there.
        </p>
        <a
