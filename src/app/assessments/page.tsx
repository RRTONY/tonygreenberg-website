...
export const metadata: Metadata = {
  ...
  description:
    "Three research-backed instruments — Dharma Finder, Consciousness Scale, and the Grant Study Assessment — mapping purpose, consciousness, and life satisfaction.",
    ...
    <div className="relative z-1 min-h-screen">
      ...
      <div className="relative z-1 bg-[#0A0A10] pt-[clamp(7.5rem,12vw,10rem)] pb-[clamp(4rem,6vw,6rem)]">
        <div className="mx-auto max-w-300 px-8">
          <div className="mb-4 font-mono text-xs tracking-[0.2em] text-brand-gold-light uppercase">
            Know Thyself
          </div>
          ...
          <p className="max-w-170 text-[1.05rem] leading-[1.8] text-[#999]">
            Purpose. Consciousness. Satisfaction. Three dimensions of a life well-lived, measured by
            three of the most rigorous frameworks ever developed. Each takes 15–20 minutes.
            Together, they create a portrait of where you are — and where you&apos;re being called.
          </p>
          <div className="mt-12">
            <a
              href="#instruments"
      ...
      >
        ...
        <p className="mt-10 text-center text-sm text-muted-foreground">
          ...
          <Link href="/find-my" className="text-brand-gold underline underline-offset-4">
            Browse the full assessment directory <ForwardIcon aria-hidden="true" />
          </Link>
        </p>
      </div>
      ...
      <div className="relative z-1 border-t border-b border-border">
        <div className="mx-auto max-w-300 px-8 py-[clamp(4rem,6vw,6rem)]">
          ...
          <p className="max-w-170 text-[1.05rem] leading-[1.8] text-foreground/80">
            ...
            matters. What I&apos;ve learned: you need three coordinates to locate yourself.{" "}
            <strong>Purpose</strong> tells you what you&apos;re here to do (Schmachtenberger).{" "}
            <strong>Consciousness</strong> tells you from what level you&apos;re doing it (Hawkins).{" "}
            <strong>Satisfaction</strong> tells you whether the life you&apos;ve built actually
            sustains you (Harvard Grant Study). Together, they&apos;re a triangulation of the soul.
          </p>
        </div>
      </div>
