...
import { postTeaserBySlugQuery } from "@/lib/content/legacy-content-query-tokens";
...
const START_HERE_ESSAYS = [
  {
    ...
    title: "When Healing Becomes Extraction",
    why: "The clearest statement of what I stand for — and what I'll fight against.",
    theme: "Ethics & Systems",
    time: "22 min",
  },
  {
    num: "02",
    ...
    why: "How I think about broken systems and what replaces them. Health as a case study.",
  ...
  },
  {
    ...
    why: "The physics underneath the AI buildout. Why this matters for everything.",
    theme: "AI & Energy",
    time: "10 min",
  },
  {
    ...
    why: "The foundational idea behind everything I build. Only time buys trust.",
    theme: "Trust",
    time: "8 min",
  },
  {
    ...
    why: "On stage with Kurzweil. Why verification matters more than credentials.",
    theme: "Technology",
    time: "7 min",
  },
  {
    ...
    why: "How I think about infrastructure as a moral act, not just a cost.",
    theme: "Impact",
    time: "6 min",
  },
  {
    ...
    why: "From 2010. Still the most accurate prediction I ever made about the internet.",
...
const OPEN_QUESTIONS = [
  {
    q: "Was I wrong about blockchain?",
    note: "Wrote about it optimistically in 2018. The infrastructure thesis held. The governance thesis did not. Still deciding.",
  },
  {
    q: "Can capital actually regenerate?",
    note: "ImpactSoul is the experiment. The hypothesis is that tokenized assets can fund restoration without extraction. The data is still coming in.",
  },
  {
    q: "What does consciousness have to do with enterprise technology?",
    note: "This is the question that connects everything on this site. I don't have a clean answer. I have 25 years of circumstantial evidence.",
  },
  {
    q: "Is psychedelic medicine being captured before it can heal?",
    note: "The Eli Lilly acquisition happened the same week Tina Sodhi died. I wrote about both. I don't know how the story ends.",
  },
];
...
const MOST_READ = [
  {
    num: "01",
    title: "Boiling the Human",
    subtitle: "Harvard H+ / Kurzweil",
    ...
    <div>
      ...
      <div className="relative h-[70vh] max-h-[650px] min-h-[420px] overflow-hidden">
        ...
        <div className="relative flex h-full max-w-3xl flex-col justify-end px-6 pb-12 sm:px-10">
          ...
          <div className="flex flex-wrap gap-3">
            ...
            >
              Find Your Fit <ForwardIcon aria-hidden="true" />
            </Link>
            <Link
              href="/blog"
            ...
            >
              121 Essays <ForwardIcon aria-hidden="true" />
            </Link>
          </div>
        </div>
      </div>
          ...
          <div className="grid divide-y divide-border border-t border-border sm:grid-cols-3 sm:divide-x sm:divide-y-0">
            {THREE_PATHS.map((path) => (
              <Link
                key={path.href}
                href={path.href}
                className="block p-6 transition-colors hover:bg-brand-gold/5"
              >
                ...
                <p className="mt-3 font-mono text-xs tracking-wide text-brand-gold">
                  {path.cta} <ForwardIcon aria-hidden="true" />
                </p>
              </Link>
            ))}
          </div>
      ...
      <div className="border-b border-border bg-background px-6 py-10 sm:px-10">
        <div className="mx-auto max-w-5xl">
          ...
          <Link
            href="/articles"
            className="mt-4 inline-block border-t border-border pt-3 font-mono text-xs tracking-wide text-brand-gold uppercase"
          >
            All 121 essays <ForwardIcon aria-hidden="true" />
          </Link>
        </div>
      </div>
          ...
          <div className="mx-auto max-w-4xl">
            ...
            >
              ...
              <div className="flex flex-col justify-center bg-[#0A0A10] p-8">
                ...
                {featured.excerpt && <p className="mb-5 text-white/70">{featured.excerpt}</p>}
                ...
                <p className="font-mono text-xs tracking-wide text-brand-gold-light uppercase">
                  Read the Letter <ForwardIcon aria-hidden="true" />
                </p>
              </div>
            </Link>
          </div>
        ...
        <div className="mx-auto max-w-3xl">
          ...
          <div className="grid gap-6 sm:grid-cols-2">
            <div className="flex flex-col rounded-xl border border-brand-gold/20 bg-brand-gold/5 p-7">
              ...
              <h3 className="mb-2 font-heading text-lg font-bold text-foreground">
                For companies already scaling who need the external layer no internal coach
                provides.
              </h3>
              <p className="mb-4 flex-1 text-sm text-muted-foreground">
                Tony opens rooms. You walk through them. Engagements begin with a scoping
                conversation.
              </p>
              <Link
                href="/amplifier"
              ...
              >
                Engagements begin with a scoping conversation <ForwardIcon aria-hidden="true" />
              </Link>
            </div>
            <div className="flex flex-col rounded-xl border border-border bg-card p-7">
              ...
              <p className="mb-4 flex-1 text-sm text-muted-foreground">
                Tony finds the diamond. Together you cut it. Engagements begin with a scoping
                conversation.
              </p>
              <Link
                href="/diamond-cut"
          ...
          <div className="mx-auto mt-5 max-w-xl rounded-lg border border-brand-gold-light/10 bg-muted/50 p-6 text-center">
            <p className="mb-2 border-l-4 border-[#C5A23C] pl-4 text-left font-heading text-lg font-extrabold text-foreground">
              Both engagements include a handpicked vertical domain expert. Tony does not show up
              alone.
            </p>
        ...
        <div className="mx-auto max-w-4xl">
          ...
          <div className="grid gap-4 sm:grid-cols-2">
            {OPEN_QUESTIONS.map((item) => (
              <div
                key={item.q}
                className="rounded border border-brand-gold/10 bg-background/70 p-5"
              >
        ...
        <div className="mx-auto max-w-4xl">
            ...
            {WHAT_I_BUILD.map((item) => {
              ...
              return (
                ...
                >
                  ...
                  <p className="mt-3 font-mono text-xs text-brand-gold">
                    {item.linkLabel} <ForwardIcon aria-hidden="true" />
                  </p>
                </Link>
              );
            })}
          ...
          <p className="mt-5 border-t border-border pt-4 font-mono text-xs text-muted-foreground">
            ...
            <Link href="/ecosystem" className="text-brand-gold opacity-70">
              Full Ecosystem <ForwardIcon aria-hidden="true" />
            </Link>
          </p>
        </div>
      </div>
        ...
        <div className="mx-auto max-w-2xl text-center">
          ...
          <div className="rounded-xl border border-[#6F4E37]/15 bg-[#6F4E37]/5 p-8">
            ...
            <div className="flex flex-wrap justify-center gap-3">
              ...
              >
                Chain Rankings <ForwardIcon aria-hidden="true" />
              </Link>
            </div>
          </div>
        </div>
      ...
      <div className="border-t border-border px-6 py-12 text-center sm:px-10">
        ...
        >
          Subscribe <ForwardIcon aria-hidden="true" />
        </Link>
      </div>
    </div>
  );
