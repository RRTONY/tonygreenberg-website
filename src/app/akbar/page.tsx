...
const WINE_PAIRINGS = [
  {
    wine: "Turley Old Vines Zinfandel",
    dish: "Tandoori Prawns",
    note: "Eighty-year-old vines from Paso Robles. The brambly dark fruit absorbs tandoori smoke the way old leather absorbs rain. Improbable. Transcendent.",
  },
  {
    wine: "Pierre Gimonnet Grower Champagne",
    dish: "Garlic Naan",
    note: "Not Moët. Not Veuve. A farmer's champagne — chalky, precise, almost austere — against butter-drenched bread still radiating clay-oven heat. The collision is sacred.",
  },
  {
    wine: "Brunello di Montalcino (Biondi-Santi)",
    dish: "Bhartha",
    note: "Smoky eggplant dragged through embers meets a wine that spent five years in Slavonian oak contemplating mortality. Both taste like patience rewarded.",
  },
  {
    wine: "Restrained Oregon Pinot (Cristom)",
    dish: "Goan Fish Curry",
    note: "Willamette Valley earth and coconut-tamarind broth. The pinot's forest-floor minerality catches the curry's molasses-dark bass notes mid-fall.",
  },
  {
    wine: "Albariño (Do Ferreiro)",
    dish: "Sea Bass Tikka",
    note: "Galician salt spray and charred fish flesh. The Atlantic meeting the Arabian Sea through glass.",
  },
  {
    wine: "Vouvray Demi-Sec (Huet)",
    dish: "Vegetable Samosas",
    note: "Loire honeyed quince against cumin-spiked potato and pea. The sweetness doesn't compete — it genuflects before the spice.",
  },
];

const REFRAMES = [
  {
    term: "Ritual over novelty.",
    def: "The Goan fish curry does not require a seasonal update. The menu has not changed because the menu does not need to change. It is a signal maintained across time.",
  },
  {
    term: "Trust over stimulation.",
    def: "You do not discover Akbar. You are brought here by someone who trusts you enough to share it. The recommendation is the review.",
  },
  {
    term: "Returning over arriving.",
    def: "The thousandth visit reveals what the first visit cannot. Emotional permanence is invisible to algorithms that only measure novelty.",
  },
];
    ...
    <div className="bg-[#0A0A0F] text-[#F4EDD8]">
      <div className="px-6 py-20 text-center sm:px-10">
        ...
        <p className="mx-auto max-w-xl text-lg text-[#9A9080] italic">
          ...
          Boulevard still smells like coriander, old corks, warm naan, cardamom, smoke, and polished
          wood. It does not want your content. It wants your nervous system.
        </p>
      </div>
      ...
      <div className="article-body mx-auto max-w-2xl px-6 py-10 leading-[1.85] sm:px-10 [&>p]:mb-6">
        ...
        <p>
          ...
          absorbing pressure from both sides before customers ever feel it. He remembers people the
          old way. Human memory. Not database memory.
        </p>
        <p>
          He has quietly regulated the emotional weather of Akbar for decades. The timing of water
          arriving. The pacing between courses. The calm that radiates outward from his presence
          like heat from a clay oven. You do not notice what JC does until you eat somewhere he is
          not — and then you feel the absence like a missing frequency.
        </p>
        <p>
        ...
        <p>
          The bhartha — velvet dragged through embers. Roasted eggplant collapsed into tomatoes and
          onions with a spice profile calibrated across generations. The tamarind carries
        ...
        <p className="font-semibold text-[#C9A84C] italic">
          JC changes flavor indirectly — through timing, through calm, through the rhythm of a room
          held steady.
        </p>
        ...
        <p>
          Akbar has a 3.8 on Google. Let that land. A place that has been holding this neighborhood
          together for decades — through recessions, through fires, through the complete cultural
          lobotomy of Venice — and the algorithm gives it the same score as a fast-casual poke bowl.
        </p>
        <p>
          Modern review systems reward stimulation instead of depth. They reward lighting, content
          engineering, visual seduction — the choreography of appearing interesting rather than the
          discipline of being nourishing. A restaurant that photographs well scores higher than one
          that feeds you well. A place optimized for the first visit outranks a place optimized for
          the thousandth.
        </p>
        <p>
          Akbar does not perform for cameras. The room smells faintly of decades — cardamom embedded
          in the walls, ghee vapor in the ceiling tiles, the particular warmth of a space that has
          held ten thousand conversations. This is not something you can rate on a five-point scale.
        </p>
        ...
        <p>
          In 2004, I was running a technology company through one of those deals that either makes
          you or unmakes you. The eBay transaction. Months of legal architecture that would make a
          securities lawyer weep into his Macallan. The kind of stress that lives in your jaw at 3
          AM and your lower back by noon.
        </p>
        ...
        <p>
          The Goan fish curry would arrive and the room would smell like coconut milk reducing over
          low heat, tamarind darkening at the edges, curry leaves releasing their last green breath
          into the steam. Somewhere between the second naan and the third glass of an improbable
          Turley Zin, the deal would stop feeling like it might kill us. The food was not peripheral
          to survival. It was infrastructure.
        </p>
      ...
      <div className="mx-auto max-w-4xl px-6 py-14 sm:px-10">
        ...
        <p className="mx-auto mb-10 max-w-lg text-center text-[#9A9080] italic">
          Forget the lazy &quot;pair spicy food with Riesling&quot; algorithm. These are improbable
          marriages — cult Zinfandels against tandoori smoke, grower Champagne with butter-soaked
          naan, Brunello contemplating mortality alongside bhartha.
        </p>
        <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
          {WINE_PAIRINGS.map((pair) => (
            <div
              key={pair.wine}
              className="rounded-md border border-[#C9A84C]/15 bg-[#C9A84C]/5 p-6"
            >
      ...
      <div className="mx-auto max-w-2xl px-6 py-10 sm:px-10">
        <div className="border-l-4 border-[#00C9B1] bg-[#00C9B1]/5 p-8">
          ...
          <p className="mb-4 leading-relaxed">
            This is not a franchise play. It is a preservation play. The knowledge inside
            Akbar&apos;s kitchen is irreplaceable — and currently exists only in the hands and
            memory of people who will not be here forever. Packaging is not commercialization. It is
            archiving.
          </p>
          <p className="leading-relaxed text-[#9A9080]">
            At ImpactSoul, we fund restoration infrastructure. Akbar is not a portfolio company. But
            it is proof of concept — evidence that businesses built on depth rather than extraction
            can survive for decades in a market that rewards the opposite.
          </p>
        </div>
      </div>
      ...
      <div className="mx-auto max-w-2xl px-6 py-16 text-center sm:px-10">
        ...
        <p className="mb-4 leading-relaxed">
          ...
          hitting hot oil. The sound of naan tearing. The specific silence of a room where no one is
          performing. The weight of a wine glass held by someone who has stopped checking their
          phone.
        </p>
        <p className="mb-4 leading-relaxed">
