    ...
    <div>
      <div className="bg-linear-to-b from-background to-secondary px-6 py-20 text-center sm:px-10">
        ...
        <p className="mx-auto max-w-xl text-lg text-foreground/70">
          Twenty-five years of pattern recognition distilled into five questions worth asking before
          you spend a dollar, hire a consultant, or make a decision you can&apos;t reverse.
        </p>
      </div>
      ...
      <div className="mx-auto max-w-3xl px-6 py-12 sm:px-10">
        ...
        <p className="mb-10 max-w-xl text-foreground/70">
          This isn&apos;t a business plan template. It&apos;s a thinking tool. Each step forces you
          to slow down at the exact moment most people speed up. The goal isn&apos;t to find the
          answer — it&apos;s to find the right question.
        </p>
