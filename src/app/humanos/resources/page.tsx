...
import {
  ...
  READING_LIST,
  DIAGNOSTIC_HREF,
} from "@/lib/content/humanos-content";
    ...
    <>
        ...
        <div className="mx-auto max-w-3xl">
          ...
          <div className="grid gap-5 sm:grid-cols-3">
            {DAILY_PRACTICES.map((dp) => (
              ...
              >
                <h3 className="mb-4 font-heading text-base font-semibold text-neutral-900">
                  {dp.title}
                </h3>
                <ul className="m-0 list-none p-0">
                  {dp.items.map((item) => (
                    <li
                      key={item}
                      className="relative mb-2 pl-4 text-sm leading-relaxed text-neutral-700"
                    >
      ...
      <section className="mx-auto max-w-3xl px-6 py-16">
        ...
        <p className="mb-8 text-base leading-relaxed text-neutral-600">
          The books that shaped this thinking. Not a comprehensive list — a curated one. Each title
          earned its place.
        </p>
        <div className="flex flex-col gap-4">
          {READING_LIST.map((book) => (
            ...
            >
              <h4 className="mb-1 font-heading text-lg font-semibold text-neutral-900">
                {book.title}
              </h4>
