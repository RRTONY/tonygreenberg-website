...
const MAXIMIZER_SYMPTOMS = [
  "Analysis Paralysis",
  "Chronic Dissatisfaction",
  "Decision Fatigue",
  'The "Grass is Greener" Syndrome',
];
const SATISFICER_UNLOCKS = [
  "Radical Agency",
  "Deep Focus",
  "Joy in the Present",
  "Sustainable Growth",
        ...
        <div className="mx-auto max-w-3xl">
          ...
          <div className="flex flex-col gap-4">
            {SHIFT_ROWS.map((row) => (
              ...
              >
                <div>
                  <p className="mb-1 font-mono text-[0.6rem] tracking-[0.1em] text-red-500/70 uppercase">
                    From
                  </p>
                ...
                <div>
                  <p className="mb-1 font-mono text-[0.6rem] tracking-[0.1em] text-emerald-600/70 uppercase">
                    To
                  </p>
