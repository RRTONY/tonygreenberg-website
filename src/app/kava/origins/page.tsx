      ...
      <KavaSection bg="sand">
        ...
        <div className="relative">
          ...
          {TIMELINE.map((t, i) => (
            <div
              key={t.year}
              className={`relative mb-8 flex items-start gap-4 ${i % 2 === 0 ? "md:flex-row" : "md:flex-row-reverse"}`}
            >
        ...
        <div className="grid grid-cols-1 gap-6 md:grid-cols-2">
          ...
          <KavaCard>
            <div className="mb-3 flex items-center gap-2">
              ...
              <h4 className="font-heading text-lg font-bold text-kava-terracotta">
            ...
            <div className="space-y-2 text-sm leading-[1.75] text-kava-ink">
              ...
              <p className="font-bold text-kava-terracotta">
