...
export const metadata: Metadata = {
  ...
  description: "Seven persistent myths about kava's liver safety, addiction potential, and effects, examined against the evidence.",
      ...
      <KavaSection bg="sand">
        <div className="mx-auto max-w-3xl text-center">
          <p className="font-heading text-xl leading-[1.6] font-medium text-kava-ink md:text-2xl">
            The pattern is consistent: nearly every kava safety concern traces back to non-noble cultivars, ethanolic extracts, or mixing with
            contraindicated substances. Traditional aqueous noble kava — the PRI standard — has a 3,000-year safety record that no pharmaceutical on earth
            can match.
          </p>
        </div>
      </KavaSection>
