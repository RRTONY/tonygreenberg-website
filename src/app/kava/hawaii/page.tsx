...
import { KavaBadge, KavaCard, KavaDivider, KavaHero, KavaSection, KavaSectionTitle, KavaDisclaimer } from "@/components/kava/kava-ui";
...
export const metadata: Metadata = {
  ...
  description: "The story of Hawaiian 'awa culture set against the state's methamphetamine crisis, and the pharmacological and cultural case for kava in recovery.",
    ...
    <>
        ...
        <div className="flex items-start gap-4 rounded-xl border-2 border-[#dc2626] bg-[#dc2626]/8 p-5">
          ...
          <div>
            ...
            <p className="text-sm leading-[1.75] text-kava-ink">
              ...
              only under trained community facilitator oversight.
            </p>
          </div>
        </div>
      </KavaSection>
      ...
      <KavaSection bg="sand">
        ...
        <p className="mb-6 text-base leading-[1.75] text-kava-ink/70">
          Crystal methamphetamine first arrived in Hawaii from Southeast Asia in 1985. Hawaii was the first US state to be impacted. As Judge Edward Kubo of
          Hawaii stated:
        </p>
        <blockquote className="mb-8 border-l-3 border-kava-terracotta pl-4 font-heading text-xl leading-[1.5] font-medium text-kava-terracotta">
          &ldquo;We are not proud of it. But crystal methamphetamine is our gift to the nation. It started here.&rdquo;
        </blockquote>
            ...
            <div key={t.year} className="relative mb-6 flex items-start gap-4">
              ...
              <div className="flex-1">
                <div className="mb-1 flex items-center gap-2">
                  ...
                  <KavaBadge color={t.type === "crisis" ? "terracotta" : "green"}>{t.type === "crisis" ? "ICE" : "'Awa Revival"}</KavaBadge>
                </div>
      ...
      <KavaSection bg="sand">
        ...
        <p className="mb-6 text-base leading-[1.75] text-kava-ink/70">
          Kava&apos;s kavalactone profile addresses the exact neurological damage signature of a meth comedown. This is a research hypothesis — not proven —
          but the pharmacological alignment is real and deserves formal clinical investigation.
        </p>
      ...
      <KavaSection>
        ...
        <blockquote className="mb-6 font-heading text-xl leading-[1.5] font-medium text-kava-ink md:text-2xl">
          The deepest argument for kava in Hawaii&apos;s recovery landscape is not pharmacological — it is cultural. When a native Hawaiian participates in
          &apos;awa ceremony, they are not just drinking a plant. They are accessing their ancestry, their identity, their sovereignty. For a population
          three generations into meth&apos;s destruction, the &apos;awa bowl is a way home.
        </blockquote>
        <p className="text-base leading-[1.75] text-kava-ink/70">
          Preliminary research suggests kava may reduce the craving associated with addiction. Participants reported reduction in their desire for their
          drug of choice. If the findings are confirmed, kava may be a useful component to the treatment of addictions, especially for Native Hawaiian and
          Pacific peoples.
        </p>
      </KavaSection>
