...
import { KavaHero, KavaSection, KavaSectionTitle, KavaDivider, KavaDisclaimer } from "@/components/kava/kava-ui";
    ...
    <>
      ...
      <KavaSection bg="sand">
        ...
        <p className="mb-8 text-base leading-[1.75] text-kava-ink/70">
          Kava&apos;s kavalactone components inhibit five major liver enzymes. This is the primary mechanism by which kava interacts with medications.
        </p>
        <CypProfile />
      </KavaSection>
