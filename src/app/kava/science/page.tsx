...
export default function KavaSciencePage() {
  return (
    <>
      <KavaHero eyebrow="Module 4" title="Kavalactone Science" subtitle="The 6 major kavalactones — their mechanisms, receptor targets, and PRI relevance. Plus a chemotype decoder for cultivar analysis." />
      ...
      <KavaSection bg="sand">
        ...
        <p className="mb-6 text-base leading-[1.75] text-kava-ink/70">
          Enter a chemotype string (e.g. 4-2-6-5-3-1) to see which kavalactones dominate and their effect profile. The first number indicates the dominant
          kavalactone.
        </p>
        <ChemotypeDecoder />
      </KavaSection>
      ...
      <KavaSection>
        ...
        <div className="grid grid-cols-1 gap-3 sm:grid-cols-2">
          {COMBINED_PROFILE.map((item) => (
            <div key={item} className="flex gap-3 rounded-lg border border-kava-sand-muted bg-white p-3">
