...
const FEATURED_IN = ["Forbes", "Wired", "Business Week", "Huffington Post", "Ars Technica", "All Things D", "Computer World", "Psychedelic Times"];
    ...
    <div>
      ...
      <div className="mx-auto max-w-3xl px-6 py-10">
        ...
        <p className="mb-6 leading-relaxed text-foreground/80">
          ...
          The answer: spectacular, instructive wreckage.
        </p>
      ...
      <div className="mx-auto max-w-3xl border-t border-border px-6 py-10">
        ...
        <p className="mb-6 leading-relaxed text-foreground/80">
          ...
          goes into stock buybacks while the planet burns, the victory is hollow. The work needed
          to point somewhere.
        </p>
        <div className="my-8 rounded-md bg-brand-gold/5 p-6">
          ...
          <div className="space-y-2">
            {RECEIPTS.map((item) => (
              <div key={item.label} className="flex items-baseline justify-between border-b border-border py-2">
      ...
      <div className="mx-auto max-w-3xl px-6 pb-10">
        <div className="rounded-lg bg-linear-to-br from-[#11111A] to-[#20162C] p-8 text-[#F5F0E0]">
          ...
          <p className="mb-4 text-[#F5F0E0]/70">
            I am following the collision of AI buildout, nuclear manufacturing, and the trust
            layer underneath every serious system.
          </p>
          <Link
