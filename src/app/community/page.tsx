    ...
    <div>
      <div className="bg-linear-to-b from-background to-secondary px-6 py-24 text-center sm:px-10 dark:from-[#0A0A10] dark:to-background">
        ...
        <p className="mx-auto max-w-lg text-lg text-foreground/70">
          Upload your contacts. Invite your people. Find your partner, your business collaborator,
          your tribe. Every great movement started with two people who shouldn&apos;t have met but
          did.
        </p>
      </div>
      ...
      <div className="mx-auto max-w-2xl px-6 py-16 text-center sm:px-10">
        ...
        <p className="mb-6 leading-relaxed text-foreground/70">
          Profiles, contact uploads, and a member directory are coming. Until then, the fastest way
          to actually find your tribe is the one that&apos;s always worked: reach out directly.
        </p>
        <Link
      ...
      <div className="bg-secondary px-6 py-16 text-center sm:px-10 dark:bg-[#0A0A10]">
        ...
        >
          Read the Manifesto <ForwardIcon aria-hidden="true" />
        </Link>
      </div>
      ...
      <div className="border-t border-border py-6 text-center">
        ...
        >
          Continue to The Manifesto <ForwardIcon aria-hidden="true" />
        </Link>
      </div>
    </div>
  );
